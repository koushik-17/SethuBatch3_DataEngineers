...
print(int(3 + 4j))                                                  # error due to 3+4j is a complex object
print(int('25.4'))                                                  # error due to it is a float object
print(int('Ten'))                                                    #error due to it is a str object 
...
print(float(0O6247))                                                                    #6* 8^3 + 2* 8^2 + 4*8^1 + 7 * 8^0 = 3239
print(float(0XA7B9))                                                          #10*16^3 +7*16^2  + 11* 16^ 1+ 9*16^0 =42937
print(float(3 + 4j))                                                                #error due to it is a complex object 
print(float('Ten'))                                                                #error due to it is a str object
...
print(complex('3'))                                                     #3+0j
print(complex('3.8'))                                                  #3.8+0j
print(complex(3 , '4'))                                                 #error due to 2nd element can’t be a string 
print(complex('3' , 4))                                             #error due to if first element is string 2nd is permitted
print(complex('3' , '4'))                                         #error due to if first element is string 2nd is permitted
print(complex('Ten'))                                              #error due to ‘Ten’ is not a number
