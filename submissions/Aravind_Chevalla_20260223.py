...
print(a , b , c , sep = '\t') #25  10.8  Hyd
print(a , b , c , sep = '---') # 25___10.8___Hyd
print(a , b , c , sep = '\n') 
,,,
25
10.8
...
t = (10 , 20 , 30 , 40)
s = {10 , 20 , 30 , 40}
print(l , t , s)# [10,20,30,40] (10,20,30) {10,20,30}
...
# Find  Outputs  (Home  work)
a = 10.9274
print('%8.2f'  %a) #<3space> 10.93
print('%9.1f'  %a) # <5 space>10.9
print('%10.3f'  %a) #< 4 space>10.927
print('%.2f'  %a) #10.93
