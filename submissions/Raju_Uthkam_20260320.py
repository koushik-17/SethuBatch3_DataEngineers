...
print(sum(a)) #90
#print(sum(a . items())) #sum takes intial values as 0 and 0 is integer therefore we can't add int and tuple 
...
print(max(a . items())) #max[(10,20),(30,25),(40,5),(7,28),(9,50)] #(40,5)
print(min(a . items())) #min[(10,20),(30,25),(40,5),(7,28),(9,50)] #(7,28)
print(max(a)) ##max[10,30,40,7,9] = 40 by default keys method is executed 
print(min(a)) #min[10,30,40,7,9] = 7
...
#print(dict(e)) #Error dictionary can support 3 elements
f = [[10] , [20] , [30]]
#print(dict(f)) #Error
#print(dict([10 , 20]))#Error Nested sequence is needed 
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) #{10:[20,30],40:[50,60],70:[80,90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
#print(dict(h)) #Error keys can't be mutable 
...
print(f'Sorted Dictionary : {dict(b)}')

#print(dict(sorted(list(a.items())))) One line answer 
...
b = a . copy()
print(b) #{'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue'} Deep copy 
print(a  is  b) #False
print(a  ==  b) #True 
...
print(y) #(20,'Sita')
print(z) #(15,'Rajesh')
print() # nothing  Empty space is printed
(rno1 , sname1) , (rno2 , sname2) , (rno3 , sname3) = a . items() #dict_items([(10,'Rama'),(20,'Sita'),(15,'Rajesh')])
...
a = input('Enter an Mixed case string : ').upper()
c = sorted(a)
b ={}
for x in c:
    if x.isalpha():
...
b = {}
#b.update(a) #Error tuple length must be 2 only 
print(b) #{}
c = [(10,) , (20,) , (30,)]
#b . update(c) #Error #Tuple length must be 2 only 
print(b) #{}
