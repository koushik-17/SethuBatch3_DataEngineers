...
print(type(a))  #<class 'str'>
b = eval(a)
print(b)  #{10 , 20 , 15 , 18 , 20 , 12 , 18} in any order
...
print(s) #{'Hyd',  25,  True,  10.8 } in any order
a , *b = s
print(a)  #any one element
print(b)  #remaining elements as  set 
print(type(b))  #<class 'set'>
...
s . update(tpl)
print(len(s))  #6
print(s)  #{10 , 20 , 15, 18 , 10 , 20} in any order
s . update(25)  #error
