...
a = c1()
b = c2()
# print(issubclass(b , a)) # Error as issubclass() arg 1 must be a class
# print(issubclass(c2 , a)) # Error as issubclass() arg 2 must be a class, a tuple of classes, or a union
...
print(issubclass(c4 , [int , float , c1 , str , bool])) # Error as issubclass() arg 2 must be a class, a tuple of classes, or a union
...
# print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool])) # Error as isinstance() arg 2 must be a type, a tuple of types, or a union