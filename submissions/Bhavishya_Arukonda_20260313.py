...
print(How  to  print  number  of  elements  in  2nd  inner  list)  # a[1][0],a[1][1],a[1][2]
...
print(How  to  print  inner  list  in  another  way)  # for i in a:
                                                            print(a[i])
