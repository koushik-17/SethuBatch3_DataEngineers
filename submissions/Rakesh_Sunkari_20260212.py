...
print(0B11010)   #   26 
print(int(0O6247)) #  6 * 8 ^ 3 + 2 * 8 ^ 2 + 4 * 8 ^ 1 + 7 * 8 ^ 0 i.e. 
...
print(float(3 + 4j))	# 
print(float('Ten'))	# error bez cant convert string to float
...
print(complex('3'))	# 3+0j
print(complex('3.8'))	# 3.8+0j
print(complex(3 , '4')) # error bez 2nd argument should not have string
print(complex('3' , 4)) # error bez when first arguement is string the second arguement id not permitted
print(complex('3' , '4')) #error bez of string values
print(complex('Ten'))	# error bez string cant be letters / alphabets
