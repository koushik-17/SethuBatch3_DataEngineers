...
print(sum(a)) # 90
print(sum(a . items())) # error , cannot add tuples (not concatenation)
...
print(dict(e)) # error , the inner tuple can have only 2 elements
f = [[10] , [20] , [30]]
print(dict(f)) # error , the inner tuple can have only 2 elements
print(dict([10 , 20])) # error , argument needs to be a nested sequence
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) # {10 : [20 , 30] , 40 : [50 , 60] , 70 : [80 , 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h)) # error , key cannot be a mutable object
...
print(a) # {}
del  a
print(a) # error , reference a has already been deleted
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') # 10...'Hyd' <> 20...'Sec' <> 15...'Cyb' <> 18...'Pune'
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ') # error , too many objects
for  x , y   in  a . values():
       print(x , y , sep = ' ... ') # error , too many objects
for  x , y   in  a:
       print(x , y , sep = ' ... ') # error
...
a . update(b) # error , list has no method update


#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)]
b = {}
b.update(a) # error , update method can only take 2 arguments
print(b) # {}
c = [(10,) , (20,) , (30,)]
b . update(c) # error , update method can only take 2 arguments
print(b) # {}
