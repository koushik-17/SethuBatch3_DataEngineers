...
print(add([25 , 10.8 , 'Hyd'] , [True , None , 3+4j , 'Sec']))  # [25 , 10.8 , 'Hyd' , True , None , 3+4j , 'Sec'] ,list b is appended to list a 
...
# becoz only last function defination is used. remaining are overwritten
# means same function name is not defined for many arguments
...
# f1(a = 100 , 200 , 300)  #   Error		# error ,  because after positional arguments the key word argument is permitted. before is not  
# f1(True , None , b = 'Hyd')			    # error , becoz values are give equaly to all arguments. in this multiple values given to 'b'
# f1(10 , 20 , x = 30)				        # error , becoz there is no 'x' argument in function
# f1(10 , 20)				            	# error , becoz there is 3 arguments should allowed. but only 2 arguments are given
...
print(f1(3 , 4 , 5))				# 23
print(f1(*[6 , 7 , 8]))				# 62
# print(f1([6 , 7 , 8]))				        # error , becoz only one argument could be is given , 2 arguments should remain
print(f1(*{1 : 2 , 3 : 4 , 5 : 6}))		        # 16
print(f1(**{'c' : 2 , 'b' :  4 , 'a' : 6}))	    # 14
# print(f1({'c' : 2 , 'b' :  4 , 'a' : 6}))	    # error , becoz only one argument should be given , 2 arguments should remain
print({**{'c' : 2 , 'b' :  4 , 'a' : 6}})	    # {'c' : 2 , 'b' :  4 , 'a' : 6}
# print(f1(**{'c' : 2 , 'a' : 4 , 'x' : 6}))	# error , because 'x' is not an argument

#===============================================================================

# Identify  Error (Home  work)
a = [10 , 20 , 15 , 5 , 12]
print(sorted(a , reverse = True))           # [20, 15, 12, 10, 5]
print(sorted(a , reverse = True))		    # [20, 15, 12, 10, 5]
print(25 , 10.8 , 'Hyd' , sep = '\t')       # 25      10.8    Hyd
print(25 , 10.8 , 'Hyd' , end = '\t')       # 25 10.8 Hyd  25      10.8    Hyd , due to end argument next line output return in same line
print(25 , 10.8 , 'Hyd' ,  sep = '\t' , end = '\t' ,)