...
print(add(10 , '20')) # Error due to int + str
...
if  n == 0:
    ...
    if (n // 100) % 10 != 0:
        print(["", "One", "Two", "Three", "Four", "Five",
               "Six", "Seven", "Eight", "Nine"][(n // 100) % 10], "Hundred", end=" ")
...
print(f1([6 , 7 , 8])) # Error due to 1 argument
print(f1(*{1 : 2 , 3 : 4 , 5 : 6})) # keys = 1, 3, 5 -> 1 + ( 3 * 5 ) = 16
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a)) # Error due to positional argument after keyword argument
print(sorted(a , rev = True)) # Error due to rev is invalid
print(25 , 10.8 , 'Hyd' , separator = '\t') # Error due to separator is invalid
print(25 , 10.8 , 'Hyd' , endofline = '\t') # Error due to endofline is invalid
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') # Error due to positional argument after keyword argument