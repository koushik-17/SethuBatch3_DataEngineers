...
a += b
print(a , id(a)) # [1, 2, 3, 4, 5, 6] <id_of_a>
...
print(a , id(a)) # [1, 2, 3] <id_of_a>
a  = a + b
print(a , id(a)) # [1, 2, 3, 4, 5, 6] <id_of_new_a>
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # ValueError: too many values to unpack (expected 3)
...
first = lst[0]
total = len(lst)
count_first = lst.count(first)

if count_first == total:
    print("All the elements are identical")
else:
    print("All the elements are not identical")

print("Number of elements in list:", total)
print("First element repeated:", count_first)
