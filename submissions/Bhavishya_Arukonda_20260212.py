...
print(int(3 + 4j))  # 3
print(int('25.4'))  # 25
print(int('Ten'))   # error as it is in the character form.
...
print(complex('3'))   # 3+0j
print(complex('3.8'))  # 3.8+0j
print(complex(3 , '4'))  # error because 2nd arg is string
print(complex('3' , 4))  # error because 2nd arg is not permitted when 1st arg is string
print(complex('3' , '4')) # error as both the args are string
