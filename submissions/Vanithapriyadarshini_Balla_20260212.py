...
print(int(3 + 4j))  # Error, bcz object shouldnt be complex
print(int('25.4'))  # Error, bcz obj is in str that contains . as a char 
print(int('Ten'))   # Error, bcz str char which are alphabets can't be int values
...
print(float(3 + 4j)) # Error , bcz complex can't be float
print(float('Ten')) # Error ,bcz it is not numeric string
...
print(complex('3')) # 3+0j
print(complex('3.8')) # 3.8+0j
print(complex(3 , '4'))  # Error ,bcz 2nd arg cant be a string
print(complex('3' , 4))   # Error ,bcz 2nd arg is not permited if 1st arg is a string
print(complex('3' , '4'))  # Error ,bcz 2nd arg is not permited if 1st arg is a string
print(complex('Ten')) # Error ,bcz its a char string
...
print(oct(195))  # 0o303
print(oct(0B10101110010))  # 0o2526
