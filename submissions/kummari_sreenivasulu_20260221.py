...
How  to  print  number  of  keywords # print(len(keyword.kwlist)) i.e : 35
How  to  print  type  of kwlist # print(type(keyword.kwlist))
print(kwlist) #  Error -->  name 'kwlist' is not defined
---------------------------------------------------------------------------------------------------------
# How  to  read  complex  input ?
x = complex(input('Enter  complex  number  :  ')) 
    			# input() always reads data as a string # '3+4j'
...
print(eval(''))  # Error
print(eval('  " "   ')) # one blank space is printed
print(eval(' ')) # Error
---------------------------------------------------------------------------------------------------------
# What  is  the  advantage  of  eval(input()) ?
x = eval(input('Enter  any  input  :  ')) # "25"
print(type(x)) # <class 'str'>
print(x) # '25' # Even number becomes string
---------------------------------------------------------------------------------------------------------
# What  is  a  better  approach  to  read  string  input ?
a = input('Enter  any  string  :  ') # "Hyd"
print(len(a))  # 3
print(a) # Hyd
b = eval(input('Enter   any  string  : ')) # Hyd # "Hyd"
