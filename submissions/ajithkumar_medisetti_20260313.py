...
Enter second list elements: 100 200 300 400
...
# Output:
Enter 1st list elements: 10 20 15 18 25 32
Enter 2nd list elements: 30 40 10 25 15
Output = [20, 18, 32]
...
Enter 2nd list elements: 30 40 35 32
