...
print(a [ : 7]) # a[0:7:1] --->  string  from  indexes  0  to  6  in  steps  of  2  i.e.Rama<space>Ra
...
print(a [ : -5 : -5]) # a[-1:-5:-5] --->  string  from  indexes  -1  to  -5  in  steps  of  -5  i.e. o
print(a [2 : -5]) # a[2:-5:1] --->  string  from  indexes  2  to  -6   in  steps  of  1  i.e. m
print(a [2 : -5 : 2]) # a[2:-5:2] --->  string  from  indexes  2  to  -6  in  steps  of  -1  i.e. m
...
Sample output:
Enter any string with alternate character and digit: A4$3K2_5 
Result : AAAA$$$KK____
...
print(len(' ')) # 1
print(len('A2#')) # 3
print(len(3456)) # ERROR because int can't have length
print('Sec'. len()) # ERROR because no argument inside len()
...
Enter any string with alternate character char and digit : HYD
Pls enter string with alternate digit
Press any key to continue

a=input('Enter any string with alternate character char and digit :')
out= ''
if len(a) % 2 != 0:
    print("Pls enter string with alternate digit")
else:
    for i in range(0, len(a), 2):
        ch = a[i]
        num = int(a[i+1])
        out += ch + chr(ord(ch) + num)
    print('Result :', out)
'''
