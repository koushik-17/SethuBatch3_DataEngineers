...
z = x + y * 6 
print(z) # 34
25 = a # Error refernce must be left side
a + b = x + y # Not supported assignment
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y) # False new list is created
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 4 , 3]
print(x == y) # False bcz order is important
a = (4 , 1 , 3 , 2)
b = (4 , 2 , 3 , 1)
print(a == b)  # False bcz order is important
p = {1 , 2 , 3 , 4}
q = {4 , 1 , 3 , 2}
print(p == q)   # True
m = range(5)
