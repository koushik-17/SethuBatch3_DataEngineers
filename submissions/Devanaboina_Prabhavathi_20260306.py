...
print(a [ : 7 : 2]) # 0 2 4 6 Rm a
print(a [ : 7])# [0:7:1] Rama Rao
print(a [2 : 4]) #[2:3] ma
print(a [2 : ]) # ma Rao
print(a [ : 4 ])# Rama
...
a = input("Enter input string: ")  # Example: A4M3Z5D2
out = ""
...
while True:
    try:
        index = a.index('is', start)  # find next occurrence
        print(index)
        start = index + 1  # move past current occurrence
...
try:
    ...
    while True:
        print(index)
        # Search in the part before current index
        index = a.rindex('is', 0, index)
except ValueError:
    pass  # no more occurrences
print('End')
...
#  Find  outputs  (Home  work)
a = 'Hyd is\tgreen\ncity.Hyd is\thitec\ncity.Hyd is\this\ncity'
print(a . count(' ')) # count space
print(a . count('\t')) # count tab
print(a . count('\n')) # count new tab