...
print( lambda   x  :  x * x(7)) # definition of lamda function should be in the form of (lambda arguments : expression) and it should be called with arguments. 
# <function <lambda> at 0x000001F03A94D080>
print( lambda   x  :   x * x) # <function <lambda> at 0x7f8b8c8c8c8c> 
...
# print(add()) # missing arguments
print(add) # <function <lambda> at 0x0000022A0359A980>
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) # TypeError: 'str' object is not callable
...
a  =  lambda  :  'Hyd'
print(a()) # Hyd
print(a) # <function <lambda> at 0x7f8c8c8c8c8c>
