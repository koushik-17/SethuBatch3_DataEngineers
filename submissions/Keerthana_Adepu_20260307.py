...
print(a . split('')) # Error because an argument need to be given inside the ''
...
e = [15 , 36 , 48]
print(':' . join(e)) # error , the list needs to contain string elements
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f)) # SankarDayalSarma
g = range(5)
print('-' . join(g)) # error , range is not a str class object
...
print('' . isdigit()) #   False
print(' ' . isdigit()) # False
print(9247 . isdigit()) # error , it's a str class method and needs a str object
...
print('a  :  {x}  \t  b  :  {y}  \t  c  :  {z}  ' . format(z = a , y = b , x = c)) # a : 'Hyd'  b : 'Hyd'    c : 'Hyd'
