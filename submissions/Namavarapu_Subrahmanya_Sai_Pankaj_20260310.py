...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
#a , *b , c , *d , e  = list # there cannot be another *unpacking
...
print('c : ' , c) # c: Hyd
print('d : ' , d) # d : True
# a , b , c , d = list #Error because there are three elements in list and references tp point
...
#print(How  to  determine  sum  of  inner  list  elements  in  another  way) # for x in a[0]:
# a = 0
#a = a+x
...
print(max(c)) # 10.8
d = [25 , '35'] 
print(max(d)) # error because cant compare str and int
print(max([])) # no elements in iterable
print(min([])) # no elements in iterable
...
a = list()
print(a) # []
print(list(25)) # non seqence
print(list(10.8)) # non sequence
print(list(True)) # non sequence
print(list(None)) # non sequnece
...
print(type(b)) # <class 'list'>
c = sorted(a , reverse = True) # [5, 10, 12, 15, 20]
...
a . insert(2 , b)
print(a) # 5
print(len(a)) # [10, 20, [50,60,70], 30, 40]
print(a[2][:])
print(a[2][0])
print(a[2][1])
print(a[2][2])
...
a = [10 , 20 , 15 , 18 , 12]
print(a . pop(2)) # deletes 15 return 15
print(a) # [10 , 20 , 18 , 12]
print(a . pop(len(a))) #  Raises  IndexError
print(a . pop(-3)) # [10 , 18 , 12]
print(a) # [10 , 18 , 12]
print(a . pop(-4)) # Raises  IndexError
