...
print(a . split(''))  #errorno delimeter
...
x=input('enter a expression with + symbols')
y=x.split('+')
z=[]
for i in y:
    z.append(int(i))
...
e = [15 , 36 , 48]
print(':' . join(e))  #error-join() method is for strings
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f))  #'SankarDayalSarma
g = range(5)
print('-' . join(g)) #error-join() method is for strings
...
print('' . isdigit()) #   False
print(' ' . isdigit())  #false
print(9247 . isdigit())  #error-no isdigit() method in int class
...
a=input('enter a string with alphabets and digits:')
b=''
c=''
