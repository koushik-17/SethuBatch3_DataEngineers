...
# End  of  class
a = c1()#c1 class constructor <nextline> error
b = c2()#implocit call #c2 class constructor <nextline> None
print(b)#type and address
print(b . __init__())#explicit call #c2 class constructor <nextline> None
c = c3()
...
del  a . x#delete x from object a
del  b . y#delete y from object b
print(a . __dict__)#{'y':20,'z':30}
print(b . __dict__)#{'x':10,'z':30}
print(a . x)#error not exist
print(b . y)#error not exist
'''
Object  'a'   --->  x=10 y=20 z=30 after deletion y=20 z=30
Object  'b'   --->  x=10 y=20 z=30 after deletion x=10 z=30
'''
