...
#     fahrenheit_list.append(celsius_to_farenheit(temp))
...
#function to compute power of two
def power_of_two(n):
    return 2 ** n
# create a map iterator range 0 - 9
...
2) Let  input  be  [3.5 , 2.8 , 4.2  , 1.9]
    What  are  the  outputs ?  --->  Area  of  radius  3.5
						                              ...
						                              Area  of  radius  1.9
'''
radii = eval(input('Enter a list ofradius: '))
...
largest = reduce(find_largest, lst)
