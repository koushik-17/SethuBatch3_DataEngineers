...
print({10 : 'Hyd' , 20 : 'Sec'} |  {30 : 'Cyb' , 20 : 'Vja'})   # error because pipe operator is only for set
print(range(4) | range(5)) # error because pipe operator is only for set not for range
print([10 , 20]  |  [30 , 20]) # error because pipe operator is only for set
...
# Find outputs
print(7 / 0)    # error because denominator must not be zero
print(7 // 0)     # error because denominator must not be zero
print(7 % 0)     # 7
...
z = x + y * 6
print(z)  #34
25 = a  # error because digit cannot get assigned
a + b = x + y  # error because of invalid expression

# Find outputs (Home work)
a = b = c = 25
print(id(a))  # address of 25
print(id(b))   # address of 25  , same as a
print(id(c))   # address of 25 , same as a and b
...
print(math . pow(-2 , -3))  # 0.12
print(math . pow(10 , -2))  # 0.01
print(math . pow(4 , math . pow(3 , 2)))  #  262144   === 4 ** 9
...
print(math . sqrt(-16)) # error because the value is negative
print(sqrt(49))  # error because method is not called
...
print(fabs(-25))  # error because method is not called with class
...
print(floor(3.5))  # error because method is not called with class
print(ceil(3.5))  # error because method is not called with class
