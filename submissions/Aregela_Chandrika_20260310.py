...
print(a + 5) # Error : can concatenate list to list
print(a + '5') # Error : can not concatenate list and str 
print([10 , 20] + (30 , 40)) # Error : can not concatenate list to tuple
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1 , 2 , 3] , Address : 456789957
a += b
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1 , 2 , 3], Address : 3456789
a  = a + b
print(a , id(a)) # [1, 2, 3, 4, 5, 6],  Different address: 2186189044224
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # Error : assigned multiple starred but should be one * 
...
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # Error : cannot add string and int
...
print(max(c)) # Error
d = [25 , '35']
print(max(d))  # Error : due to str and int
print(max([])) # Error : due to No-Args
print(min([])) # Error : due to No-Args
...
print(a) # ["V","a","m","s","i"]
a = list()
print(a) # Creates Empty list []
print(list(25)) # Error : due to non-sequnce
print(list(10.8)) # Error : due to non-sequnce
print(list(True)) # Error : due to non-sequnce
print(list(None)) # Error : due to non-sequnce
...
print(list(b)) # [(30, 40, 50), (60, 70, 80, 90), (10, 20)] in any order
...
del    a[2]
print(a) # [10 , 20 , 18]
del  a[3] # Error : No index 3 in [10 , 20 , 18]
...
try:
	...
	list . remove(15)
	print(list) # [10 , 20 , 15 , 18 , 15 , 12 , 15 , 19]
	list . remove(25)
except:
...
a = [10 , 20 , 15 , 18 , 12]
print(a . pop(2)) # Index 2 → element 15 is removed and printed i.e, 15
print(a) # [10, 20, 18, 12]
print(a . pop(len(a))) #  Error 
print(a . pop(-3)) # 20 is removed and printed i.e, 20
print(a) # [10, 18, 12]
print(a . pop(-4)) # Error
print(a . pop())  # pop() without index removes last element i.e, 12
print(a) # [10, 18]
b = [] 
b . pop() # Error : due to empty list
