...
print(int(3 + 4j)) #error because only float, binary, octal, hexadecimal and a few strings can be arguments for int()
print(int('25.4')) #25  
print(int('Ten')) #error because the value inside the string should have numericals for the function to detect it   
...
print(float('0075')) #75.00
print(float(0B1010101)) #64 + 16 + 4 + 1 #85.0
print(float(0O6247)) #6*8^3 + 2*8^2 + 4*8^1 + 7*8^0
print(float(0XA7B9)) #10*16^3 + 7*16^2 + 11*16^1 + 9*16^0
print(float(3 + 4j)) #error because only int, binary, octal, hexadecimal and a few strings can be arguments for float()
print(float('Ten')) #error because the value inside the string should have numericals for the function to detect it   
...
print(complex('3')) #3 + 0j
print(complex('3.8')) #3.8 + 0j
print(complex(3 , '4')) #error because only first argument in a complex() func can be string  
print(complex('3' , 4)) #error because 2nd argument is not permitted when the 1st argument is string  
print(complex('3' , '4')) #error because of both the above reasons
print(complex('Ten')) #error because the value inside the string (only for the 1st argument)  should have numericals for the function to detect it



bool() Function Homework
