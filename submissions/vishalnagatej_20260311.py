...
# b = a . copy()
# print(b)		    # [10 , 20 , 15 , 18]
# print(a  is  b)		# False becoz 'is' used to check the reference is same or not, using copy() returns new list
# print(a  ==  b)		# True becoz both objects having same elements
# c = a[:]
# print(c)		    # [10 , 20 , 15 , 18]
# print(a  is  c)		# False
# print(a  ==  c)		# True
