create database demodbfortest;
use demodbfortest;
create table employees_demo(emp_id int primary key auto_increment,emp_name varchar(50),department varchar(50),salary decimal(10,2),age int,joining_date date);
desc employees_demo;
show create table employees_demo;
