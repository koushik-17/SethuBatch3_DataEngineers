...
c = c3()
d = c4()
print(a)#<class '_main_.c1'>
print(b)#<class '_main_.c2'>
print(c)#<class '_main_.c3'>
print(d)#<class '_main_.c4'>
print(b . str())#'35'
print(c . str())#Hyd
print(d . str(50))#50

Write  a  program  to  determine  total , average  and  grade  of  a  student
Inputs  are  Roll Number , Stud  Name , Marks  of  3  subjects  and  Gende
