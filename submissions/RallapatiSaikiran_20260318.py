...
vowels=set('aeiou')
distinct_vowels=''.join(sorted(set(s)&vowels))
...
print(a)  # {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.6, 'Employee':Male , 'married': True}
...
print(a)    # 10:Rama   20:Sita    30:Rajesh    18:Kiran
...
print(40  not  in  a . values())   #  Falsw
...
c = {**a , **b}   
print(c)   #  {10:60,30:50}(b values overriten a's')
d = a | b
print(d)    #    {10:60,30:50}
