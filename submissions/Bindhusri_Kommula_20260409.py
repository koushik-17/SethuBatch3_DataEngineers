...
print('a  :  ' , a . __dict__) # a : {'dd1':15, mm1: 8, yy1 : 1947 }
print('b  :  ' , b . __dict__) # b : {'dd1':26, mm1: 1, yy1 : 1950 }
print('c  :  ' , c . __dict__) # c : {'dd1':19, mm1: 7, yy1 : 1985 }
d = Date() # error 3 args missing
e = Date(dd = 30 , mm = 4 , yy = 2022) # error 
f = Date(dd1 = 26 , mm1 = 8 , 2023) # error


'''
Object  'a'   --->  dd1=15 mm1=4 yy1=1947
