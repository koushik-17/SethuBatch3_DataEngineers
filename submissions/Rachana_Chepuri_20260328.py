...
# # 10
# ''' Find  outputs  (Home  work)'''
# # def  f1(b):#Error---tuple is immutable
# # 	b[2] = 25 
# # # End  of  the  function
# # a = (10 , 20 , 15 , 18)
# # print(a)
...
print(add(10 , 20))#30
print(add(10.6 , 20.8))#31.3
print(add('Hyder' , 'abad'))#Hyderabad
print(add(True , False))#1
print(add(25 , 10.8))#35.8
print(add(3 + 4j , 5 + 6j))# 8+10j
print(add(10 , '20'))#Error--due to int and string cannot concatenate
print(add())
...
a  =  lambda  :  'Hyd'
print(a())#Hyd
print(a)#Type and addess
'''Tricky  program'''
#Find  outputs
a  =  lambda  :  print('Hyd');  print('Sec')  ; print('Cyb')
a()#Sec<nxtline>Cyb<nxtline>Hyd
'''Find  outputs  (Home  work)'''
s = 'Hyd'
...
for  x  in  a:
	     x()
a = [def   f1():  print('Hyd') ,  def   f2():  print('Sec')]#Error----in comprehsion def is not defined
print(a)
'''output'''
Hyd
Sec
...
for i in range(n):
    print(fib(i), end=" ")#How  to  print  first  'n'  terms  of  fibonacci  series
...
print('a^b =', power(a, b))#How  to  print  a , b  and  a ^ b
'''
