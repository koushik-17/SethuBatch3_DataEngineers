...
a = {10 : 20 , 30 : 40 , 50 : 60}
print(sum(a . keys()))  # sum of Keys
print(sum(a . values()))  # Sum of values 
print(sum(a))  # Sum of values 
...
Nested  sequence  such  as  list  of  tuples , list  of  lists , tuple  of  tuples , tuple  of  lists,set  of  tuples  and  so  on
