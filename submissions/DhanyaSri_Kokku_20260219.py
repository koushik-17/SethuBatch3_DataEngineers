...
print(range(4) | range(5)) # Error range object cannot be concatenated wth pipe method
print([10 , 20]  |  [30 , 20]) # Error list object cannot be concatenated with pipe method
...
# Find outputs
print(7 / 0) # Error a number cannot be divided with zero 
print(7 // 0) # Error a number cannot be divided with zero 
print(7 % 0) # Error a number cannot be divided with zero 
...
print(10 == 10.0) # True
print(3 + 4j >  3 + 4j) # Error complex number cannot be compared with a '>' operator
...
z = x + y * 6
print(z) # 34
25 = a # Error the left side of the assignment operator should be a reference not a object 
a + b = x + y # Error the left side of the assignment operator should be a reference not a object

# Find outputs (Home work)
a = b = c = 25
print(id(a)) # Address of the object 25
print(id(b)) # Address of the object 25
print(id(c)) # Address of the object 25
...
print(math . sqrt(3+4j)) # Error the argument for the sqrt() should be real
print(math . sqrt(math . sqrt(256))) # 4.0
print(math . sqrt(math . pow(3 , 4))) # 9.0
print(math . sqrt(-16)) # Error the argument for the sqrt() should not be negative
print(sqrt(49)) # Error math module is not mentioned while using the method
...
print(fabs(-25)) # Error math module is not mentioned while using the method
...
print(floor(3.5)) # Error math module is not mentioned while using the method
print(ceil(3.5)) # Error math module is not mentioned while using the method
