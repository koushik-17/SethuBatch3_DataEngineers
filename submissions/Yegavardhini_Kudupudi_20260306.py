...
print(a [-6 : ]) # a[-6:8:1]--> ma Rao
print(a [: -4 : -1]) # a[-1:-4:-1]-->oaR
print(a [-3 : -1]) # a[-3:-1:1]--> Ra
print(a [-3 : ]) # a[-3:8:1]--> Rao
print(a [ : : ]) # a[0:7:2]--> Rma Rao
print(a [ : ]) # a[0:7:2]--> Rama Rao
print(a [ : : -1]) # a[0:7:2]--> oaR amaR
print(a [ : : -2])  #  a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
print(a [ -2 : : -2])  # a[0:7:2]--> a mR
print(a [2 : 8]) # a[0:7:2]--> ma Rao
print(a [2 : 8 : -1]) # a[0:7:2]--> 
print(a [ : -6 : -1]) # a[0:7:2]--> oaR a
print(a [2 : -3]) # a[0:7:2]--> ma
print(a [1 : 6 : 2]) # a[0:7:2]--> aaR
print(a [ : -5 : -5]) # a[0:7:2]--> o
print(a [2 : -5]) # a[0:7:2]--> m
print(a [2 : -5 : 2]) # a[0:7:2]--> m
print(a [ : 0 : -1]) # a[0:7:2]--> oaR ama
print(a [-5 : 0 : -2]) # a[0:7:2]--> aa
...
if len(a) > 2 and len(b) > 2:
    ...
    print("length of string should be more than 2")
...
What  are  the  outputs ?  --->  Character  at  index  0  :  V		                                  Character  at  index  1  :  A
...
for i in a:
    if i not in ch:
        ch = ch + i
print("string without duplicates : ", ch)
...
print(len(' '))#1
print(len('A2#'))#3
print(len(3456))# error integers have no length
print('Sec'. len()) # error 
