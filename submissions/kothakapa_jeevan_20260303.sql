...
show tables;
insert into student_details values (10,'Ram'),(11,'abc'),(12,'Hyd');
select * from student_details;

create table employees(Emp_id int auto_increment primary key,Emp_name varchar(20),salary decimal (10,2));
insert into employees (emp_name,salary)values ('Ram',10000);
select * from employees;
insert into employees values('Sanju',12000);
insert into employees values('Nani',11000);
...
#auto increment = 500;
insert into employee_autoINR (emp_name) values ('Ram');
insert into employee_autoINR (emp_name) values ('Sita');
...
insert into user_test values(10,'rajeshrang11@gmail.com','Ram1122@');
insert into user_test values(20,'hanuma1010@gmail.com','rAnga000%');
insert into user_test values(30,'hanuma1010@gmail.com','Human08081');
show errors;
