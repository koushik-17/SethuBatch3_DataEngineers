...
#a[4] = 32 #range is immutble 
#print(a * 2) #range object is not repeated because its immutable 
...
e = range(-10)
print(*e) #Empty squence 
f = range(2 , 2)
print(*f) #2 1
#g = range(10 , 11 , 0.1) #float objects cann't used in range 
#h = range('A' , 'F') #string object is not supported in range object
...
#a , b , c = *r   #Error
m = r  
print(id(r)) #Address of the r
print(id(m)) #Address of m
...
#a . remove('25')
#print(a) #Error because there is no element str'25' present in the list
...
print(a * 0) #[]
print(a * -1) #[]
#print(a * 4.0) #Error Cannot mutiply squence with float
a = a * 3
print(a) #[25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd']
print(id(a)) #Address of list a is printed 
a = [25]
print(a , id(a)) #[25] Address of list a 
#print(a * a) #cannot multiply list to list #Error
...
print(list[2 : -5]) #[3+4j]
print(list[-1:-5]) #[] #because the defalut step is 1 
...
#     0     1     2    3     4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a)) #[10 , 20 , 30 , 40 , 50],Address of list a
a[1 : 4] = [60 , 70] #[20,30,40] = [60,70]
print(a , id(a)) #[10,60,70,50],Address of list a
a[2: 4] = [100 , 200 ,  300] #[70,50] = [100,200,300] 
print(a , id(a)) #[10,60,100,200,300], Address of list a 


#  Find  outputs  (Home  work)
a =  [25]
#print(a[1]) #Error because there is no index no 1 
print(a[1:]) #Error or []