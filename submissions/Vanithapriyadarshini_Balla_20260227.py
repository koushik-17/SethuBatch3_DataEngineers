...
# End of loop
print('Outside loop')
'''1<nl>Sec<nl>Hello<nl>2<nl>Sec<nl>Hello<nl>3<nl>4<nl>Sec<nl>Hello<nl>5<nl>Sec<nl>Hello<nl>6<nl>7<nl>Sec<nl>Hello<nl>
Outside loop'''

# Identify Error  (Home  work)
if ():
	print('Hyd')
	continue      # Error ,bcz continue should be used with loops
	print('Sec')
...
if(10 , 20 , 30):
	print('Hyd')
	break       # Error ,bcz break should be used with loops
	print('Sec')
