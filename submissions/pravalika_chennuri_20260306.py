...
a = 'Rama Rao'     # step = +1 then end = end - 1  and step = -1 then end = end +1
...
print(a [-6 : -1]) # a[-6 : 0 : 1]   --->  string  from  indexes  -6  to  -1  in  steps  of  1  i.e. ma<space>Ra
print(a [-6 : ]) # a[-6 : 0 : 1]   --->  string  from  indexes  -6  to -1  in  steps  of  1  i.e. ma<space>Rao
print(a [: -4 : -1]) # a[-1 :-4: -1]   --->  string  from  indexes  0  to  -3  in  steps  of  -1  i.e. oaR
...
print(a [ : ]) # a[0 : 8 : 1]   --->  string  from  indexes  0  to  7  in  steps  of  1  i.e. Rama Rao
print(a [ : : -1]) # a[-1 : -8 : -1]   --->  string  from  indexes  -1  to  -8  in  steps  of  2  i.e. oaR amaR
print(a [ : : -2])  #  a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
print(a [ -2 : : -2]) # a[-2 : -9 : -2]   --->  string  from  indexes  -2  to  -9  in  steps  of  -2  i.e. a<space>mR 
print(a [2 : 8]) # a[2 : 8 : 1]   --->  string  from  indexes  2  to  7  in  steps  of  1  i.e. ma Rao
print(a [2 : 8 : -1]) # a[2 : 8 : -1]   --->  string  from  indexes  2  to  7  in  steps  of  -1  i.e. Nothing
...
print(a [ : 0 : -1]) # a[-1 : 0 : -1]   --->  string  from  indexes  -1  to  0  in  steps  of  -1  i.e. oaR ama
...
if len(a)>=2 and len(b)>=2:
    a1=a[:2]
    b1=b[:2]
    print("result : ", b1 + a[2:], a1 + b[2:] , sep = " ")
else:
    print(" please enter  each  string  has  a   minimum  of  two  characters ")
...
if len(a)>=4:
    ...
    print("please enter  each  string  has  a   minimum  of  four  characters")
...
for i in range(len(a)):
    if i%2==0:
        ...
        odd += a[i]
print("strings at even indexs : ", even)
print("strings at odd indexs : ", odd)
...
try:
    a = input("enter any string with alternative character and digit : ")
    output = ""
    for i in range(0,len(a),2):
        output += (a[i]* int(a[i+1])) 
    print("result : ", output)
except(ValueError):
    print("string should have one character and one digit")
...
try:
    ...
    output = ""
    for i in range(0,len(a),2):
        output += (a[i] + chr(ord(a[i]) + int(a[i+1])))
    print("Result : ", output)
except(ValueError):
    print("string should have one character and one digit")
