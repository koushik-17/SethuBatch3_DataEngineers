(Home  work)
1.Write  a  program  to  convert  a  dictionary  {'Empno' : 25 , 'Ename' : 'Rama  Rao' , 'Sal' : 10000.0}  to  Emp  class  object
...
'''
6.Write  a  program  to  add , subtract , multiply  and  divide  two  rational  numbers
