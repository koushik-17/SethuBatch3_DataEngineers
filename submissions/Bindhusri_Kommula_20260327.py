...
print( lambda   x  :  x * x(7)) # <function <lambda> at hexadecimal add>
print( lambda   x  :   x * x) # <function <lambda> at hexadecimal add>
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) #type and add
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) # type and add
print(lambda  x  :  print(x) (s)) # type and add
...
key = 'power_3'
print(a[key]) # <function <lambda> at hexadecimaladd>
print(a[key](5)) ## 125
