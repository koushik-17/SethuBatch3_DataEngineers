...
13.# isspace()  method  demo  program  (Home  work)
...
14.# islower()  method  demo  program  (Home  work)
...
'''
16.Write  a  program  to  determine  user  input  is  alphabet , digit , white space  or  special  character
...
'''
17.Write  a  program  to  reverse  a  string  without  slice
...
'''
18.Write  a  program  to  reverse  order  of  words  in  the  sentence  without  slice
...
'''
20.Write  a  program  to  sort  string  in  alphabetical  order
