...
a = {10 : 20 , 30 : 40 , 50 : 60}
print(sum(a . keys())) #120
print(sum(a . values())) #120
print(sum(a)) #120-default keys addition
#print(sum(a . items())) #error-can't add tuples
#================================================================================================================================
...
#print(dict(e)) #error dict has only key-value pair
f = [[10] , [20] , [30]]
#print(dict(f)) #error dict has only key-value pair
#print(dict([10 , 20])) 
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) #{10:[20,30],40:[50,60],70:[80,90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
#print(dict(h)) #error can't use list as key
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') #10...Hyd     20...Sec    15...Cyb    18...Pune
#for  x , y   in  a . keys(): error  keys should be only 1 but here there are 2
       print(x , y , sep = ' ... ') #10...Hyd     20...Sec    15...Cyb    18...Pune
...
a = {}                     # Step 2: empty dictionary

for ch in sorted(s):       # Step 3: sort characters
    if ch.isalpha():       # Step 4: ignore spaces / non-alphabets
        a[ch] = a.get(ch, 0) + 1
