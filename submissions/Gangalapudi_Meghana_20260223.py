...
print(a , b , c , separator = ':')       #Error - separator parameter does not exist we have 'sep' parameter instead.
...
print(F'{a:}  \t   {b:}   \t  {c:}')               #print(F'{a:}  \t   {b:}   \t  {c:}')
print('a  =  {a}  \t  b  =  {b}  \t  c  =   {c}')  #a  =  {a}      b  =  {b}      c  =   {c}
print(F'a  =  a  \t  b  =  b  \t  c  =  c')        #a  =  a      b  =  b      c  =  c
print(F'{x =}  \t   {y =}   \t  {z =}')            #Error - Because variables x, y, z are not defined.
