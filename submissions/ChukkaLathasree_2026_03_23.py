...
# End  of  the  function
disp(25 , 'Rama  Rao' , 10000.0) ---> 25 , 'Rama Rao' , 10000.0
disp('Sita' , 20000.0 , 35) # error due to positional value and key word are different
...
# Find  outputs (Home  work)
def    disp(empno , ename , sal):
        print(F'Emp  Number : {empno:4}  \t  Emp  Name : {ename:15}  \t  Salary : {sal}') # Error
# End  of  the  function
disp(25 , 'Rama Rao' , 10000.0) # 25,'Rama Rao' , 10000.0
...
y = 30000.0
z = 20
disp(x , y , z) # 'Rama Rao' , 30000.0 , 20 
