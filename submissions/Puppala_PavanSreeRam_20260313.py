...
#Write  a  program  to  create  a  list  with  cubes  of  2 , 4 , 6 , 8 , 10
...
##Write  a  program  to  extract  those  elements  of  1st  list  which  are  not  in  2nd  list
...
##Write  a  program  to  add  each  element  of  1st  list  with
