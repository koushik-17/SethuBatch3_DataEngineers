...
a = c1()
b = c2()
print(issubclass(b , a))# in issubclass anyone of the arguments must be a class
...
print(issubclass(c4 , [int , float , c1 , str , bool]))##a cannot be a list of types
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool]))#a cannot be a list of types
