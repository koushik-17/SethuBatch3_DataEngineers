...
a += b 
print(a , id(a)) # (1,2,3,4,5,6) new address of object a
...
print(c) # Hyd
print(d) # True
p , q , r =  x # Error x has more values
a , b , c , d  , e = x # Error not sufficient elements
...
print(id(a)) # a new address of object a
...
a . add(25)# True,25,10.8,1,'Hyd' #as 25 is already present in the set
a . add(None)# True,25,10.8,1,'Hyd',None
a . add('Hyd')# True,25,10.8,1,'Hyd',None #as 'Hyd' is already present in the set
a . add(1.0)# True,25,10.8,1,'Hyd',None#as 1 is already present in the set
