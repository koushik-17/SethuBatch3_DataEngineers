...
a = [10 , 20 , 15 , 18]
print(a) # [10 , 20 , 15 , 18]
change(a) # Error , sending wrong argument
print(a) # [10 , 17 , 18 , 25]
...
print( lambda   x  :  x * x(7)) # returns type and address
print( lambda   x  :   x * x) # returns type and address
