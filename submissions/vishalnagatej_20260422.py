...
import time
list = eval(input('Enter list od celsius tempreture : '))
print('Equivalent farenheit tempreture')
a = map(lambda x : 1.8 * x + 32,list)
for i in a:
    print(i)
    time.sleep(1)
...
2) Let  input  be  [3.5 , 2.9 , 4.6  , 1.8]
...
a = eval(input('Enter 1st tuple : '))
b = eval(input('Enter 2nd tuple : ')) 
c = tuple(map(lambda x,y : x + y , a , b))
print('Addition tuple : ',c)
...
a = eval(input('Enter list of strings (or) numbers : '))
...
# End  of  for  loop
c3 = count()
# print('Element :  ' , next(c3))  # error , because count() produce infinate numbers so , it takes lot of time and  it throws memory error
c4 = count()
# print(*c4)            # error , because count() produce infinate numbers so , it takes lot of time and  it throws memory error
...
d = count()
# disp(d)               # error , count() is throws infinate numbers. so, it takes lot of time and throws memory error
