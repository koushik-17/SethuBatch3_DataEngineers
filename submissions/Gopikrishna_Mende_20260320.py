...
b = a . copy()
print(b) # {'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue'}{'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue'}
print(a  is  b) #False
print(a  ==  b) # True
...
print(type(b))
for  x  in   b:
        print(x)  # 10 <new line> 20 <new line> 15 <new line> 18 
...
for  x   in   b:
        print(x) #(10, 'Hyd')<new line>(20, 'Sec') <new line> (15, 'Cyb') <new line>(18, 'Pune')
for  x , y   in  b:
        print(x , y , sep = ' ... ')
        # 10 ... Hyd
        # 20 ... Sec
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') # 10 ... Hyd <new line> 20 ... Sec <mnew line> 15 ... Cyb <new line>18 ... Pune
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ') # Error
for  x , y   in  a . values():
       print(x , y , sep = ' ... ') # Error
