#  Find  outputs - | union it combines unique elements – works for set, dict and does not 
work for list and range  
print({10 , 20}  |  {30 , 20}) # {10, 20, 30} 
print({10 : 'Hyd' , 20 : 'Sec'} |  {30 : 'Cyb' , 20 : 'Vja'})  # {10:'Hyd', 20:'Vja', 30:'Cyb'} 
print(range(4) | range(5)) # Error as range doesn’t support union 
print([10 , 20]  |  [30 , 20]) # Error as list doesn’t support union 
...
print(8.5 // 3) # 2.0 
print(18 // 4) # 4 
print(-18 // 4)  #  Tricky -18 / 4 = -4.5 = -5 
print(-(18 // 4))  #  Tricky 18 // 4 = 4 = -4 
# Find outputs 
print(7 / 0)  # division by zero is not allowed in python 
print(7 // 0) # division by zero is not allowed in python 
print(7 % 0) # division by zero is not allowed in python 
# ** operator demo program 
print(3 ** 4)  #   3 ^ 4 = 81 
...
print(10 == 10.0) # True 
print(3 + 4j >  3 + 4j) # Error as python don’t allow comparing complex number 
...
z = x + y * 6  
print(z) #34 
25 = a  # Error due to we cannot use a integer as reference 
a + b = x + y # Error  
# Find outputs (Home work) 
a = b = c = 25 
...
print(sqrt(49)) #Error due to math not written/ imported. 
...
print(fabs(-25)) #Error due to math not imported. 
...
print(floor(3.5))# Error due to math not imported. 
print(ceil(3.5)) #Error due to math not imported. 