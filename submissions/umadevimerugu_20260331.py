...
print(b)#[ {'Make' : 'Tesla' , 'Model' : 'X' , 'Year' : 1999},{'Make' : 'Ford' , 'Model' : 'Focus' , 'Year' : 2013}  ,{'Make' : 'Mercedes' , 'Model' : 'C350E' , 'Year' : 2008} ]
print(sorted(a))#
############################################################################################
 # Find outputs  (Home  work)
...
f1()A#error bcz infinite times calling the functions eachother
############################################################################################
 #  Find  outputs  (Home  work)
def  f1():
        print('f1    function')
...
How  to  call  print()  function  thru  ref  'p'  and   print  'Hyderabad' #p('hello')
print = None
print('Hello')
...
How  to  call  id()  function  thru  ref  'x'  and   print  id  of  object 25#print(i(25))
