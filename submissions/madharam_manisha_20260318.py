...
print(id(a)) #address of a which may be 2000
#================================================================================================================
...
print(a  is  b) #False
print(a  ==  b) #True
c = a #{10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh' , 18 : 'Kiran'}
print(a  is   c) #True
print(a  ==  c) #True
#==================================================================================================================
#Find  outputs  (Home  work)
...
a = {}
b = int(input('enter the no of values:'))
for i in range(b):
