...
print(sum(a . items()))#error due to + between int and typle
...
print(dict(e))#error due 3 elements in inner sequence
f = [[10] , [20] , [30]]
print(dict(f))#error due to single element in inner sequence
print(dict([10 , 20]))#error due to sequence we need nested-sequence
...
dn=eval(input("Enter dictionary : "))
nd=sorted(dn.items())
print(dict(nd))
...
st=input("Enter mixed case string : ").upper()
a={}
nw_st=sorted(st)
for i in nw_st:
    if i.isalpha():
...
b = {}
b.update(a)
print(b)#error due to more than 2 element nested-sequence
c = [(10,) , (20,) , (30,)]
b . update(c)
print(b)#error due to single element in nested-sequence
