...
b = sorted(a)
print(b) #['Amar','Kiran','Rajesh','Rama','Rama Rao','sita','Vamshi']
c = sorted(a , reverse = True)
...
print(a[2][1]) #How  to  print  50)
print(a[2][2]) #How  to  print  60)
print(a[2][3]) #how  to  print  70)
...
b = int(input('Enter a element to be deleted : '))
for x in a:
    if x == b:
        a.remove(x)
print(a)
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() #we can't sort integers and strings 
...
if a.count(a[0]) == len(a):
    ...
    print('All elememts are not identical ')
