...
a = c1()
b = c2()
print(issubclass(b , a)) # error , argument needs to be a class
print(issubclass(c2 , a)) # error , argument needs to be a class
...
print(issubclass(c4 , [int , float , c1 , str , bool])) # error , argument needs to be a tuple of classes not list
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool])) # error , argument needs to be a tuple of classes not list
