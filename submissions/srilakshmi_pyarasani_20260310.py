...
print(a + 5)#Error because 5 is int
print(a + '5')#Error because '5' is string
print([10 , 20] + (30 , 40))#Error because of tuple
...
print(a , id(a))#[1,2,3], address of list a
a  = a + b
print(a , id(a))#[1,2,3,4,5,6], address of new list
...
print(sum(d))#63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e))#Error because of string
...
16) outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a))#Error because it is not valid
...
17) max()  and  min()  functions  demo  program  
...
print(min(b))#Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c))#Error because it is not valid 
d = [25 , '35']
print(max(d))#Error because it is not valid 
print(max([]))#Error because it is not valid 
print(min([]))#Error because it is not valid 
...
a = list()
print(a)#Empty
print(list(25)) #Error because it is not valid 
print(list(10.8))#Error because it is not valid 
print(list(True))#Error because it is not valid 
print(list(None))#Error because it is not valid 
...
print(a[2])(How  to  print  'H')
print(a[1])(How  to  print  'y')
print(a[0])(How  to  print  'd')
...
print(a . pop(2))#15
print(a)#[10, 20. 18, 12]
print(a . pop(len(a)))#Error because it is not valid
print(a . pop(-3))#20
print(a)#[10, 18, 12]
print(a . pop(-4))#Error because it is not valid
print(a . pop())#[10,18]
print(a)#empty
b = []
b . pop()
...
35) reverse()  method  demo  program 
a = [10 , 20 , 15 , 18]
print(a)#[10, 20, 15, 18]
a . reverse()
print(a)#[18, 15, 20, 10]
...
38) Identify  error 
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()#Error because it is not valid

39) count()  method  demo    program 
