Name-Dhruva Gupta			Subject-Python			Date-19/2/26

1)
#  Find  outputs
print({10 , 20}  |  {30 , 20}) #{10,20,30}
print({10 : 'Hyd' , 20 : 'Sec'} |  {30 : 'Cyb' , 20 : ‘Vja'}) #{10:’Hyd’,20 : ’Vja’ , 30 : 'Cyb'}
print(range(4) | range(5)) #range won’t have duplicates so Range does not support it
print([10 , 20]  |  [30 , 20]) #List won’t support it
...
3)
# Find outputs
print(7 / 0) #Division by 0 not allowed
print(7 // 0) #Division by 0 not allowed
print(7 % 0) #Modulus of 0 not allowed
...
print(10 == 10.0) #True
print(3 + 4j >  3 + 4j) #Error as they only support == and !=
...
z = x + y * 6 
print(z) #34
25 = a #Assignment error
a + b = x + y #Assignment Error

12)
# Find outputs (Home work)
a = b = c = 25
print(id(a)) #Object Id
print(id(b)) #Same Object Id
print(id(c)) #Same Object Id
...
import  math
print(math . pow(2 , 3))  #  2 ^ 3 = 8, always int
print(math . pow(-2 , -3)) #-0.125
print(math . pow(10 , -2)) #0.01
print(math . pow(4 , math . pow(3 , 2))) #262144.0, always float

26)
# sqrt()  function  demo  program
import  math
print(math . sqrt(25)) #5.0 return float as well
...
print(sqrt(49)) #Error as sqrt to call
