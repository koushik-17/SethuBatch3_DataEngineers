...
for  i   in   range(1 , 8):
	...
	print('Hello')
# End of loop
print('Outside loop') # 1 <nl> sec <nl> Hello <nl> 2 <nl> sec <nl> hello <nl> 3 <nl> 4 <nl> sec ........outside loop

# Identify Error  (Home  work)
if ():
	print('Hyd')
	continue  # error due to no loops
	print('Sec')
...
for  i   in   range(1 , 8):
	...
	print('Hello') 
# End  of  the  loop
print('Outside loop') # 1 <nl> sec <nextline> hello <nextline> 2 <nl> sec <nl> hello <nl> 3 <nl> outside loop
