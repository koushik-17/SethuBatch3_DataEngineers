...
print(id(a))                    #12345678909876543
print(len(a))                   #8
print(*a[2 : 7] , sep = ' , ')  #20 , 25 , 30 , 35 , 40
print(*a[ : : -1])              #45 40 35 30 25 20 15 10
a[4] = 32                       #Error - Range objects are immutable.
print(a * 2)                    #Error
...
g = range(10 , 11 , 0.1)    #Step must be an integer.
...
a . remove('25')
print(a)# Error - becz '25' is a string which is not listed/mentioned in list.
...
print(a * 0)#[]
print(a * -1)#[]
print(a * 4.0)#Error - we can not multiply sequence by non-int of type 'float'
a = a * 3
print(a)#[25, 10.8, 'Hyd', 25, 10.8, 'Hyd', 25, 10.8, 'Hyd']
print(id(a))#123456789
a = [25]
print(a , id(a))#[25] 123456789
print(a * a)#Error - we can not multiply sequence by non-int of type 'list
...
#     0    1   2    3    4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a))                    #[10, 20, 30, 40, 50] 123456789
a[1 : 4] = [60 , 70]
print(a , id(a))                    #[10, 60, 70, 50] 123456789 (same memory address)
a[2: 4] = [100 , 200 ,  300]
print(a , id(a))                    #[10, 60, 100, 200, 300] 123456789 (same memory address)


#  Find  outputs  (Home  work)
a =  [25]
print(a[1])                         #Error - becz the list contains item till index zero only.
