...
for ch in s:
    if ch.lower() in vowels:
        result.add(ch.upper())
print("Distinct vowels :", "".join(sorted(result)))
...
How  to  append  18 : 'Kiran'  to  dictionary  'a'  # a[15] = 'Rajesh'
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b)  # Error because dictionaries do not support + operator
c = {**a , **b}
print(c)  # {10: 60, 30: 50}
d = a | b
print(d)  # {10: 60, 30: 50}
