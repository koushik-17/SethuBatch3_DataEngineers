...
f = range(2 , 2)
print(*f) # error
g = range(10 , 11 , 0.1) # error float is not permitted
h = range('A' , 'F') # error string is not permitted
...
a . remove('25')# error there is int 25 not str 25
print(a) [25 , 10.8 , True]
...
print(a * 0) # []
print(a * -1) # []
print(a * 4.0) # error float is not permitted
a = a * 3
print(a) # [25 , 10.8 , 'Hyd' , 25 , 10.8 , 'Hyd' , 25 , 10.8 , 'Hyd']
print(id(a)) # address of the object
a = [25]
print(a , id(a)) # [25] and address of the object
...
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a)) # [10 , 20 , 30 , 40 , 50] and address of the object
a[1 : 4] = [60 , 70] 
print(a , id(a)) # [10 , 60 , 70 , 50] and address of the object
a[2: 4] = [100 , 200 ,  300] 
print(a , id(a)) # [10 , 60 , 100 , 200 , 300] and address of the object 

a =  [25]
print(a[1]) # error there is only one element and cannot have non-sequence
print(a[1:]) []
