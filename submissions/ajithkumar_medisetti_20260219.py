...
# Find outputs (Home work)
a = b = c = 25
print(id(a)) # Addres Of The Object 25
...
print(math . sqrt(10)) # 3.16227
print(math . sqrt(6.25)) # 2.5
print(math . sqrt(True)) # 1.0
print(math . sqrt(3+4j)) # (2.1213203435596424+1.0606601717798212j)
print(math . sqrt(math . sqrt(256))) # 4.0
print(math . sqrt(math . pow(3 , 4))) # 81.0
print(math . sqrt(-16)) # Error Because It Negative Number
print(sqrt(49)) # Error Because Sqrt Is Not Defined
...
print(fabs(-25)) # Error fabs Is Not Defined
