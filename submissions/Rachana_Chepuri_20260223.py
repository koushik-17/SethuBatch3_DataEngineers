...
print(a , b , c , separator = ':') # Error because : not permitted
...
print('%s'  %a) #Hyd
print('%s' , a) #%s Hyd
print('%s'  a) #error due to % mising
print('%s' , %a) #error due to  format missing
print(a) #Hyd
...
print('%s'  a) #error due to % is missing
print('%s' , %a) #error due to  format missing
print('%l'  %a) #error due to use only lowercase
print(a) # [10 , 20 , 30 , 40]
...
print('%d    %g      %s'   a , b , c)   # error due to comma missing
print('%d    %g    %s'  ,  %(a , b , c))  # error due to wrong format
print('%d    %g    %s'    %a%b%c)   # error due to wrong order format
...
print(F'{x =}  \t   {y =}   \t  {z =}') # error no values for x y z
