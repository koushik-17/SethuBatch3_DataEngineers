...
# for x , y  in a.keys(): print(x,y) # error because cannot unpack non-iterable int object
# for x , y  in a.values(): print(x,y) # error because not enough values to unpack
# for x , y  in a: print(x,y) # error because cannot unpack non-iterable int object
...
print("result:", a) # result: {'A': 3, 'M': 1, 'O': 1, 'R': 2}
