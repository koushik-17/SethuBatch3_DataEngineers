...
class  triangle:
	def  get(self):
		self.x = float(input('Enter 1st side: '))
		self.y = float(input('Enter 2nd side: '))
		self.z = float(input('Enter 3rd side: '))
	def  test(self):
...
'''
import SALENDRI_SHIRISHA_20260407 as s
a = s.triangle() #How  to  create  triangle  object
s.triangle.get(a) #How  to  call  get()  method  in  another  way
s.triangle.test(a) #How  to  call  test()  method  in  another  way
print('Area : ', s.triangle.area(a)) #How  to  call  area()  method  in  another  way
print('Perimeter: ', s.triangle.peri(a)) #How  to  call  peri()  method  in  another  way
...
d =
e =
f = #How  to  create  6  objects  a , b , c , d , e , f
...
Meow Meow Meow .... <next line> Bhow Bhow Bhow .... <next line> Mehar  Mehar  Mehar  ....
