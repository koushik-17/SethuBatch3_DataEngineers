...
print(range(4) | range(5)) # Error as range object doesnot support
...
# Find outputs
print(7 / 0) # Error as denominator is 0
print(7 // 0) # Error as denominator is 0
print(7 % 0) #Error
...
print(fabs(-25)) # Error as function is not defined
...
print(floor(3.5))#Error as floor is not defined
print(ceil(3.5))#Error as ceil is not defined
