...
print(id(a))#some system generated address say 2000
...
print(id(a))#same system generated address 2000
...
a  =  {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(a)#{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
How  to  append  'Gender' : 'M'  to  dictionary  'a'#a['Gender'] = 'M'or a.update({'Gender':'M'})
How  to  append  'Married' :  True  to  dictionary  'a'#a['Married'] = 'M'or a.update({'Married':'Yes'})
print(a)#{'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65 ,'Gender':'M','Married':'Yes' }
...
for i in range(n):
	Ename=input("enter employee number:"))
