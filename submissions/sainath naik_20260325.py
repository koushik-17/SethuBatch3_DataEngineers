...
10.# Default  arguments  demo  program
...
25.#  Variable  number  of  arguments  demo  program
...
'''
26.#  Write  a  function  to  determine  average  of  arguments  passed  to  the  function (Home  work)
def  avg(*a):
...
27.# Write  a  function  to  concatenate  strings  passed  to  the  function ? (Home  work)
'''
def  concat(*a):
...
31.# Which  of  the  following  are  valid  ?  (Home  work)
...
33.# Variable  number  of  keyword  arguments  demo  program
def   disp(**a):
	print('Results')
	print(type(a))
	print(a)
