...
print(*a[2 : 5]) # 'Hyd'  True  3+4j
a[2] = 'Sec'
a . append('Sec') # Error because append doesn't exist in the tuple
a . remove('Hyd') # Error because remove doesn't exist in the tuple
b =  10 , 20 , 30
print(b) #(10 , 20 , 30)
...
print(tuple(25)) # Error because 25 is an non-sequence
...
print(id(a)) # address of the updated tuple object 