1) sep  argument  demo  program outputs
a , b , c = 25 , 10.8 , 'Hyd'
...
print(a , b , c , separator = ':')#Error because : is not valid
...
print('%s'  %a)#Hyd
print('%s' , a)#%s Hyd
print('%s'  a)#Error because it is not valid
print('%s' , %a)#Error because it is not valid
print(a)#Hyd
...
print('%s'  a)#Error because it is not valid
print('%s' , %a)#Error because it is not valid
print('%l'  %a)#Error because it is not valid
print(a)#[10 , 20 , 30 , 40]
...
print('%d    %g      %s'   a , b , c)#error it is not valid
print('%d    %g    %s'  ,  %(a , b , c))#error it is not valid
print('%d    %g    %s'    %a%b%c)#error it is not valid
...
print(F'{x =}  \t   {y =}   \t  {z =}')#Error it is not valid
