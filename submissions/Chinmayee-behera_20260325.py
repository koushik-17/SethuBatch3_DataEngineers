...
f1(50 , 60) # error, after * it should be keyword arguments 
f1(70 , b = 80) # error
f1(a = 15 , 25) # error
...
def   f1(a  , b , *): # after * atleast 1 arg should be present
        pass
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c): # atleast 1 arg should be there before /
        pass
def   f2(a , b , c , *):  # atleast 1 arg should be there after *
        pass
...
# Identify  error  (Home  work)
def  f4(* , a , b , c , /):
	        pass  # error because after * everything should be keyword arg and everything before it should be positional arg, so it is not possible
...
# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d): # b and d should be passed first
	pass
...
# Find  outputs(Home  work)
def   add(a = 10 , b , c): # non-defaut arg should come first
        pass
def   add( * , a = 10 , b , c ):
        return  a + b + c
# End  of  the  function
...
def   add(a , b = 10 ,  c ,  * , d  , e = 20 , f): # error after * only keyword arguments should be there
		pass
...
print('Default Values  :  ' , f1 . __defaults__) #Default Values  : (HydSec,[1,2,3])
...
f1(70) # a : 70  \t   b  :  ()
f1(a = 80) # a : 80 \t   b  :  ()
f1(b = (10 , 20 , 30) , a = 40) # a : (10 , 20 , 30)  \t   b  :  (40,)
f1() # a : 25  \t   b  :  ()
