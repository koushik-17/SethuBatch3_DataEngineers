...
print(a , b , c , sep = ',,,')#25,,,10.8,,,Hyd#in previous line it is printed 
print(a , b , c , sep = ':::' , end = '\t\t\t')#25:::108:::Hyd<tab><tab><tab>
print(a , b , c) # in last line prints#25 10.8Hyd
...
print('%s    %s    %s'  %(a , b , c))#'25' '10.8' 'Hyd'
print('%d    %g    %s'  , a , b , c)#'%d    %g    %s' 25 10.8 Hyd
print('%d    %g      %s'   a , b , c) #Error
print('%d    %g    %s'  ,  %(a , b , c))#Error
print('%d    %g    %s'    %a%b%c)#Error
print('%d'    %a  ,  '%f'     %b  ,  '%s'   %c)#25  10.937400 Hyd
