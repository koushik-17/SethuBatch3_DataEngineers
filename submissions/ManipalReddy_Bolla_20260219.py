...
print(18 // 4)#4.0
print(-18 // 4)  # -5
print(-(18 // 4))  # -4(parentheses first)
...
print(10 == 10.0)#True
print(3 + 4j >  3 + 4j)#Error(Complex numbers cannot be compared)
...
print(id(b))#address of 25
print(id(c))#address of 25
