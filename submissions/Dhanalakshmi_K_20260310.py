...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # Error due to multiple stars in a list
...
d = [25 , '35']
print(max(d)) # Error due to string object
print(max([])) # Error due to empty String
print(min([])) # Error due to empty String
...
print(a) # []
print(list(25)) # [25]
print(list(10.8)) # [25, 10.8]
print(list(True)) # [25, 10.8, True]
print(list(None)) # [25, 10.8, True, None]
...
del    a[2] # [10 , 20 , 18]
print(a)
del  a[3] #  Error due to out of range
del  a
print(a) # Error due to there is empty list
...
for i in a:
    if i != 15:
     b.append(i)
print('List without ',b "'s : ", b)

#  pop()  method  demo  program
a = [10 , 20 , 15 , 18 , 12]
print(a . pop(2)) # 15
print(a) # [10 , 20 , 18 , 12]
print(a . pop(len(a))) # Error due to len
print(a . pop(-3)) # Error due to negative index
print(a) # [10 , 20 , 18 , 12]
print(a . pop(-4)) # Error due to negative index
print(a . pop()) # 12
print(a) # [10, 20, 15, 18]
b = []
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # Error due to 'int' and 'str'
...
if a.count(b) == len(a):
    print('All the list element are identical')
else:
    print('List element are not identical')