[10:24, 28/03/2026] +91 99482 50500: #Find  outputs (Home  work)
power = lambda  a = 3.5 , b = 2  :  a ** b
print(power(2 , 3))
print(power(4.5 , 4))
print(power())
print(power(9))
[10:25, 28/03/2026] +91 99482 50500: # Find  outputs
...
print(a())
print(a)
[10:25, 28/03/2026] +91 99482 50500: # Tricky  program
# Find  outputs
a  =  lambda  :  print('Hyd');  print('Sec')  ; print('Cyb')
a()
[10:25, 28/03/2026] +91 99482 50500: #  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))
print(lambda  x  :  print(x) (s))
print((lambda  x  :  print(x)) (s))
(lambda  x  :  print(x)) (s)
[10:25, 28/03/2026] +91 99482 50500: # Tricky  porgram
# Find  outputs
x = 5
adder1 = lambda    y  :  x + y
x = 10
...
x = 40
print(adder3(300))
[10:26, 28/03/2026] +91 99482 50500: #Find  outputs  (Home  work)
a = [lambda   x  :  x * 2 , lambda   x  :  x * 3 ,  lambda   x  :  x ** 4]
for   fun   in   a:
        print(fun(5))
[10:26, 28/03/2026] +91 99482 50500: #  Find  outputs
def   f1():
	print('Hyd')
def   f2():
	print('Sec')
...
print(a)
[10:26, 28/03/2026] +91 99482 50500: # Find output  (Home  work)
...
print(a[key])
print(a[key](5))
[10:27, 28/03/2026] +91 99482 50500: # Find  outputs  (Home  work)
def   f1(x):
        return  lambda  n  :  x ** n
#  End  of  the  function		
lamb = f1(3)
...
print(lam(2.5))
print(lam(4))
[10:27, 28/03/2026] +91 99482 50500: #Nested  lambda  function  (Home  work)
add  =  lambda    x = 10   :    lambda   y  :  x  +  y
a = add()
print(a(20))
print(add(30)(40))
[10:27, 28/03/2026] +91 99482 50500: # Find  output  (Home  work)
add = lambda  x  :   x == 25
print(add(10))
...
add = lambda  x  :   x = 25
add = lambda  x  :   x := 25
[11:20, 28/03/2026] +91 99482 50500: '''
...
print('Gcd :  ' ,   ???)
[11:25, 28/03/2026] +91 99482 50500: '''
...
[11:29, 28/03/2026] +91 99482 50500: '''
...
[11:31, 28/03/2026] +91 99482 50500: '''
...
[11:36, 28/03/2026] +91 99482 50500: '''
