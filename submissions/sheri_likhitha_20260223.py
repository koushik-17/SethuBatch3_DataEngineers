...
print(a , b , c , separator = ':')	#error because of seperator it should be 'sep'
...
print(a , b , c , sep = ',,,')			#25,,,10.8,,,'Hyd'
print(a , b , c , sep = ':::' , end = '\t\t\t')	#25:::10.8:::'Hyd'<tabspace><tabspace><tabspace>
...
#Find  outputs  (Home  work)
a ,  b , c = 25 , 10.8 , 'Hyd'
print(F'{a}  \t   {b}   \t  {c}')			#25<tab space>10.8<tabspace>Hyd
...
print(F'a  =  a  \t  b  =  b  \t  c  =  c')		#a=a <tabspace> b=b <tabspace> c=c <tabspace>
print(F'{x =}  \t   {y =}   \t  {z =}')			#error because it is not defined
