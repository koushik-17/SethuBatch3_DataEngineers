...
print(len(a)) #3
print(How  to  print  1st  inner  list) #[10,20,30,40]
print(How  to  print  2nd  inner  list) #[50,60,70,80]
print(How  to  print  3rd  inner  list) #[90,100,110,120]
...
print(How  to  print  1st   inner  list) # [10,20]
print(How  to  print  2nd   inner  list) # [30,40,50]
print(How  to  print  3rd   inner  list) # [60,70,80,90]
print(How  to  print  number  of  elements  in  1st  inner  list) # 2
print(How  to  print  number  of  elements  in  2nd  inner  list) # 3
print(How  to  print  number  of  elements  in  3rd  inner  list)  # 4
...
print(How  to  print  inner  list  in  another  way) # for x in a:
                                                          print(x)


#  Find  outputs  (Home  work)
a = [[10 , 'Rama' , 1000.0] , [20 , 'Sita' , 2000.0] , [15 , 'Rajesh' , 3500.0] , [18 , 'Kiran' , 2800.0] , [5 , 'Amar'  ,5000.0] ]
print(sorted(a)) # [[5,'Amar',5000.0],[18 ,'Kiran' ,2800.0],[15,'Rajesh',3500.0],[10,'Rama',1000.0],[20,'sita',2000.0]

print(sorted(a , reverse = True))#[[20,'sita',2000.0],[10,'Rama',1000.0],[15,'Rajesh',3500.0],[18 ,'Kiran' ,2800.0],[5,'Amar',5000.0]]

print(a)# [[5,'Amar',5000.0],[18 ,'Kiran' ,2800.0],[15,'Rajesh',3500.0],[10,'Rama',1000.0],[20,'sita',2000.0]
...
for a in a:
    first_letters.append(a[0].upper())
...
a = ["hyd", "pune", "chennai", "vijayawada"]
first_letters = [a[0].upper() for a in a]
...
words = a.split()  # ['hyd', 'is', 'green', 'city']
for word in words:
...
output = [[word.upper(), len(word)] for word in a.split()]
...
# Extract elements from list1 that are not in list2 using comprehension
