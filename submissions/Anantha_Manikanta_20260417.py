...
print(cls.x , cls.y) # Error because 'cls' is not defined
print(self.x , self.y) # Error because 'self' is not defined
'''
'''
#2
# Find outputs
...
a = c1()
a.m1() # static / instance method <__main__.c1 object at 0x1A23>
'''
'''
...
class c1:
	...
	def m1(self):
		...
		# How to print static variable 'x' in another way
		print(self.__class__.x)
		# print(cls.x) # Error because 'cls' is not defined
		print(self.x)
	def m2(cls):
		...
		def m2(cls):
			...
			# How to print static variable 'x' in another way
			print(c1.x)
			# print(self.x) # Error because 'self' is not defined
	# Corrected:
	@classmethod
	def m2(cls):
		# How to print static variable 'x'
...
# How to print static variable 'x' in another way
print(c1.__dict__['x'])
print(x) # Error because 'x' is not defined (no global x).
print(self.x) # Error because 'self' is not defined.
print(cls.x) # Error because 'cls' is not defined.
...
print('Result : ' , c)
'''
12) Write a program to print only static variables but not environment variables of classname.__dict__
...
'''
13) 1) Write a program to validate emp number , emp name and salary and also print them
