...
print(a + 5) # Error, because list can not be concatenated with other sequence or non sequence
print(a + '5') # Error, because list can not be concatenated with other sequence or non sequence
print([10 , 20] + (30 , 40)) # Error, because list can not be concatenated with other sequence or non sequence
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1, 2, 3] , Memory Address 25252525
a += b
print(a , id(a)) # [1, 2, 3] , Same Memory Address 25252525
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1, 2, 3], Memory Address 25252626 
a  = a + b
print(a , id(a)) # [1, 2, 3, 4, 5, 6], Memory Address 25252626 
...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # Error, because there are unequal number of elements for unpacking
a , b , *c , d , e = list # Error, because there are unequal number of elements for unpacking
print('a : ' , a) 
print('b : ' , b)  
print('c : ' , c)
print('d : ' , d)
print('e : ' , e)
a , b , *c , d , e , f = list # Error, because there are unequal number of elements for unpacking
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # There can not be more than '*' for unpacking
...
print(sum(d))  # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # Error, we can not find sum for string 
...
print(list(10.8)) # Error, because 10.8 is non sequence
print(list(True)) # Error, because True is non sequence
print(list(None))  # Error, because None is non sequence
...
del a[3] # Error
del  a
print(a) # Error, because we can not print already deleted object
...
b = int(input("Enter a element to be removed: "))
...
'''
Output :
Enter a list: [6, 7, 8, 6, 6, 4, 6, 3, 6]
Enter a element to be removed: 6
List without 6's : [7, 8, 4, 3]
'''
#-------------------------------------------------------------------
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # String 'Hyd' can not be compared int 15 for sorting
...
'''
Output :
Enter list : [6, 7, 8, 6, 6, 4, 7, 3, 6, 10]
Output : [8, 4, 3, 10]
'''
...
'''
Output :
Enter the List : ['Hyd', 'Hyd','Hyd','Hyd','Hyd']
