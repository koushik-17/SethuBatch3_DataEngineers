...
How  to  import   keyword  module import keyword #import keyword
How  to  print  kwlist #print(keyword.kwlist)
How  to  print  number  of  keywords print(keywords)#print(len(keyword.kwlist))
How  to  print  type  of kwlist#print(type(keyword.kwlist))
print(kwlist)#[and , or , not , is , in , None , True , False , .....] 
...
print(eval('  " "   '))#' '
print(eval(' '))#error
 # What  is  the  advantage  of  eval(input()) ?#it reduces to rember all type cast functions
x = eval(input('Enter  any  input  :  '))
print(type(x))
print(x)
# What  is  a  better  approach  to  read  string  input ?
a = input('Enter  any  string  :  ') #"Gayathri"
print(len(a))#8
print(a)#Gayathri
b = eval(input('Enter   any  string  : '))#Gayathri
print(len(b))#8
print(b)#Gayathri