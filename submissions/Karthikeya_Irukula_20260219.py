...
print(8.5 // 3) # 2.0
print(18 // 4) # 4
print(-18 // 4)  #  Tricky -5 next integer.
print(-(18 // 4))  #  Tricky -4 prev integer.

# Find outputs
print(7 / 0) #Error integer cannot divide with zero
print(7 // 0) #Error integer cannot divide with zero
print(7 % 0) #Error integer cannot be modulus by zero
