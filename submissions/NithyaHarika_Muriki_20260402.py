...
hi_fun()
hello_fun()
[12:49 pm, 02/04/2026] +91 99482 50500: #  How  to  call  f1()  function  when  @decor  tag  is  missing  ?
def   decor(fun):
	def   inner():
		x = fun()
		return   x + 2
...
f1 = decor(f1)
print(f1())
[12:54 pm, 02/04/2026] +91 99482 50500: # Find  outputs(Home  work)
def   decor(fun):
	print(fun . _name_)
	def    inner(name):
		if   name  == 'Python':
...
print(div(10 , 0))
print(inner(10 , 3))
[12:55 pm, 02/04/2026] +91 99482 50500: # Modify  following  div  function  such  that  both  div(9 , 2)  and  div(2 , 9)  should  return  4.5  only
def  decor(fun):
...
print(div(9 , 2))  #  4.5
print(div(2 , 9))  # 4.5
[12:55 pm, 02/04/2026] +91 99482 50500: #  Find  outputs (Home  work)
def   decor(fun):
	def   inner():
...
f1()
print('Bye')
[12:57 pm, 02/04/2026] +91 99482 50500: # Most  tricky   program
...
f3('Hyd' ,  True  , 3 + 4j)
f4()
[1:14 pm, 02/04/2026] +91 99482 50500: # Find  outputs  (Home  work)
def  square(fun):
	def  inner1():
		x = fun()
		return  x * x
