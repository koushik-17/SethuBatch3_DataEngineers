...
print(a + 5) # error, sequence cannot be added to a non-sequence
print(a + '5') # error, list can only be concatenated with a list
print([10 , 20] + (30 , 40)) # error, list can only be concatenated with a list

# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1 , 2 , 3] # id of the list a
a += b
...
print(a , id(a)) # [1 , 2 , 3] # id of the list a
a  = a + b
print(a , id(a)) # [1 , 2 , 3 , 4 , 5 , 6] # list with a different id
...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # error, more references than elements present in the list
a , b , *c , d , e = list
print('a : ' , a) # a : 25
print('b : ' , b) # b : 10.8
print('c : ' , c) # c : []
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # there can only be one starred object
...
print('c : ' , c) # c : 'Hyd'
print('d : ' , d) # d : True
a , b , c , d = list # error , more references than elements in the list
...
print(sum(d)) # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # error, all the arguments need to be either numbers or boolean
'''
...
#  Find  outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a)) # error, the nested list is taken as a single sequence element
print(sum(a[0])) #print(How  to  determine  sum  of  inner  list  elements)
print(sum(*a)) #print(How  to  determine  sum  of  inner  list  elements  in  another  way)
...
print(min(b)) # Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c)) # error, the elements should be similar to be compared
d = [25 , '35']
print(max(d)) # error, cannot compare a str and int
print(max([])) # error, argument cannot be empty
print(min([])) # error, argument cannot be empty
'''
...
a = list() 
print(a) # []
print(list(25)) # error, argument needs to be a sequence
print(list(10.8)) # error, argument needs to be a sequence
print(list(True)) # error, argument needs to be a sequence
print(list(None)) # error, argument needs to be a sequence
'''
list()  function
-----------------
...
5) What  are  the  two  arguments  of  sorted()  function ?  ---> List  to  be  sorted																											and
...
del a[2]
print(a) # [10 , 20 , 18]
del a[3] # error , there are only indexes upto 2 in the list
del a
...
try:
	...
	list . remove(25) # throws error, which is handled below
except:
...
x = eval(input('Enter the element to be removed:'))
...
print(a . pop(2)) # 15
print(a) # [10 , 20 , 18 , 12]
print(a . pop(len(a))) # error , index does not exist as indexes go from 0 - 3 and length is 4
print(a . pop(-3)) # 20
print(a) # [10 , 18 , 12]
print(a . pop(-4)) # error , invalid index
print(a . pop()) # 12
print(a) # [10 , 18]
b = []
b . pop() # error, pop cannot be used on an empty list
'''
pop()   method
------------------
...
6) del  list[index]
    ...
    What  is  the  difference  between  the  two  statements ?  --->
											del  operator  removes  element  but  does  not  return  the  deleted  element										whereas  pop()  method  not  only  deletes  element  but  also  returns  the  deleted  element
'''
...
a . sort(reverse = True)
print(a) # ['Vamsi , 'Sits' , 'Rama Rao' , 'Rama' , 'Rajesh' , 'Kiran' , 'Amar']

# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # error, cannot sort different object types
...
if a.count(a[0]) == len(a):
    print('All the elements of the list are identical.')
else:
    print('All the elements of the list are not identical.')
