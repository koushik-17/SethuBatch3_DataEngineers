...
print(sys . getrefcount({10 , 20 , 15 , 18}))  #1
print(sys . getrefcount('Hyd'))   #some address 
...
class  Test:
	...
	def  __del__(self):
		...
		return  25
# End  of  the  class
t = Test()                  #constructor : some address
print(t . __init__())       #constructor : same address  
                            #None
print(sys . getrefcount(t)) #2
print(t . __del__())        #Destructor : some address
                            #25
print(sys . getrefcount(t)) #2
print('Bye')                #Bye
...
class  c1:
	def  __init__(self):
		print('Object  is    created') #3. Object is created
	def  __del__(self):
		print('Object  is  lost')   #8. Object is lost
# End  of  the  class
def    f1():
	print('Function  Begin')    #2. Function Begin
	a  =  c1()
	print(a)                    #4. __main__.c1 object is created at some address
	print('Function  end')      #5. Function end
	return   a
print('Program  Begin')     #1. Program Begin
b = f1()
print(b)                    #6. __main__.c1 object is created at some address
...
class  c1:
	def  __init__(self):
		print('Object  is    created')  #3. Object is created
	def  __del__(self):
		print('Object  is  lost')       #5. Object is lost
# End  of  the  class
def    f1():
        print('Function  begin')    #2. Function begin
        a  =  c1()
...
class   c1:
	...
	def   __del__(self):
		print('c1  class  object  is  lost')        #6. c1 class object is lost
# End of class c1
class  c2:
	def  __init__(self):
	...
	def  __del__(self):
		print('c2  class  object  is  lost')        #7. c2 class object is lost
#End of class c2
print('Program  begin')     #1. Program begin
x = c2()
print('program end')        #6. Program end
...
class   c1:
	def  __add__(a , b):
		x = c1()
		y = c1()
		print(x + y)    #object should not be created in the class inside constructor
a = c1()
b = c1()
print(a + b)    #Infinite  recursion  and  program  will  crash  with  RecursionError: maximum recursion depth exceeded in comparison
...
a = c1(10)
b = c1(20)
print(a > b)    #__gt__method : 10 20
                #None
print(a < b)    #__gt__method : 20 10
                #None
'''
Object  'a'   --->  
...
a = c1(10)
b = c1(20)
print(a == b)   #__eq__method : 10 20
                #False
print(a != b)  # not (a == b) #__eq__method : 10 20
                #True
...
class c2:
	...
	def __mul__(x , y):
		...
		return  y.empno * x.noh #number-of-hours (i.e.  8) *  hourly-rate(i.e.  25)
# End of the class
a = c1()
b = c2()
...
a = c1()
b = c1()
print('a + b : ' , a + b)      # a + b : __add__method of class  c1
print('a + 7 : ' , a + 7)      # a + 7 : __add__method of class  c1
print(7 + a)        #Error due to operand are unsupported for +: int and c1
print('7 + 8 : ' , 7 + 8)      # 7 + 8 : 15
m = c2()
n = c2()
print(m + n)        #Error due to operand are unsupported for +: c2 and c2
print('a + m : ' , a + m)       # a + m : __add__method of class  c1
print(m + a)          #Error due to operand are unsupported for +: c2 and c1
