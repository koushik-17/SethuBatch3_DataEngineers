...
print(sum(a)) # 90
print(sum(a . items())) # unsupported operand type(s) for +: 'int' and 'tuple'
...
print(dict([10 , 20])) # ValueError: dictionary update sequence element #0 has length 1; 2 is required
...
for  x   in   b:
	print(x) # Hyd <newline> Sec <NewLine> Cyb <newLine> Pune
...
for  x   in   b:
        print(x) # (10, 'Hyd') <newline> (20, 'Sec') <newline> (15, 'Cyb') <newline> (18, 'Pune')
for  x , y   in  b:
        print(x , y , sep = ' ... ') # 10 ... Hyd <newline> 20 ... Sec <newline> 15 ... Cyb <newline> 18 ... Pune
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') # 10 ... Hyd <newline> 20 ... Sec <newline> 15 ... Cyb <newline> 18 ... Pune
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ') # ValueError: too many values to unpack (expected 2)
for  x , y   in  a . values():
       print(x , y , sep = ' ... ') # ValueError: too many values to unpack (expected 2)
for  x , y   in  a:
       print(x , y , sep = ' ... ') # ValueError: too many values to unpack (expected 2)
...
s = s.upper()              # Step 1: Convert to uppercase
chars = sorted(s)          # Step 2: Sort characters
a = {}                     # Step 3: Empty dictionary
for ch in chars:
    if ch.isalpha():       # Ignore spaces and non-alphabets
        a[ch] = a.get(ch, 0) + 1
...
a . update(b) # {'Y': 'Yellow', 'G': 'Gray', 'R': 'Red', 'B': 'Blue'}
...
b = {}
b.update(a)
print(b) #ValueError: dictionary update sequence element #0 has length 3; 2 is required
c = [(10,) , (20,) , (30,)]
b . update(c) # ValueError: dictionary update sequence element #0 has length 1; 2 is required
print(b) #{10: 20, 30: 40}
