...
Answer: An else block cannot preced without if statement
...
#Answer: if statement condition must end with a ':'
...
print('Sec')
'''
Answer: as the tuple is non-empty so it produces an boolean value i.e., True and Hyd is printed , for every non-empty tuple Hyd is printed
'''
...
#Answer: in python we use indentation rather then {}
...
#Answer : All the conditions are false , so else blok is executed only if elif: is written instead of else: if
