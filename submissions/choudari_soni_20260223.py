...
print(a , b , c , separator = ':')	#error because of separator :
...
print('%s'  %a)		#Hyd
print('%s' , a)		#%s Hyd
print('%s'  a)		#error because % is missing
print('%s' , %a)	#error because there is a comma
print(a)		#Hyd
...
print('%s'  a)		#error because % is missing
print('%s' , %a)	#error because , don't use comma b/w them
print('%l'  %a)		#error because %l is not defined
print(a)		#[10 , 20 , 30 , 40]
...
print('%d    %g    %s'  , a , b , c)	#%d %g %s 25 10.92 Hyd
print('%d    %g      %s'   a , b , c)	#error because % missing
print('%d    %g    %s'  ,  %(a , b , c))	#error because there is a comma
