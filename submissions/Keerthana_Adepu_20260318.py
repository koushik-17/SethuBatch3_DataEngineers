...
'''
a = input('Enter the mixed case string:')
b = a.upper()
c = set()
vowels = 'AEIOU'
...
print(id(a)) # Address of dictonary a
...
d = {*a , *b , *c}
print(d) # {10 , 20 , 15 , 18 , 14 , 25 , 19 , 15}
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b) # error, dictionaries can only be concatenated with | operator
c = {**a , **b}
print(c) # {10 : 60 , 30 : 50}
d = a | b
print(d) # {10 : 60 , 30 : 50}
...
'''
s = input('Enter the string with multiple employee details:')
s1 = s.split(',')
a = {}
