...
a . append('Sec') # Error immutable so cannot append 
a . remove('Hyd') # Error immutable so cannot remove  
b =  10 , 20 , 30 
print(b) #(10, 20, 30) 
...
print(tuple(25)) #Error as 25 is an int (Non sequence) and cannot be iterable  
# Find  outputs (Home  work) 
a = () 
print(type(a)) <class ‘tuple’> 
print(a) () 
