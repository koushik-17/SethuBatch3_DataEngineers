...
def   f1(a  , b , *):# after * there should be an argument
        pass
################################################################################################################################
...
# End of the function
f1(10 , 20 , 30 , d = 40 , e = 50 , f = 60) # a:10 b:20 c:30 d:40 e:50 f:6
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c):#there should be atleast one argument before /
        pass
def   f2(a , b , c , *):#there should be atleast one argument after *
        pass
#####################################################################################################################################
...
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass
def   f2(b , d , a = 10 , c = 20):#positions
	pass
######################################################################
#  Find  outputs (Home  work)
def   f1(a = 10):
...
print(add(10 , 20 , 30 , 40))# 4-argument  function
				10+20+30+40=100
print(add(50 , 60 , 70))#4-argument  function  <nextline> 50+60+70+4=184
print(add(80 , 90))#'4-argument  function <NL> 80+90+3+4=177
print(add(100))#'4-argument  function <nl> 100+2+3+4=109
...
print(f1(a = [100 , 200 , 300],   x = 6 ))#[100 , 200 , 300,36]
print('__defaults_  :  ' , f1.__defaults__)#([0,1,4,0,1,4,9,16],)
...
f1()# emptystring 	<class 'Nonetype>	0	
