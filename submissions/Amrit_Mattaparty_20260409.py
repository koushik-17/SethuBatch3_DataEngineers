...
print('f : ' , f)   # f :  11 / 15
c._init_()
print('c : ' , c)   # c :  22 / 7 (uses default 22/7, but still valid call)
a._init_(3.8 , 4.6)
print('a : ' , a)   # a :  3.8 / 4.6
...
#   Constructor
#   ...
#   Error as maximum recursion depth exceeded
...
b = c2()   # No output from __init__ because __init__ is not defined for c2.
print(b._dict_)   # {}
b.init()   # Method
...
y = c2()   # y is created but has no attributes yet.
...
# print(a.x) # Error as 'c1' object has no attribute 'x'
# print(b.y) # Error as 'c1' object has no attribute 'y'
...
#end of the class
a = c1() # Function
print(a) # None (because function returns None by default).
...
b = c1(25) # Function : 25
print(b)   # None (function returns None).
...
ccurrent = c1() # How to create c1 class object of current module # Output: c1 class of prog9d
c9a = c1_prog9a() # How to create c1 class object of prog9a # Output: c1 class of prog9a
