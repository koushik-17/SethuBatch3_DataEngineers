...
print(0XA7B9)  #  42937 
print(int(3 + 4j))  # Error complex number cannot convert to int
print(int('25.4'))  # Error string should contain decimal value
...
print(float('Ten')) # Error  string is not numeric 
...
print(complex('3' , '4')) # Error first is string then second argument cannot allowed 
print(complex('Ten')) # Error string is not in numeric 
