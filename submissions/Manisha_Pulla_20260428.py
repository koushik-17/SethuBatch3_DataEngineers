...
try:
    con = mysql.connector.connect(database = "emp" ,host ="localhost",password= "Manisha@123.",user = "root")
    cur = con.cursor()
...
con = mysql.connector.connect(database = "employee" ,host ="localhost",password= "Manisha@123.",user = "root")
cur = con.cursor()
