...
from cal import x as y , add as a, mul as m, c1 as c # Member  alias
...
print(b(10,7))#How  to  call  mul()  function  of  cal  module  with  10  and  7)
d=c()
...
from mod1 import x  as y, disp as d1, c1 as m1c#How  to  import  members  of  mod1
from mod1 import x  as z, disp as d2, c1 as m2c#How  to  import  members  of  mod2
x = 30
def   disp():
        print('disp  function  of  same  module')
class  c1:
	def   m1(self):
		print('m1   method  of  class  c1  in  same  module')
print(y)#How  to  print  variable  'x'  of  mod1)
d1()#How  to  call  disp()  function  of  mod1
m1c().m1()How  to  call  method  m1()  of  class   c1  in  mod1
print()
print()
print(z)How  to  print  variable  'x'  of  mod2)
d2()How  to  call  disp()  function  of  mod2
m2c().m1()#How  to  call  method  m1()  of  class   c1  in  mod2
print()
print()
print(x)#How  to  print  variable  'x'  of  current  module)
disp()#How  to  call  disp()  function  of current  module
