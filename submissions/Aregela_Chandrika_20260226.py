...
if  d > 0:
    ...
    r1 = print(f'Root 1 : {(-b / (2*a)) }')
    r2 = print(f'Root 2 : {-b / (2*a) }')
...
match  i:
	case  1:
		print('One')
	case  _:  # Anonymous object should be at end 
...
5) What  is  the  output  when  input  is  (10 , 20 , 30) ?  ---> (10 , 20 , 30)
...
#  Find  outputs
while  True:
	print('Hello')  # Hello <nextLine> Hello <nextLine> ........ so on
print('Bye')
