...
a = c1() 
a . m1() # static method
c1 . m1(25) # Error because m1() needs 0 arguments but we are passing 1 argument 
...
a = c1()
a . m1() # static / instance method <nextline> type and address of object 'a'
...
print(self . x) # Error self an't be called outside
