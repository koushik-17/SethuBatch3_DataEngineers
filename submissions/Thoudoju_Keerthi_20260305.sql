...
select * from employees_demo limit 3,3;
...
select department,count(*) from employees_demo group by department having count(*)>2;
select department,avg(salary) from employees_demo group by department having avg(salary)>40000;
select department,sum(salary) from employees_demo group by department having sum(salary)>100000;
select department,max(salary) from employees_demo group by department having max(salary)>70000;
select department,min(salary) from employees_demo group by department having min(salary)<35000;
select department,avg(age) from employees_demo group by department;
select department,avg(age) from employees_demo group by department having avg(age)>28;
select department,count(*) from employees_demo group by department having count(*)<3;