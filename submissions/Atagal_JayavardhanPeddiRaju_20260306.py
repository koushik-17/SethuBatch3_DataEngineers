...
a=eval(input("enter the string 1:"))
b=eval(input("enter the string 2:"))
a_1=b[:2]+a[2:]
b_1=a[:2]+b[2:]
c=a_1+ b_1
print(c)
...
print("starting for left to right")
for i in range(len(a)):
     print("character at index ",i,a[i])

print("starting for right to left")    
...
for i in range(len(n)):
    if i%2==0:
        ...
        b=b+n[i]
print("string at even index:",a)
print("string at odd index:",b)
...
print("String after removing duplicates:", c)
...
[1:04 pm, 06/03/2026] +91 99482 50500: ''(Home  work)
...
[1:05 pm, 06/03/2026] +91 99482 50500: '''  (Home  work)
