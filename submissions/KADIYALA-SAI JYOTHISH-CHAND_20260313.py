...
10...20
error becuase there unequal  objects
'''
...
str=eval(input('Enter list of lower case string : '))
a=[]
for i in str:
  a.append(i[0].upper())
print(a)
...
str= input('Enter any string')
a=[[i.upper(),len(i)] for i in str.split()]
print(a)
...
Let  1st  list  be  [10 , 20 , 15 , 18 , 25 , 32] bb and  2nd  list  be  [30 , 40 , 10 , 25 , 15]
What  is  the  output ?  --->  [20 , 18 ,  32]
'''
a=eval(input('Enter 1st List : '))
b=eval(input('Enter 2nd List : '))
c=[]
print('Elements of 1st list which are not in 2nd list : ',end="")
for i in a:
  if i not in b:
    c.append(i)
print(c)
...
print('Squares of 1 and 20 which are divisible by 2 :',a)

#  Repeat  previous  program  with  comprehension  and  without  using  if
a=[ i**2 for i in range(2, 21,2)]
print('Squares of 1 and 20 :',a)
