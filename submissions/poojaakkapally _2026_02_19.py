...
print(range(4) | range(5)) -------error(cant support range in range)
print([10 , 20]  |  [30 , 20])-----error(cant support list in list)
...
print(10.5 // 2)-------prev  integer(5.5)   = 5.0
...
print(3 + 4 * 5 - 32 / 2 ** 3)----3 + 4 * 5 - 32 / 2 ^3 = 19.0
