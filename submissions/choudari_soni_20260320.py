...
c = sorted(a . values())
print(c)#{15 : 'Blue',20 : 'Green' ,10 : 'Red',5 : 'White',18 : 'Yellow'}
d = sorted(a . items())
...
print(rno1 , sname1)#(101,soni)
print(rno2 , sname2)#(102,Rachana)
print(rno3 , sname3)#(103,kalyani)
