...
print(range(4) | range(5)) # Error due to range object can' be concated with pipe
print([10 , 20]  |  [30 , 20]) # Error due to List object can't be concated with pipe
...
# Find outputs
print(7 / 0) # Error due to cannot divided by zero 
print(7 // 0) # Error due to divided by zero 
print(7 % 0) # Error due to divided by zero 
...
print(10 == 10.0) # True 
print(3 + 4j >  3 + 4j) # Error due to python doesn't support greater than comparsion 

#  Find  outputs  (Home  work)
print('Rama'   >  'Rajesh')  #  True :  'm' > 'j'
print('Rama'  <  'Sita')   #   True :   'R' < 'S'
print('Hyd'  ==  'Hyd')  #  True :
print('Rama'  <=   'Ramana') # True : '' < 'a'
...
25 = a # Error due to object cannot be referneces 
a + b = x + y # Error due to object can't be assignment 

# Find outputs (Home work)
a = b = c = 25
print(id(a)) # Adress of object '25'
print(id(b)) # Adress of object '25'
print(id(c)) # Adress of object '25'
...
a , b , c = 3 , 4 , 5
a *= b + c   
print(a) # a = a * (b + c) = 3 * (4 + 5) = 3 * 9 = 27 

# Find outputs (Home work)
a = 20
a %= 3 + 2 * 4 
print(a) #  a = 20 %= (3 + 2 *4 ) = 20 %= (3 + 8 ) = 20 %= 11 = 9
...
print(math . sqrt(3+4j)) # Error due to sqrt cannot be complex 
print(math . sqrt(math . sqrt(256))) # 4.0
print(math . sqrt(math . pow(3 , 4))) # 9.0
print(math . sqrt(-16)) # Error due to Value Error
print(sqrt(49)) # Error due to there is no math function
...
print(fabs(-25)) # Error due to there is no math function
...
print(floor(3.5)) # Error due to there is no math function
print(ceil(3.5)) # Error due to there is no math function
