...
print(a [ : 7]) # a[0 : 7 : 1]   --->  string  from  indexes  0  to  7  in  steps  of  1  i.e. Rama Ra
print(a [2 : 4]) # a[2 : 4 : 1]   --->  string  from  indexes  2  to  4  in  steps  of  1  i.e. ma
print(a [2 : ]) # a[2 :  : 1]   --->  string  from  indexes  2  to  7  in  steps  of  1  i.e. ma Rao
...
print(a [-6 : ]) # a[-6 : 0 : 1]   --->  string  from  indexes  -6  to  0  in  steps  of  1  i.e. ma Rao
print(a [: -4 : -1]) #<space>Ra
print(a [-3 : -1]) # R amaR
print(a [-3 : ])  # Rao
print(a [ : : ]) # Rama Rao
print(a [ : ]) # Rama Rao
...
for i in range(0,len(A)):
    print(F'character at index -{i+1}:' +A[i])
#-----------------------------------------------------------------------
'''
...
for i in range(len(A)):
    if i%2 == 0:
        ...
        odd += A[i]
print("string at even indexes : "+eve)
...
#------------------------------------
try:
    A=input("Enter any string with alternate characterc and digit :")
    B=""
    for i in range(len(A)):
        if i%2 == 0:
    ...
    print("ples Enter any string with alternate characterc and digit")
#-----------------------------------------------------------------------------------------------------
