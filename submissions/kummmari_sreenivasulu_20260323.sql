...
-- 	BLAKE is working as CLERK 
	...
	-- 1. Employees with more than 30 years of experience
	SELECT * FROM employees WHERE (YEAR(CURDATE()) - YEAR(hire_date)) > 30;

	-- 2. Divide string into first, middle, last name
	SELECT 
