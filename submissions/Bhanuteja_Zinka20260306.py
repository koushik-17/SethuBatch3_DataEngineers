 ...
 print(a [ : : -2])   # oRaa 
 print(a [ -2 : : -2])# a<space>mR # mistake 
 ...
 print(f'Result : {b[:2]+a[2:]} {a[:2]+b[2:]}') 
 ...
 try: 
     ...
     print('String should have alternate string and character') 
 ...
 for i in range(len(s)): 
     if s[i] not in new: 
         new += s[i] 
 print(f'String Without Duplicates : {new}') 
 ...
 print(len(' '))        # 1 
 print(len('A2#'))      # 3 
 print(len(3456))       # Error Int 
 print('Sec'. len())    # Error Format 
