...
[1:14 pm, 21/04/2026] +91 99482 50500: # Find  outputs (Home  work)
import  time
...
while  True:
	try:
		...
		break
[1:14 pm, 21/04/2026] +91 99482 50500: # Find outputs
import  time
def  disp(f):
	while  True:
		try:
...
print('Filter  f2')
disp(f2)
[1:15 pm, 21/04/2026] +91 99482 50500: # How  to  print  fliter  object  in  different  ways ?
import   time
...
[1:15 pm, 21/04/2026] +91 99482 50500: #  Write  a  program  to  print  odd  numbers  between  1  and  20  with  filter  iterator
[1:16 pm, 21/04/2026] +91 99482 50500: '''
Write  a  program  to  print  distinct  vowels  of  the  string  using  filter.
Input  is  string  and  output  is  set
'''
[1:16 pm, 21/04/2026] +91 99482 50500: # Nested  filter  i.e.  filter  on  filter
import   time
