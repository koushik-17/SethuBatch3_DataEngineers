...
print(float(0O6247)) # 512*6 + 64*2 + 8*4 + 1*7 
print(float(0XA7B9)) # 4096*10 + 256*7 + 16*11 + 1  
print(float(3 + 4j)) # 
print(float('Ten')) #
...
print(complex('3')) # 3+0j
print(complex('3.8')) # 3.8+0j
print(complex(3 , '4'))  # Error because arg2 cannot be in string
print(complex('3' , 4))  # Error arg2 cannot be defined 
print(complex('3' , '4')) # Error arg2 cannot be defined and cannot be string
print(complex('Ten')) # 
