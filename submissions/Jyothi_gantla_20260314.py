...
for  x , y  in  a:
	print(x , y , sep = '...')#[10...2o <n>30...40<nl>50...60<nl>70...80]
...
for  x  in  a:
    print(x)
print()#[10 , 20 , 30] <nl> [40 , 50 , 60] <nl> [70 , 80 , 90]
for  x , y ,  z  in   a:
...
print(sorted(a , reverse = True))#reverse of [5 , 'Amar'  ,5000.0],[10 , 'Rama' , 1000.0] ,[15 , 'Rajesh' , 3500.0] , [18 , 'Kiran' , 2800.0] ,  , [20 , 'Sita' , 2000.0] ]
...
a = [10 , 20 , 15 , 18 , 25 , 32]
b = [30 , 40 , 10 , 25 , 15]
d = [i for i in a if i in a and i not in b]
print(d)
