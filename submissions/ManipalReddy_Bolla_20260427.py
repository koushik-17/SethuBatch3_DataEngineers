...
print(re  .  sub('[a-z]'  ,  '%'  ,  'a7b8G6d5'))#'%7%G%6%5'
...
import  re
print(re . split(','  ,  'Hyd,Pune,Chennai,Delhi,Vijayawada'))#['Hyd','Pune','Chennai','Delhi','Vijaywada']
...
# Find  outputs
import re
print(re . split('[.]'  ,  'www.gmail.com'))#['www','g.mail','com']
