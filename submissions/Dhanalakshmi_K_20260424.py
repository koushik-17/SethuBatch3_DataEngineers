...
itr = c4()
for  x  in   itr:
	print(x) # Error due to missing _next_method
...
itr = c5()
for  x  in   itr:
	print(x) # Error due to missing _next_method and return  statement in _iter_ method 
...
# End  of  the  class
a  =  c6()
print(dir(c6)) # Error due to wrong method names (iter instead of _iter_ and next instead of _next_)
for  x  in  a:   
        print(x)
while  True:
	print(next(a))  
...
1) 1st  input  ---> 'Hyd is green city'
    2nd  input  --->  'Green'
	What  are  the  outputs  ---> <class 're.Match'>, green  is found  between  indexes  7   and   11
...
'Hyd is green city'  does  not  start  with  'city'
'Hyd is green city'  does  not  end  with  'city'
'''
