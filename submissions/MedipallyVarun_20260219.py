...
print(range(4) | range(5)) # Error because range object can not be concatenated 
...
print(math . pow(-2 , -3)) # 125
print(math . pow(10 , -2)) # 1
print(math . pow(4 , math . pow(3 , 2))) # 262134
