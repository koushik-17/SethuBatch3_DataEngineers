...
print(float(3 + 4j)) #Error because we can't convert complex to float
print(float('Ten'))  #Error because it is string
...
print(complex(False)) #oj
print(complex(True , 4)) #1+4j
print(complex('3')) #3+0j
print(complex('3.8')) #3.8+0j
print(complex(3 , '4')) #Error not valid 
print(complex('3' , 4))  #Error not valid
...
print(oct(195)) #0o303 (Divide the number by 8) 
print(oct(0B10101110010)) #0o2562  
print(oct(0xA7B9)) #0o123671 (First convert Hexadecimal to Binary and then Binary to octal)


# hex()  function  demo  program
print(hex(25))  #0x19
print(hex(0B10101111010111)) #0x2BD7
print(hex(0O6247)) #0xCA7 (First convert the octal number to 3- bit binary and then group into four we get the Hexadecimal number)
