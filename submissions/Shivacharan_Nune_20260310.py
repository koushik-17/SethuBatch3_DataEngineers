...
print(a  is  b)    #True
print(a  ==  b)    #True
b[2] = 12          #index at second element of list is modified to 12(only one list a and b references are pointing to it)
print(a)           #[10,20,12,18]
#---------------------------------------------------------------------------
#  Find  outputs  (Home  work)
a = [10 , 20 , 15 , 18]
...
print(a + 5)                 #Error:correct should be print(a+[5])
print(a + '5')               #Error:correct should be print(a+['5']) or print(a+list('5'))
print([10 , 20] + (30 , 40)) #Error:correct should be print([10,20]+list((30,40)))
#-----------------------------------------------------------------------------------------------------
# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]    
b = [4 , 5 , 6]
print(a , id(a))  #[1 , 2 , 3]<space>some address
a += b            #a=[1 , 2 , 3] +[4 , 5 , 6]=[1,2,3,4,5,6]
print(a , id(a))  #[1,2,3,4,5,6]<sapce>same adress
#----------------------------------------------------------------------------------------
# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]  
b = [4 , 5 , 6]
print(a , id(a))   #[1 , 2 , 3] some adress
a  = a + b         
print(a , id(a))   #[1 , 2 , 3 , 4 , 5 , 6] different adress
#----------------------------------------------------------------------------------------
# Find  outputs
...
#----------------------------------------------------------------------------
#  Find  outputs (Home  work)
a = range(4 , 10 , 2)        #4,5,6,7,8,9
b = list(a)                  #[4,5,6,7,8,9]
print(b)                     #[4,5,6,7,8,9]
print(type(b))               #<class 'list'>
a = list('Vamsi')           
print(a)                     #['v','a','m','s','i']
...
print(all(d))     #False
e = []             
print(all(e))     #True:if there are no false elements it is true
'''
all()  function
-----------------
...
y=eval(input("enter the value to be removed :"))
try:
    for i in range(len(x)):
        x.remove(y)
except:
    print(f"no {y} left in x")
print(x)
#-----------------------------------------------------------------------------
