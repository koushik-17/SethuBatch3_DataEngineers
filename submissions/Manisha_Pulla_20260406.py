...
a . m1()#3rd method
m1()#Function
#function name and method name can be same and in case of funtions and classes the last one remains and others are ignored/discarded and in case of methods 
#--------------------------------------------------------------------------------------------------------------
#  Find  outputs  (Home  work)
class   c1:
	def   m1(self):
