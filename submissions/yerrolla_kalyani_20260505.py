...
x . m3()  #error there is no method m3() in parent class
x = child()
...
# End  of  the  class
c = child()
print(c . add(10 , 20 , 30))#child  method <nxt_line> 60
print(c . add(10 , 20))#child  method <nxt_line> 33
...
class  c5(c1):
	def  _init_(slef):
		print('c1  class  constructor')
# End  of  the  class
c1()  #error ,i.e obj is not created as it is a abstract parent class 
c2() #error ,i.e obj is not created as it is a abstract parent class
c3() #error obj is not created as it is   @abstractmethod
...
class  shape(ABC):
	def   get(self):
		self.a=float(input("enter a value:"))#How  to  read  value  of  'a'
	@abstractmethod
	def   area(self):
		pass
	@abstractmethod
...
class   parent(ABC):
	...
	def  m3(self):
		pass
class  child(parent):#child of parent which is abstaract class 
	def  m1(self):
		print('m1  method  of  child  class')
class  gc(child):#child of child
	def  m2(self):
		print('m2  method  of    gc  class')
class  ggc(gc):#child of gc
	def  m3(self):
		print('m3  method  of  ggc  class')
# End  of  the  class
a = ggc()#object is created 
a . m3()#m3  method  of  ggc  class
a . m2()#m2  method  of    gc  class
a . m1()#m1  method  of  child  class
parent() # object is not created error no refernce to parent()
child()  # object is not created error no refernce to child()
gc()# object is not created error no refernce to gc()
...
print(p1 . mod1 . x)  #error there is no p1 p1 is not imported so error due to p1
print()
print()
...
print(p1 . p2 . mod2 . x)  #error there is no p1 package ie it is not imported only the mod2 is only imported so error 
from  p1  import   p2 . mod2  #error the . is not supported in the import clause 
from  p2  import  mod2# error p2 is subdirectory of p1 without importing the p1 we cannot import the p2 i.e., error 
...
a=c1()  #
a.m1()  #How  to  call  method  m1()  of  class   c1   in  mod2  of  sub-package  p2  in  package  p1
from  p1  import  mod1 . *  # error  . is not supported in the import clause so error 