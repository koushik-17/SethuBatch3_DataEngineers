...
a[4] = 32 # range is immutable
print(a * 2) # range does not contain duplicates
...
e = range(-10)
print(*e) # it creates a empty string
f = range(2 , 2)
print(*f) # it creates a empty string
g = range(10 , 11 , 0.1) # range does not support float
h = range('A' , 'F')  # range does not support strings
...
a . remove('25')
print(a) # list does not contain '25'
...
print(a * 0) # []
print(a * -1) #[]
print(a * 4.0) #error, cant multiply by float
a = a * 3
...
a =  [25]
print(a[1]) # index 1 is not there
print(a[1:]) #[]
