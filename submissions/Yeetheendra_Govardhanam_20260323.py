...
#f1(40 , 50)  #Error replaced to 3 values
#f1(60)  #Error replaced to 3 values
#f1()#Error replaced to 3 values
...
# End  of  the  function
disp(25 , 'Rama Rao' , 10000.0)
#Emp Number : 25 \t Emp Name: Rama Rao \t Sal: 10000.0
disp(ename = 'Sita' , sal = 20000.0 , empno = 35)
#Emp Number : 35 \t Emp Name: Sita \t Sal: 20000.0
x = 'Rama  Rao'
y = 30000.0
z = 20
disp(x , y , z)
#Emp Number : Rama Rao \t Emp Name: 30000.0 \t Sal: 20
...
if n == 0:
    ...
    # Crores
    result += words(n // 10000000, "Crores")

    # Lakhs
    result += words((n // 100000) % 100, "Lakhs")

    # Thousands
    result += words((n // 1000) % 100, "Thousand")

    # Hundreds
    h = (n // 100) % 10
    if h != 0:
        result += words(h, "Hundred")
