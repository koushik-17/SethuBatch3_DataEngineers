...
a = int(input("enter a value : "))  #Read  input
b = prime_divisors(a)    #call  the  function
print("prime divisors : ", b)  #print  results
print("no.of prime divisors : ", len(b))
...
#def   f1(a  , b , *): # error * cannot be last
#        pass
...
# Identify error (Home  work)
#def  f1(/ , a , b ,  c): # error / cannot be starting
#        pass
#def   f2(a , b , c , *): # error * cannot be ending
#        pass

# Identify  error  (Home  work)
#def  f4(* , a , b , c , /): # error after keyword arguments no allows postional arguments
#	        pass
...
# Identify  Error
#def   f1(a = 10 ,  b ,  c = 20 ,  d): # error non default should at begin and default should at last 
#	pass
...
def   f1(a = 'Hyd' , b = []):
	...
	print('b :  ' , b)
# End of the function
#print('Default Values  :  ' , f1 . _defaults_) # a = ('Hyd',) b =([],)
f1() # a = HydSec b = [1,2,3] 
#print('Default Values  :  ' , f1 . _defaults_) # a = ('HydSec',) b = ([1,2,3],)
f1() # a = HydSec b= [1,2,3,1,2,3]
#print('Default Values  :  ' , f1 . _defaults_) # a = ('HydSecSec',) b = ([1,2,3,1,2,3],)
...
def   f1(*t):
	...
	print()
# End  of  the  function
f1(10 , 20 , 15 , 18) # (10,20,15,18) <next line> class tuple <nextline> 4 
f1() # None <nextline> class Nonetype <nextline> 0
...
tpl = (100 , 200 , 150)
f1(tpl) #((10,20,30),) <nextline> class tuple <nextline> 1
#f1(t = (10 , 20 , 30)) #   Error
...
# End  of  the  function
f1([10 , 20] , {30 , 40} , (50 , 60))  # [10 , 20]  <nextline> class list <nextline> {30 , 40} <nextline> class set <nextline> (50 , 60) <nextline> class tuple
...
def   disp(**a):
	...
	print()
# End  of  the  function
disp(RollNo = 10 , StudName = 'Rama  Rao') # class dict <nextline> {rollno:10,studname:'rama rao'}  
disp(EmpNo = 25 , EmpName = 'Sita' , Salary = 10000.0) # class dict  <nextline> {EmpNo : 25 , EmpName : 'Sita' , Salary : 10000.0}
disp(AcNo = 30 , CustName = 'Kiran' , Balance = 20000.0 , Gender = 'm') # class dict <nextline> {AcNo : 30 , CustName : 'Kiran' , Balance : 20000.0 , Gender : 'm'}
disp() # class dict <nextline>{}
