...
print(f'{a} / {b}','=',a/b)
print(f'{a} % {b}','=',a%b)
print(f'largest({a},{b})','=',max(a,b))
print(f'smallest({a},{b})','=',min(a,b))
print(f'{a} - {b}','=',a-b)
print(f'squareroot({a}) is :',math.sqrt(a))
print(f'gcd({a},{b}) is :',math.gcd(a,b))
print(f'factorial({a}) is :',math.factorial(a))
print(f'power({a},{b}) is :',math.pow(a,b))
...
print('Divisible by 2' if a%2==0 else 'Not Divisible by 2' )
