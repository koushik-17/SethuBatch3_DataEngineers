...
print( lambda   x  :  x * x(7))  # Error due to parenthesis for lambda function
print( lambda   x  :   x * x)  # 
...
#print(add())  # Error due to zero arguments
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))  # type and class of lambda function 


# Find  outputs (Home  work)
large = lambda x ,y : x > y  # How  to  define  lambda  to  determine  largest  of  two  arguments
...
print(x)  # (17	, 3 , 70 , 1.425714285714857)
p , q , r , s = all(9 , 2)
print(p)  # 11
print(q)  # 7
print(r)  # 18
...
#  Find  outputs
a  =  lambda  :  'Hyd'
print(a())  # Error due to zero arguments
print(a)  # type and class of lambda function
