...
print(add(10 , '20'))#Error because string and int cannot be concatenated

3) outputs 
def  f1():
	print('No-argument  function')#error because not permitted
def  f1(x):
	print('Single  argument  function  : ' , x)#error because not permitted
def  f1(x , y):
	print('Two  argument  function : ' , x , y)#error because not permitted
def  f1(x , y , z):
...
3) How  to  print  92  in  words ?  --->  b[92 // 10]  and  a[92 % 10]  = b[9]  and  a[2]
    How  to in  words ?  --->  b[92 // 10]  and  a[92 % 10]  = b[9]  and  a[2]
...
f1(True , None , b = 'Hyd')#Error because not permitted
f1(10 , 20 , x = 30)#Error because not permitted
f1(10 , 20)#Error because not permitted
...
print(f1(3 , 4 , 5))#23
print(f1(*[6 , 7 , 8]))#62
print(f1([6 , 7 , 8]))#Error because not valid
print(f1(*{1 : 2 , 3 : 4 , 5 : 6}))#16
print(f1(**{'c' : 2 , 'b' :  4 , 'a' : 6}))#14
print(f1({'c' : 2 , 'b' :  4 , 'a' : 6}))#Error because not valid
print({**{'c' : 2 , 'b' :  4 , 'a' : 6}})#{'c': 2, 'b': 4, 'a': 6}
print(f1(**{'c' : 2 , 'a' : 4 , 'x' : 6}))#Error because not valid

10) Identify  Error
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))#Error because keyword arg is first
print(sorted(a , rev = True))#Error because rev is not define in python
print(25 , 10.8 , 'Hyd' , separator = '\t')#Error because separator keyword is not permitted
print(25 , 10.8 , 'Hyd' , endofline = '\t')#Error because endofline keyword is not permitted
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')#error because of 10.8 and 'Hyd'