...
r=re.fullmatch('(0|[+]91)?[6789][0-9]{9}',a)
if r:
    print('valid')
else:
    print('invalid')
...
What  is  the  regular  expression  for  the  above  rules ?  --->(TS|ts|Ts|tS)(0[1-9]|1[0-9]|2[0-9])[A-Za-z]{2}[0-9]{4}

import re
a=input('Enter a vehicle number : ')
r=re.fullmatch('(TS|ts|Ts|tS)(0[1-9]|1[0-9]|2[0-9])[A-Za-z]{2}[0-9]{4}',a)
if r:
...
r=re.fullmatch('(0*[1-9]|1[0-9]|2[0-9]|3[0-1])/(0*[1-9]|1[0-2])/[0-9]{4}',a)
if r:
    print('Valid date')
else:
    print('Invalid date')
...
r=re.fullmatch('([A-Za-z]+|[ ]+)[,]([A-Za-z]+|[ ]+)[,]([A-Za-z]+|[ ]+)[-][0-9]{6}',a)
if r:
    print('Valid address')
else:
...
r=re.fullmatch('[4|5|6][0-9]{3}[-][0-9]{4}[-][0-9]{4}[-][0-9]{4}',a)
if r:
