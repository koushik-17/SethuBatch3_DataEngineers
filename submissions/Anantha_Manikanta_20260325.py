...
f1(70 , b = 80)  # Error because positional arguments are not allowed
f1(a = 15 , 25)  # Error because poaitional cant come after keyword argument
'''
'''
...
f1(70 , 80 , c = 90) # Error because only 1 positional argument is allowed but 2 are given
f1(70 , 80 , 90) # Error because only 1 positional argument is allowed but 3 are given
f1(c = 15 , b = 25 , 35) # Error because only positional argument is after keywoed arguments
'''
'''
4) # Identify error (Home  work)
def   f1(a  , b , *):
        pass  # Error because atleast 1 argument should be specified after *
'''
'''
...
# End  of   the  function
f1(10 , 20)  # a : 10 	 b : 20
f1(a = 30 ,  b = 40)  # Error because after / only positional arguments are allowed
f1(50 , b = 60)  # Error because after / only positional arguments are allowed
f1(a = 70 , 80)  # Error because positional argument cannot come after keyword argument
'''
'''
...
f1(a = 70 , b = 80 , c = 90)  # Error because a, b should be positional arguments only
f1(a = 100 , b = 110 , 120)  # Error because no positional argument is allowed after keyword argument
f1(a = 130 , 140 , c = 150)  # Error because no positional argument is allowed after keyword argument
f1(160 , b = 170 , 180)  # Error because no positional argument is allowed after keyword argument
f1(190 , b = 200 , c = 210)  # Error because b should be positional argument not keyword argument
'''
'''
...
f1(1 , b = 2 , c = 3 , d = 4 , e = 5 , f = 6)  #   # Error because b should be positional arguments only
f1(1 , 2 , 3 , 4 , 5 , f = 6)  # Error because e should be keyword argument only
f1(10 , 20 , c = 30 , 40 , e = 50 , f = 60)  # Error because no positional argument is allowed after keyword argument
f1(10 , 20 , 30 , 40 , e = 50 , f = 60)  #    # Error because no positional argument is allowed after keyword argument
'''
'''
8) # Identify error (Home  work)
def  f1(/ , a , b ,  c):
        pass  # Error because there should be atleast 1 argument before /
def   f2(a , b , c , *):
        pass  # Error because there should be atleast 1 argument after *

'''
'''
9) # Identify  error  (Home  work)
def  f4(* , a , b , c , /):
	        pass  # Error because / should come before *
'''
'''
...
f1(y = 20)  # Error because we created function with same name so previously created functions are deleted and error is y is not defined
f1(x = 30)  # Error because we created function with same name so previously created functions are deleted and error is x is not defined
'''
'''
...
print(add())  # Error because a's value is not specified
print(add(a = 100 , 200))  # Error because there cant be positional argument after keyword argument
print(add(100 ,  , 300))  # Error because invalid syntax there cant be spaces in b
print(add(100 ,  b , 300))  # Error because b is not defined
'''
'''
12) # Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass  # Erroe because default arguments should be at the end only
