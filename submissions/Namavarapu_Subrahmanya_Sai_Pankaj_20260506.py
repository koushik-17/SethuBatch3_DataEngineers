...
p1 . _init_ . f1()
a = p1 . _init_ . c1()
# Reason is that, this works only if p1/_init_.py exists as a real module; otherwise it is an import/access error.
...
from   p1 . mod1  import   *
import  p1 . _init_
# Reason is that, the imports are redundant and may overwrite earlier names; the last import* affects local names.