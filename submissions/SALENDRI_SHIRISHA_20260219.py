...
#print(range(4) | range(5))   # Error due to range neither support to plus operator nor to pipe operator
#print([10 , 20]  |  [30 , 20])  # Error due list can't be done with pipe operator, it done with plus (+) operator
...
# Find outputs
#print(7 / 0)  # Error due to division by zero in python
#print(7 // 0)  # Error due to division by zero in python
#print(7 % 0)  # Error due to division by zero in python
...
print(4 * 3 * 2)  # 4 * 3 * 2 = 24
print(3 + 4 * 5 - 32 / 2 ** 3) # 3 + 4 * 5 - 32 / 2 ^ 3  =  3 + 4 * 5 - 32 / 8  =  3 + 20 - 4  =  19.0
...
print(10 == 10.0)  # True
#print(3 + 4j >  3 + 4j) # Error due to complex numbers can't be compared with > , < , >= , <=
...
print(id(b))   # Same address of the Object 25
print(id(c))   # Same address of the Object 25
...
a , b , c = 3 , 4 , 5
a *= b + c   
print(a) # a = a * b + c  =  3 * 4 + 5  =  12 + 5  =  17

# Find outputs (Home work)
a = 20
a %= 3 + 2 * 4 
print(a) # a = a % 3 + 2 * 4  =  20 % 3 + 2 * 4  =  9 

# Find outputs (Home work)
a = 3
a **= 4 
print(a) # a = a ^ 4  =  3 ^ 4  =  81
...
print(a  is  not  b)  # False
print(a == b)  # True 
print() # Nothing is printed, moved to next line
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y)  # False
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 4 , 3]
print(x == y)  # False (Non matching characters)
a = (4 , 1 , 3 , 2)
b = (4 , 2 , 3 , 1)
print(a == b)  # False (Order is different)
p = {1 , 2 , 3 , 4}
q = {4 , 1 , 3 , 2}
print(p == q)  # True (Set is unordered)
m = range(5)
n = range(5)
print(m == n)  # True (Objects comparison)
...
#print(math . sqrt(-16))  # Error due to Negative number
#print(sqrt(49))  # math module is not imported, so it searches in the current program
...
#print(fabs(-25))  # Error due to math module, as it searches in the current program
...
#print(floor(3.5))  # Error due to math module, as it searches in the current program
#print(ceil(3.5))   # Error due to math module, as it searches in the current program