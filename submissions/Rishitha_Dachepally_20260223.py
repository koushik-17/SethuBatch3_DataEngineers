...
#print(a, b, c, separator = ':') # Error because print() has no argument named separator
...
print('%s' %a) # Hyd
print('%s' , a) # %s Hyd
#print('%s' a) # Error because missing % operator
#print('%s' , %a) # Error because invalid syntax
print(a) # Hyd
...
#print('%s' a) # Error because missing % operator
#print('%s', %a) # Error because invalid syntax
#print('%l' %a) # Error because %l is invalid format specifier
print(a) # [10, 20, 30, 40]
...
#print('%d %g %s' a, b, c) # Error because missing % operator
#print('%d %g %s' , %(a, b, c)) # Error because invalid syntax
#print('%d %g %s' %a%b%c) # Error because wrong formatting order
...
#print(F'{x =} \t {y =} \t {z =}') # Error because z is not defined
