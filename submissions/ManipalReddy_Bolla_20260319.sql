...
-- 4. Write a query to display employees information who is not getting commission.
...
-- DROP: Removes entire table structure and data, cannot be rolled back easily
