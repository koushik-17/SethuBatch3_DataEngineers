...
print(0XA7B9)  # 42937
print(int(3 + 4j)) # ERROR because complex can't be converted into int
print(int('25.4')) # ERROR because int str can be determined where as float str can't be 
print(int('Ten'))  # ERROR because Ten isn't number but is given as str
...
print(float(0B1010101)) # 26.0
print(float(0O6247)) # 3239.0
print(float(0XA7B9)) # 42397.0
print(float(3 + 4j)) # ERROR because complex can't be converted into float
print(float('Ten')) # ERROR because Ten isn't number but is given as str
...
4) Is  complex(3 , '4')  valid ?  ---> Invalid,  becoz  2nd  arg  can  not  be  a  string
...
print(complex('3')) # 3+0j
print(complex('3.8')) # 3.8+0j
print(complex(3 , '4')) # ERROR because  2nd  argument can't be str
print(complex('3' , 4))  # ERROR because  2nd  argument  is  not  permitted  when  1st  argument  is  a  str
print(complex('3' , '4'))  # ERROR because  2nd  argument  is  not  permitted  when  1st  argument  is  a  str
print(complex('Ten')) # ERROR because complex can allow accept numbers or number str
