...
b = a . copy() #Here deep copy takes place.a and b pointing to two different dictionaries.
...
a . update(b) #{'R': 'Red' , 'G': 'Green' , 'B': 'Blue' , 'Y' : 'Yellow'}
...
sorted_S = {k : v for k , v in sorted(S.items())}
print(sorted_S)
