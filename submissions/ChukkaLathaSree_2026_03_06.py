...
print(a [ : : -1])# [-1:-9:-1] indexes from -1 to -9 in steps of -1 i.e. oaR amaRprint(a [ : : -2])  #  a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
...
'''
output
Enter any string with alternative character and digit:A4B3C2$5
Result : AAAABBBCC$$$$$
'''
========================================================================================================================================================================
8'''
...
'''
try:
    n = input("Enter any string with alternative character: ")
    out = ''
    ...
    print("Pls enter string with alternative character")
    
'''
output
Enter any string with alternative character: A4M3Z5D2
Output: AEMPZ_DF
Enter any string with alternative character: Hyd
Pls enter string with alternative character 
'''
...
try:
    ...
    print('End')
========================================================================================================================================================================
16#  count()  method  demo  program (Home  work)
