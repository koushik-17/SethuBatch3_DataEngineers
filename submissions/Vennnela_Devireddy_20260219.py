#  Find  outputs
print({10 , 20}  |  {30 , 20})     # {10, 20, 30} ,'|' is the union operator for sets, Union means combine elements and remove duplicates.
print({10 : 'Hyd' , 20 : 'Sec'} |  {30 : 'Cyb' , 20 : 'Vja'})    # {10: 'Hyd', 20: 'Vja', 30: 'Cyb'}, Key 20 appears in both 'Sec' will be replaced by 'Vja'.
...
# ** operator demo program
print(3 ** 4)  #   3 ^ 4 = 81
print(10 ** -2) # 10⁻² = 1 / (10²) = 1 / 100 = 0.01
print(4 * 3 * 2) # 4 × 3 = 12 --> 12 × 2 = 24
print(3 + 4 * 5 - 32 / 2 ** 3) # 3 + 4 * 5 - 32 / 8 --> 3 + 20 - 4.0 --> 19.0
...
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y) # False , List are mutable so it creates 2 diff objects
print(x  is  not  y) # True
print(x == y) # True
print() #blank space
m = (1 , 2 , 3 , 4)
n = (1 , 2 , 3 , 4)
print(m  is  n) #True , because tuples are immutable objects
print(m  is  not  n) # False
print(m == n) # True
print(x == m) # False , different types are not equal
...
print(fabs(-25)) # NameError: name 'fabs' is not defined
