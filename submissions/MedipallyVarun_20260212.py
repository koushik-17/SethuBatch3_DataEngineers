...
print(int(3 + 4j)) # 3
print(int('25.4'))  # 25
print(int('Ten')) # Error (Sting can't be converted into integer)
...
print(float(0O6247)) #
print(float(0XA7B9)) #
print(float(3 + 4j)) # 3.0
print(float('Ten')) # Error (string can't be converted into float )
...
print(complex('3')) # 3 + 0j
print(complex('3.8')) # 3.8 +0j
print(complex(3 , '4')) # Error (string in imag is not possible)
print(complex('3' , 4))  # Error (string in real is not possible)
print(complex('3' , '4')) Error (string in real and imag is not possible)
print(complex('Ten')) Error (string is not possible)
...
print(hex(25))  # 0x19
print(hex(0B10101111010111)) ) # x2bf57
print(hex(0O6247)) # 0xc27
