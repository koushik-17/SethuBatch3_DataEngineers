...
Hint:  Use  slice
'''
a = input("enter the string : ") # java python
print(((a[5:7])+(a[2:4])),((a[0:2])+(a[7:11])),end=" ")
...
for i in range(1):
    ...
    print('Character  at  index  0  :' ,(n[0]))
    print('Character  at  index  1  :' ,(n[1]))
    print('Character  at  index  2  :' ,(n[2]))
    print('Character  at  index  3  :' ,(n[3]))
    print('Character  at  index  4  :' ,(n[4]))
for j in range(1):
    ...
    print('Character  at  index  -3  :' ,(n[-3]))
    print('Character  at  index  -4  :' ,(n[-4]))
    print('Character  at  index  -5  :' ,(n[-5]))  
'''
...
a = input("enter any string : ")
for i in range(1):
   print('string at even indexes :',a[0]+a[2]+a[4]+a[6])
   print('string at odd indexes :',a[1]+a[3]+a[5]+a[7])
'''
