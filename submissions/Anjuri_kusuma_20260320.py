...
print(max(a . items())) #[(10,20),(30,25),(40,5),(7,28),(9,50)]-->(40,5)
...
e = [[10 , 20 , 30] , [40 , 50 , 60] , [70 , 80 , 90]] #error
print(dict(e)) #error
f = [[10] , [20] , [30]]
print(dict(f)) #error
...
'''
a=eval(input("Enter any dictonary : "))
b=sorted(a.items())
c=dict(b)
print(c)
---------------------------------------------------
...
print(type(b)) #<class'list'>
for  x   in   b:
	print(x) #'Hyd' /n 'Sec' /n 'Cyb' /n 'Pune' /n
'''
...
for  x   in   b:
        print(x) #(10,Hyd) /n (20,Sec) /n (15,Cyb) /n (18,Pune) /n
for  x , y   in  b:
