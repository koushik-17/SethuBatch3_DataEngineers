...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list   #error But list has 4 elements.
a , b , *c , d , e = list
print('a : ' , a)       #a : 25
print('b : ' , b)       #b : 10.8
print('c : ' , c)       #c : []
print('d : ' , d)       #d:Hyd
print('e : ' , e)       #e:True
a , b , *c , d , e , f = list   #error  But list has 4 elements.
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list     #error Python does not allow more than one starred (*) expression in unpacking
...
print(sum(d))     #63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e))     #Error occurs.unsupported operand type(s) for +: 'float' and 'str'
...
print(list(10.8))    #error 'float' object is not iterable
print(list(True))    #error 'bool' object is not iterable
print(list(None))    #error 'none' object is not iterable
...
print(len(a))     #5
print(How  to  print  inner  list)     #print(a[2][0])
...
print("First element repeated:", a.count(a[0]))
