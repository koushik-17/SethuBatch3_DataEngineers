...
c . __init__() # empty
print('c  :  ' , c) # 22/7
a . __init__(3.8  , 4.6) # 3.8 / 4.8 
print('a  :  ' , a) # 22/7 
g = Rat(nr1 = 9 , 5) # error 
h = Rat(nr = 9 , dr = 5) # error there is no h 
...
d = Date() # Error
e = Date(dd = 30 , mm = 4 , yy = 2022) # Error due to dd, mm, yy 
f = Date(dd1 = 26 , mm1 = 8 , 2023) # Error due to there is one argument missing
...
a = c1()
b = c2()
print(b) #c2 class constructor and type and address of the object 
print(b . __init__())# c2 class constructor <next line> None 
c = c3()
print(c . __init__()) # c3 class constructor <next line> c3 class constructor <next line>
...
# End  of  the  class
a = f1()
print(a) # Constructor <next line> type and address
