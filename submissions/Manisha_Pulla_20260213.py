...
print(a) #range(10,15,5) 
print(*a) #10,15,20,25,30,35,40,45 
print(id(a)) # identity of an object 
print(len(a)) #8 
...
a , b , c = *r   
m = r   
print(id(r))  #identity of an object 
print(id(m)) #identity of an object 
#  Find  outputs  (Home  Work) 
...
print(id(a)) #identity of an object 
a = [25] 
print(a , id(a)) #[25] identity of an object 
print(a * a) #Error 
...
print(list[-2 : : -2])  #   list[-2 : -9 : -2]   --->  List  from  indexes  -2  to  -8  in steps  of  -2  
i.e.   [10.8 , True , 3+4j , 25] 
...
#     0     1     2    3     4 
a = [10 , 20 , 30 , 40 , 50] 
print(a , id(a)) #[10,20,30,40,50] identity of an object 
a[1 : 4] = [60 , 70] 
print(a , id(a)) #[10,60,70,50]   identity of an object 
a[2: 4] = [100 , 200 ,  300] 
print(a , id(a)) #[10,60,100,200,300]   identity of an object 
#  Find  outputs  (Home  work) 
a =  [25] 
print(a[1]) #Error 
print(a[1:]) #[]