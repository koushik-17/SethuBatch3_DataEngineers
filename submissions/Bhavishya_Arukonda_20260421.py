...
disp(f2)  # 10  0  -25  (25,)  Hyd  10.8 [10 , 20]  True 
...
f1 = filter(lambda x: x % 2 == 0, a)   # fresh iterator
for x in f1:
    print(x)  #  How  to  iterate  thru  filter  object  with  for  loop
# print('Unpack  filter  object :  ' ,  ???)
f1 = filter(lambda x: x % 2 == 0, a)
print('Unpack filter object : ', *list(f1))
f1 = filter(lambda x: x % 2 == 0, a)
