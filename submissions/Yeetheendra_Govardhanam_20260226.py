...
match  i:
	case  1:
		print('One')
	case  _: 
		print('None of   the  above') # it should be at the end
	case  2:
		print('Two')
print('Bye')
...
match  m:
	case  1:
		print('One')
	case  _:  
		print('Hello') #there should be only one wild card
	case  _:  
		print('Bye')
print('End')
...
match  m:
	case  1:
		print('Hyd') #Hyd rest one's are ignored
	case  1:
		print('Sec')
	case  1:
		print('Cyb')
