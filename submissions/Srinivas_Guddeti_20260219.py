...
#print(range(4) | range(5)) # Error because range does not support | operator
#print([10 , 20] | [30 , 20]) # Error because list does not support | operator
...
#print(7 / 0) # Error because division by zero is not allowed
#print(7 // 0) # Error because division by zero is not allowed
#print(7 % 0) # Error because modulo by zero is not allowed
...
print(10 == 10.0) # True
#print(3 + 4j > 3 + 4j) # Error because complex numbers cannot be compared using >
...
z = x + y * 6
print(z) # 34
#25 = a # Error because constant value cannot be assigned
#a + b = x + y # Error because expression cannot be assigned
...
a = 25
print(++a) # 25
#print(a++) # Error because Python does not support postfix increment
#print(a++1) # Error because invalid syntax
print(--a) # 25
#print(a--) # Error because Python does not support postfix decrement
#print(a--1) # Error because invalid syntax
print(-a) # -25
print(+-a) # -25
print(-+a) # -25
...
#print(math . sqrt(3+4j)) # Error because sqrt does not support complex number
print(math . sqrt(math . sqrt(256))) # 4.0
print(math . sqrt(math . pow(3 , 4))) # 9.0
#print(math . sqrt(-16)) # Error because sqrt does not support negative number
