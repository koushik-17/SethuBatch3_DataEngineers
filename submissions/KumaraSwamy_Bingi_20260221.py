...
print(x)  # complex number that entered
#  Tricky  program
# Find  outputs  (Home  work)
print(eval("    'hyd'   "))  # hyd
hyd = "Sec"
...
print(type(x))  # type of the input that entered
print(x)  # the input that entered
# What  is  a  better  approach  to  read  string  input ?
a = input("Enter  any  string  :  ")
print(len(a))  # length of the string that entered
print(a)  # the string that entered
b = eval(input("Enter   any  string  : "))
print(len(b))  # length of the string that entered
print(b)  # the string that entered
