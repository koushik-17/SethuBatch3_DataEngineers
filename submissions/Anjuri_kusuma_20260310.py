...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a))#[1,2,3] some add
a += b
print(a , id(a))#[1,2,3,4,5,6] same add
------------------------------------------------------------------------
# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]
...
print(a , id(a))#[1,2,3]  some add
a  = a + b
print(a , id(a))#[1,2,3,4,5,6] other add
---------------------------------------------------------------------------
# Find  outputs
...
print('c : ' , c)#Hyd
print('d : ' , d)#True
a , b , c , d = list #shortage of elements
-------------------------------------------------------------------------
# Comparing  Lists
a = [10 , 20 , 15 , 18]
b = [10 , 20 , 15 , 18]
...
d = [25 , '35']
print(max(d))#error
print(max([]))#requires arguments
print(min([]))#requires arguments
...
b = sorted(a)
print(b)#['Amar','Kiran','Rajesh','Rama','Rama Rao','Vamsi']
c = sorted(a , reverse = True)
print(c)['Vamsi','Rama Rao','Rama','Rajesh','Kiran','Amar']
...
try:
	...
	print('25  is   not  in  the  list')#this prints
...
'''
i1=[10 , 20 , 15 , 18 , 19 , 15 , 17 , 20 , 15 , 14]
i2=15
y=[]
for x in i1:
    if x!=i2:
...
a . sort(reverse = True)
print(a)#['Vamsi','Sita','Rama','Rama Rao','Rajesh','Kiran','Amar']
----------------------------------------------------------------------
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()#different elements cannot be compared 
----------------------------------------------------------------------
