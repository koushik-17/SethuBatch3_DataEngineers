...
insert into employees(emp_name,salary) values('Navaneeth',10000),('John',20000),('Prince',300000);
...
insert into company_employees(emp_id,emp_code,first_name,last_name,email,age,salary,department,joining_date,is_active)
 values(1000,242,'nava','reddy','navanreddy@gmail.com',30,30000,'HR','2026-03-03',TRUE);
