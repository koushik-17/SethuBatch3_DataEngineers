...
c = c3()             #c3 class constructor  None
...
self=c1() #How  to  create  c1  class  object  of  current  module
prog9a.self=c1() #How  to  create  c1  class  object  of  prog9a
-----------------------------------------------------------------------------------
'''
How  to  use  both  the  classes (i.e.  c1  of  prog9a  and  c1  of  current  program)
'''
