...
print(a  is  b)        # True
print(a  ==  b)         # True
b[2] = 12               # edits elemt at index 2 with 12
print(a)              # [10,20,12,18]
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a))  # [1,2,3] and address of list object
a += b   # edits a by addinf elemts from b
...
b = [4 , 5 , 6]
print(a , id(a))   #[1,2,3]
a  = a + b          #changes ref a to new list [1,2,3,4,5,6]
print(a , id(a))   # [1,2,3,4,5,6]
...
print(list(b))      
# [(10, 20), (30, 40, 50), (60, 70, 80, 90)]  (order may vary)
...
# Write a program to delete 'all' occurrences of 'x' from the list
...
# Tricky program
# Remove all duplicate elements (keep only elements with count = 1)
