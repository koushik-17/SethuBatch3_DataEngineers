...
-----------------------------------------------------------------------------------------------------------------
# Find  outputs  (Home  work)
print((lambda   x  :   x * x) (7)) # (lambda 7 : 49)
print( lambda   x  :  x * x(7)) # Error
print( lambda   x  :   x * x)  #Error
print( (lambda  x = 25 :  x * x) () )  #Error
square = lambda  x :  x  *  x #Error
print(square(5)) # 25
-----------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------
#  Find  outputs (Home work)
print((lambda  x , y : x + y) (10 , 20) ) # (lambda 10,20 : 30)
print((lambda  x , y : x + y) (10.8 , 20.6))# (lambda 10.8,20.6 : 31.4)
...
# Find  outputs
x = 5
adder1 = lambda    y  :  x + y # y:5+y
x = 10
adder2 = lambda    y  :  x + y # y:10
x = 20
adder3 = lambda    y  :  x + y
print(adder1(100))
x = 30
...
add = lambda  x  :   x == 25
print(add(10)) # x==10
add = lambda  x = 25 :   x == 35 # Error
print(add()) # Error
add = lambda  x  :   x = 25 # 25
