...
print(10.5 // 2) # prev  integer(5.0)   = 5.0
print(10 // 3) # prev  integer(3.3)   = 3
print(10.0 // 3) # prev  integer(3.0)   = 3.0
print(8.5 // 3) # prev  integer(2.0)   = 2.0
print(18 // 4) # prev  integer(4.5)   = 4
print(-18 // 4)  #  Tricky - prev  integer(-4.5)   = -5
print(-(18 // 4))  #  Tricky - prev  integer(-4)   = -4
...
print(id(b)) # same address of object a
print(id(c)) # same address of object a
