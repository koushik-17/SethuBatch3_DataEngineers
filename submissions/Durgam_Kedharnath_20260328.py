...
print( lambda   x  :  x * x(7)) # <function <lambda> at 0x000001F597A0E20>
print( lambda   x  :   x * x) # <function <lambda> at 0x000001F597E03E20>
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) # <function <lambda> at 0x000002659DB13E20>
print(lambda  x  :  print(x) (s)) # <function <lambda> at 0x000002659DB13E20>
