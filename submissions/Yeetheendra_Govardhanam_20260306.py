...
if len(x)>=2 and len(y)>=2:
	print(f"Result: {y[:2]+x[2:]} {x[:2]+y[2:]}")
else:
	print("Each  string  has  a   minimum  of  two  characters")
"""
...
print("String from left to righ : ")
...
print("String at even indexes : ", N)
...
"""
f = input("Ente any string : ")
g = ""
for h in f:
	if h not in g:
		g+=h
print("String without duplicates : ",g)
"""
...
index = -1
try:
	while  (index := a . index('is' , index + 1)) != -1:
		print(index)
except:
	print("End")
"""
