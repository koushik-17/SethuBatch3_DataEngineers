...
print(int(3 + 4j))  # Error due to complex object can't converted to int 
print(int('25.4'))  # Error due to invalid literal for int()
print(int('Ten'))   # Error due to invalid literal for int()
...
print(float(3 + 4j)) # Error due complex objects can't be converted to float
print(float('Ten')) # Error due string objects can't be converted to float
...
print(complex('3')) # (3 + 0j)
print(complex('3.8')) # (3.8 + 0j)
print(complex(3 , '4'))  # Error due to because 2nd arg cannot be string 
print(complex('3' , 4))  # Error due to because 1st arg cannot be string 
print(complex('3' , '4')) # Error due to invalid complex object
print(complex('Ten')) # Error due to invalid complex object
