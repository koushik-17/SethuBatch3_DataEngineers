...
print(a)  # (10, 20, 15, 18)
f1(a)
print(a)  # Error because tuple dont support assignment
'''
'''
...
print( lambda   x  :  x * x(7))  # <function <lambda> at 123>
print( lambda   x  :   x * x)  # <function <lambda> at 123>
...
print(add(10 , '20'))  # Error because string and integer cannot be concatenated
print(add())  #  Error because 2 argumnets are missing
print(add)  # <function <lambda> at 123>
'''
'''
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))  # <function <lambda> at 123>
'''
'''
...
a  =  lambda  :  'Hyd'
print(a())  # Hyd
print(a)  # <function <lambda> at 123>
'''
'''
14) # Tricky  program
# Find  outputs
...
s = 'Hyd'
print(lambda  s  :  print(s))  # <function <lambda> at 123>
print(lambda  x  :  print(x) (s))  # <function <lambda> at 123>
...
'''
'''
18) # Find output  (Home  work)
a = {'power_2'  :  lambda   x  :  x ** 2 ,
       'power_3'  :  lambda   x  :  x ** 3 ,
  	   'power_4'  :  lambda   x  :  x ** 4}
key = 'power_3'
print(a[key])  # <function <lambda> at 123>
print(a[key](5))  # 125
'''
'''
...
print(lamb(2))  # 9
print(lamb(5))  # 243
print(lamb)  # <function <lambda> at 123>
print(lamb())  # Error because the argument is not passed to lambda
'''
'''
...
'''
'''
21) #Nested  lambda  function  (Home  work)
...
'''
'''
23) Write  a  recursive  function  to  determine  gcd (or) hcf  of  two  numbers
...
print('Gcd : ', gcd(m, n))
'''
24) Write  a  recursive  function  to  find  sum of  the  digits  of  a  number
...
'''
25) Write  a  recursive  function  for  fibonacci  term
...
for i in range(1, n + 1):
    print(fib(i), end=' ')
'''
26) Write  a  recursive  power  function
...
print(a, '^', b, '=', power(a, b))
'''
27) Write  a   recursive  function  to  reverse  a  number
