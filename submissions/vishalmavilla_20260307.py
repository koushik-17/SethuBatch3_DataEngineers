...
print(f'Result : {st[0]}{st[1:].replace(st[0],'*')}')
...
for i in range(len(li)):
  #print(li[i][::-1]," ",sep='',end='')
  rev.append(li[i][::-1])
print('Reverse String :',' '.join(rev) )
