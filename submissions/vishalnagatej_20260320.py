...
print(sum(a))			# 90 sum of elements are keys in dict
# print(sum(a . items()))   # error sum not permitted for items in dict
...
# print(dict(e))	# error argument should be two arguments only , key and value
f = [[10] , [20] , [30]]
# print(dict(f))	# error
# print(dict([10 , 20]))	# dictionary argument should be exactly two elements , key and value
...
print(a)	# {}
del  a
# print(a)	# error becoz dict is deleted
...
print(a  is  b)   # False , becoz a and b is refers to different objects		
...
# for  x , y   in  a . keys():
    #   print(x , y , sep = ' ... ')    # error too many values to unpack
# for  x , y   in  a . values():
    #    print(x , y , sep = ' ... ')   # error too many values to unpack
# for  x , y   in  a:
    #    print(x , y , sep = ' ... ')   # error too many values to unpack
...
# a . update(b)  # 'a' should be dict not list
...
b = {}
# b.update(a)     
print(b)    # error argument should be exact 2 arguments
c = [(10,) , (20,) , (30,)]
# b . update(c)
print(b)    # error arguments should be exact 2 arguments
