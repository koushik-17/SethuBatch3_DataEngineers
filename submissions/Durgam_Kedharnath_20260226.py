...
if (a==b==c) and (a+b) > c and (b+c) > a and (c+a) > b:
    print("Equilateral Triangle")
    Area=math.sqrt(3)/4*a**2
    print("Area :",Area)
else :
    if (a==b or a==c or b==c) and (a+b > c and b+c > a and c+a > b) :
...
match  i:
	case  1:
		print('One')
	case  _: 
		print('None of   the  above') # Error wildcard should be used in last case
	case  2:
		print('Two')
print('Bye')
...
match  m:
	case  1:
		print('One')
	case  _:  
		print('Hello') # Error wildcards should be only one and it should in last case
	case  _:  
		print('Bye')
print('End')
...
match  units:
	case units if units <=100 :
		cost = 3*100
	case  units if units >=100:
		cost = (100*3)+((units-100)*3.50)
	case  units if units >=200:
		cost = (100*3)+(100*3.50)+((units-200)*4)
	case  units if units >=400:
		cost = (100*3)+(100*3.50)+(200*4)+((units-400)*4.50)
	case  units if units >=700:
		cost = (100*3)+(100*3.50)+(200*4)+(300*4.50)+((units-700)*5)
print(cost)
'''
