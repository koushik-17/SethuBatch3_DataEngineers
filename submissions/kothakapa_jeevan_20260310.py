...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) ---> [1,2,3] 1100222
a += b
print(a , id(a)) ---> [1,2,3,4,5,6] 222000333
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) ---> [1,2,3] 440055500
a  = a + b
print(a , id(a)) --> [1,2,3,4,5,6] 66998775
...
del    a[2]
print(a) --> [10,20,18]
del  a[3] --> error (index range not reached)
del  a --> deleted
print(a) --> error (no object called a)
