...
f1(1) # Single argument function : 1
...
n = int(input("Enter value of n: ")) # 10

result = prime_numbers(n)

print("Prime numbers:", result) # Prime numbers: [2, 3, 5, 7]
print("Number of prime numbers:", len(result)) # Number of prime numbers: 4
