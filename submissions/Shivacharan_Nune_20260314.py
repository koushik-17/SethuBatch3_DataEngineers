...
# a = (1 , 2 , 3)
# b = (4 , 5 , 6)
# print(a , id(a)) #(1 , 2 , 3),some address
# a += b           
# print(a , id(a)) #(1,2,3,4,5,6),Different address:new tuplec created reference modified
# #--------------------------------------------------------------
# #  Find  outputs
# a = (1 , 2 , 3)
# b = (4 , 5 , 6)
...
# a , *b = s
# print(a)#not sure
# print(b)#rest of elements in list
# print(type(b))#class list
#-----------------------------------------------
# # Find  outputs  (Home  work)
# s = {'Hyd',  25,  True,  10.8 }
# print(s)#{'Hyd',  25,  True,  10.8 } not sure
# a , *b , c = s
# print(a)#'Hyd' 
# print(b)#[25,True]
# print(c)#10.8
# #<if printed in line 258 order>
#----------------------------------------
# # Find  outputs  (Home  work)
# s = {20 , 10 , 20 , 10}
# print(s)#{20 , 10}
...
# b = set(a)
# print(b)#{100,110,120,130,140,150} may be
...
# a . add(set())#Error
# a . add({ })#Error:dictionary canner be added
#-----------------------------------------------------------------
# Find  outputs (Home  work)
# s = set()
# tpl = (10 , 20 , 15 , 18)
...
# print(a . pop())  #25 if 25 is first element
# print(a . pop())   #10.8 if 10.8 is first element
# print(a . pop())  #'Hyd' if it is the first element
# print(a . pop())  #True if its the first element
# print(a . pop())  #error 
# print(a) #{}
# b = {10 , 20 , 30 , 40}
# print(b . pop(2))  #error-since set is unordered-no index
...
# print(a | b)  #error
# print(b . union(a))#error-since list has no union method
# print(a + b)  #error-set cant be added using +
...
# print(a)  #{0,1,4,9,16,25,36,49,64,91} in any order
...
# a=set(eval(input('Enter first list: ')))
# b=set(eval(input('Enter second list: ')))
# c=a.intersection(b)
