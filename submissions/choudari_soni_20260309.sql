...
select * from employees_lab where emp_name and salary;
...
select * from emp where department = 'IT' or 'HR';
...
select distint department from employees_lab;
...
select * from employees_lab group by department having count(department)>2;
...
select * from employees_lab where limit5;
...
delete employees_lab where emp_name='Lokesh';
