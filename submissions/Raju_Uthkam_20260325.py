...
f1(70 , 80 , c = 90) #Error because b and c should be keyword arguments only 
f1(70 , 80 , 90) ##Error because b and c should be keyword arguments only
f1(c = 15 , b = 25 , 35) #we can't write keyword argument before positional argument (positional argument follows keyword argument)


# Identify error (Home  work)
def   f1(a  , b , *): #Error at least one argument is must be after * 
        pass
...
f1(a = 30 ,  b = 40) #Error because a and b both should be positional arguments 
f1(50 , b = 60) #Error 
f1(a = 70 , 80) #Error
...
f1(a = 130 , 140 , c = 150) #Error because a and b should be positional arguments 
f1(160 , b = 170 , 180) # b should be positional arguments 
f1(190 , b = 200 , c = 210) # b should be positional arguments 
...
#f1(10 , 20 , c = 30 , 40 , e = 50 , f = 60) #Error postional argument follows keyword argument 
f1(10 , 20 , 30 , 40 , e = 50 , f = 60) #a : 10 <tab> b : 20 <tab> c : 30 <tab> d : 40 <tab> e : 50 <tab> f : 60


# Identify error (Home  work)
def  f1(/ , a , b ,  c): #There should be at least one argument after slash 
        #pass
def   f2(a , b , c , *): #Invalid there should be at least one argument after *
        pass


# Identify  error  (Home  work)
def  f4(* , a , b , c , /): #at least one argument should be given after slash 
	        pass
...
f1(y = 20) #Error there is no arguments with y 
f1(x = 30) #Error there is no argument with x 
...
#print(add()) #Error
#print(add(a = 100 , 200)) #Error postional arg follows keyword arugument
...
# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d): #We can't pass non defalut arguments after default arguments 
	pass
...
#print(add(c = 100 , d = 200 , 300 , 400)) #Error there should not be postional arguments after keyword arguments 
#print(add(100 , 200 , c = 300 , x = 400)) #Error unexpected argument x 
#print(add()) #Error 
...
#disp(40 , 50 , 60 , 70) # Error 4 arguments are given 
...
print(add(80 , 90)) #Error we need to give only keyword arguments 


# Find  outputs(Home  work)
def   add(a = 10 , b , c): #non default parameter can't followed by default parameter 
        pass
def   add( * , a = 10 , b , c ):
        return  a + b + c
# End  of  the  function
...
print(add(c = 25 , a = 43)) #Error argument is missing
print(add(1 , 2 , 3)) #Error we can't give positional arguments
def   add(a , b = 10 ,  c ,  * , d  , e = 20 , f): #keyword argument follows positional argument
		pass
...
print('__defaults_  :  ' , f1.__defaults__) ##([0,1,2],)
...
def   f1(a = 'Hyd' , b = []): 
	...
	print('b :  ' , b)
# End of the function
print('Default Values  :  ' , f1 . __defaults__) #'Hyd' <nextline> ([],)
f1() #Hyd <nextline> [1,2,3]
print('Default Values  :  ' , f1 . __defaults__) #Hyd' <nextline> ([],)
f1() #SecHyd <nextline> [1,2,3]
print('Default Values  :  ' , f1 . __defaults__) #Hyd' <nextline> ([],)
f1() #SecHyd <nextline> [1,2,3]
...
def   f1(*t):
	...
	print()
# End  of  the  function
f1(10 , 20 , 15 , 18) #(10,20,15,18) <nextline> <class 'tuple'> <nextline> 4 <nextline>
f1() #() <nextline> <class 'tuple'> <nextline> 0 <nextline>
f1([10 , 20] , (30 , 40 , 50) , {60 , 70 , 80 , 90}) 
#([10 , 20] , (30 , 40 , 50) , {60 , 70 , 80 , 90}) <nextline> <class 'tuple'> <nextline> 3 <nextline>
f1('Hyd') #('Hyd') <nextline> <class 'tuple'> <nextline> 1 <nextline>
tpl = (100 , 200 , 150)
f1(tpl) #((100,200,150)) <nextline> <class 'tuple'> <nextline> 1 <nextline>
f1(t = (10 , 20 , 30)) #   Error
...
#print(avg()) #Error
print(avg(25)) #Average of 25
print(avg(3 + 4j , 5 + 6j)) #Average of 3 + 4j , 5 + 6j
tpl = (10 , 20 , 15 , 18)
#print(avg(tpl))
...
print(concat()) #Nothing is printed 
...
f1(70) #a : 70, b : ()
f1(a = 80) #Error
#f1(b = (10 , 20 , 30) , a = 40) #a : 40 <tab> b : (10,20,30)
f1() #Error
#f1(a = 10 , (20 , 30 , 40))
#f1(25 , b = (10 , 20 , 30)) #a : 25 <tab> b : (10 , 20 , 30)
f1(25 , a = (10 , 20 , 30)) #a : (10 , 20 , 30) <tab> (25,)
...
f1(50 , b = 60) # a : (50,) <tab> 60
f1(b = 70) #Error argument is missing 
...
def   disp(**a):
	...
	print()
# End  of  the  function
disp(RollNo = 10 , StudName = 'Rama  Rao') #Results <nextline> <class 'dict'> <nextline> {RollNo:10,StudName:'Rama Rao'} <Nextline> Empty space 
disp(EmpNo = 25 , EmpName = 'Sita' , Salary = 10000.0) #Results <nextline> <class 'dict'> <nextline> {EmpNo:25,EmpName:'Sita',Salary:10000.0}
disp(AcNo = 30 , CustName = 'Kiran' , Balance = 20000.0 , Gender = 'm') #Results <nextline> <class 'dict'> <nextline> {AcNo:30,CustName:'Kiran',Balance:20000.0}
...
#Results Empno....25 <nextline> Empname...'Rama rao' <nextline> Salary...10000.0 <nextline> Gender...m
f1() #Results 
...
def   f2(**a):
	print(a)
# End  of  the  function
f1(empno = 25 , ename = 'Sita' , sal = 10000.0) #Emp Number : 25 <tab> ename : 'Sita' <tab> salary : 10000.0
...
#10.8 <nextline> (25,'Hyd',True),{ EmpNo : 12 , EmpName : 'Rama  Rao' , Salary : 10000.0}