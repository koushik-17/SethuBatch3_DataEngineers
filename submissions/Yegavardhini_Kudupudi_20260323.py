...
f1(40 , 50)  #  Error becoz the last f1() function has 3 argunments but the function call has only 2
f1(60)    #  Error becoz the last f1() function has 3 argunments but the function call has only 1
f1()  #  Error becoz the last f1() function has 3 argunments 
...
print(f1(*[6 , 7 , 8])) # 62
print(f1([6 , 7 , 8])) # 
print(f1(*{1 : 2 , 3 : 4 , 5 : 6})) # *dict menas unpack to form a list of keys 
