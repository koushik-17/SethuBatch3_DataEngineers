...
'''
Enter  any  string : Sankar dayal sharma
Enter  any pattern : san
Sankar dayal sharma starts  with  San
...
res=re.findall('(0|\+91)?[6789][0-9]{9}',n)
if res:
    print("Valid mobile number")
else:
    print("invalid moblie number")
...
res = re.findall('[Tt][Ss][0-2][1-9][A-z]{2}[0-9]{4}', n)

if res:
    print("Valid vechile registration number")
else:
...
n = input("enter the  number:")
res = re.findall('^(0[1-9]|[1-9]|[12][0-9]|3[01])/(0[1-9]|[1-9]|1[0-2])/[0-9]{4}$', n)

if res:
    print("Valid date")
else:
    print("invalid invalid date")
#########################################################################################
'''
...
n = input("enter the  number:")
res = re.findall('[a-zA-Z]+,[a-zA-Z]+,[a-zA-Z]+-[0-9]{6}$', n)
...
'^[456][0-9]{3}-?[0-9]{4}-?[0-9]{4}-?[0-9]$'
'''
import re

n = input("enter the  number:")
res = re.findall('^[456][0-9]{3}-?[0-9]{4}-?[0-9]{4}-?[0-9]{4}$', n)
