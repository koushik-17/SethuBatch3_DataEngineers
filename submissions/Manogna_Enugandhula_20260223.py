...
print('%s'  %a) #Hyd
print('%s' , a) #%s Hyd
#print('%s'  a) #error due to expecting ',' or % 
#print('%s' , %a) #error due to required only ',' or "%" not both
print(a) #Hyd
...
#print('%d    %g      %s'   a , b , c) #error due to expecting '%' before a,b,c
#print('%d    %g    %s'  ,  %(a , b , c)) # error due to ',' and % expecting any one ',' or %
...
#print(F'{x =}  \t   {y =}   \t  {z =}')# error due to undefined x,y,z
