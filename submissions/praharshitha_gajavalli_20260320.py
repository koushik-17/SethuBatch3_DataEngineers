...
print(sum(a)) # 90
print(sum(a . items())) # ERROR because keys and values together can't be added
...
print(dict(e)) # ERROR because sequence of 2 elements can form key-value pairs,but here we have 3 elements so not possible
f = [[10] , [20] , [30]]
print(dict(f)) # ERROR because sequence of 2 elements can form key-value pairs,but here we have single element so not possible
print(dict([10 , 20])) # ERROR because we can't directly convert list into dict
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) # {10: [20, 30], 40: [50, 60], 70: [80, 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h)) # ERROR because list can't be used as key.
i = [[(10 , 20) , 30] , [(40 , 50) , 60] , [(70 , 80) , 90]]
print(dict(i)) # ERROR because tuple can't be used as key.
...
print(a) # {}
del  a 
print(a) # ERROR because there is no dict a
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ') # 10 ... Hyd<nextline>20 ... Sec<nextline>15 ... Cyb<nextline>18 ... Pune
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ') # ERROR because key is single element but asked for 2 elements to unpack
for  x , y   in  a . values():
       print(x , y , sep = ' ... ') # ERROR because value is single element but asked for 2 elements to unpack
for  x , y   in  a:
       print(x , y , sep = ' ... ') # ERROR because key is single element but asked for 2 elements to unpack
...
a . update(b) # ERROR because list 'a' doesn't have method update()

#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)]
b = {}
b.update(a)
print(b) # ERROR because empty dict can't be updated to list 'a' and sequence of three elements is not accepted
c = [(10,) , (20,) , (30,)]
b . update(c)
print(b)  # ERROR because single element can't be used
