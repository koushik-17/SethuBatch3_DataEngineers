...
print(next(z1))
print(next(z1))
# print(next(z1))  # StopIteration error
...
print('\nUnpacks zip object with * operator : ', *zip(a, b))
...
disp(z7) = No Iterables ==> Empty Iterator
...
print(id(b)) = (some integer, depends on system)

print(*b) = D Y H

print(b[0]) ==> Reversed Object Doesn't Allow Indexing

print(b[1 : 3]) ==> Reversed Object Doesn't Allow Slicing

print(b * 2) ==> Reversed Object Doesn't Allow Repetition

print(len(b)) ==> Reversed Object Has No len() Attribute
