...
print(eval('False'))#False  → actual boolean False
print(bool(''))#False → empty string is False
print(eval('  ""  '))#"" → empty string
print(eval(''))#error → empty string cannot be evaluated
print(eval('  " "   '))#" "→ string with space
print(eval(' '))#space(nothing is printed)→ cannot evaluate only whitespace
