...
print(id(a))                # (some integer id - system dependent)
print(len(a))               # 8
...
print(a * 2)                # (Not executed due to above error)
...
h = range('A' , 'F')        # TypeError: 'str' object cannot be interpreted as an integer
...
print(id(a))                # (new id value)
a = [25]
print(a , id(a))            # [25] (some id)
...
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a))            # [10, 20, 30, 40, 50] (same id throughout)
a[1 : 4] = [60 , 70]
