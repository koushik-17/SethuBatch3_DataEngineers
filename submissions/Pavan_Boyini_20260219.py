...
print(range(4) | range(5))    # Error  can't concate  
print([10 , 20]  |  [30 , 20])  # [10, 20 , 30, 20]
...
print(7 // 0)
print(7 % 0)
[11:47 am, 19/2/2026] +91 99482 50500: # ** operator demo program
print(3 ** 4)  #   3 ^ 4 = 81
print(10 ** -2)
print(4 * 3 * 2)
print(3 + 4 * 5 - 32 / 2 ** 3)
...
print(not  25) #   False
print(not  0)   # True explanation not 0 which mean non zero 
print(not  'Hyd')  # False
print(not  '')  # True 
print(not  -10)  # False
...
i = not  i > 14    # True
print(i)  # 10
print(not(6 < 4  or  9 >= 5  and  6 != 6))  # True  false or True  = True ===> True and False = False ===> not(False) = True


#  Assignment  operators  demo  program  (Home  work)

a = 25  # reference a pointing to int object 25
print(a)  # 25
b =  a   # b is referencing a's object 25
print(b)  # 25
print(a  is  b)  #  True it is checking the references of 25, is both  a and b are pointing to the same object or not 
x = 4
y = 5
z = x + y * 6
print(z)   # 34
25 = a   # Error left side must be reference not constant
a + b = x + y   #  Error left side must be reference not constant
...
a = 20
a %= 3 + 2 * 4  
print(a)  # 9 reminder for % (a = 20 % 11)
...
a = 'Hyd'
b = 'Hyd'
print(a  is  b)     #  True  different references  
print(a  is  not  b)   # False 
print(a == b)   # True
print()   # False 
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 3 , 4]
print(x is y)    # False different references
...
print(m == n)  # True 
print(x == m)  # False x is list and m is tuple


 # Find outputs (Home work)
x = [1 , 2 , 3 , 4]
y = [1 , 2 , 4 , 3]
print(x == y)        # False  Because both has different elements in the list
a = (4 , 1 , 3 , 2)
b = (4 , 2 , 3 , 1)
print(a == b)        #  False  Because both has different elements at different indexes in the list
p = {1 , 2 , 3 , 4}
q = {4 , 1 , 3 , 2}
print(p == q)      # True 
m = range(5)
n = range(5)
print(m == n)   # False can't be reusable


 # Find outputs (Home work)
a = [10 , 20 , 30]  # 
b = (10 , 20 , 30)
print(a  is  b)   # False because both a and b has different address
...
print(math . sqrt(3+4j)) # Error complex can't be squarerooted
