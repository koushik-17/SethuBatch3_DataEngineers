...
print(range(4) | range(5)) #(0,1,2,3,4)
...
print(8.5 // 3) #prev  integer()   = 4.0
print(18 // 4) #prev  integer(2.833)   = 2.0
...
print(math . sqrt(10)) #3.1623
print(math . sqrt(6.25)) #
print(math . sqrt(True)) #1
print(math . sqrt(3+4j)) # 2+1j
