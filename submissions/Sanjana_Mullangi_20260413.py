...
print(sys . getrefcount(352))#can be many references as integer is an immutable objects and it cannot be predicted
print(sys . getrefcount([10 , 20 , 15 , 18]))#1
print(sys . getrefcount(10.8))#can be many references as float is an immutable objects and it cannot be predicted
print(sys . getrefcount({10 , 20 , 15 , 18}))#1
print(sys . getrefcount('Hyd'))#can be many references as string is an immutable objects and it cannot be predicted
print(sys . getrefcount({10 : 20 , 30 : 40}))#1
print(sys . getrefcount((10 , 20 , 30 , 40)))#can be many references as tuple is an immutable objects and it cannot be predicted
...
print('Bye')
'''
Constructor: addressof object t
Constructor: addressof object t
None
any number of references
Destructor : address of object which is lost
25
any number of references
Bye
Destructor : address of object which is lost'''
