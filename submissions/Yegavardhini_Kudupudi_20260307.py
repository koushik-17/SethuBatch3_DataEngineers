...
e = [15 , 36 , 48]
print(':' . join(e)) # error the elements in the list are not strings
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f)) # SankarDayalSarma
g = range(5)
print('-' . join(g)) # error the range obj contains integer vales not strings

#  Case  conversion  methods  (Home  work)
a = 'hyD  iS  grEen  cITy'
print(a . upper()) # HYD ID GREEN CITY
print(a . lower()) #hyd is gree city
...
print('' . isdigit()) #   False
print(' ' . isdigit())  #  False
print(9247 . isdigit()) # error as 9247 is an integer
...
2) When  does  it  return  False ?  ---> When  at  least  one  character  of  the  string  is  a   non-digit  i.e. alphabet  (or) special  character	   (or)  When  there  are  no  digits  in  the  string
'''
...
2) When  does  it  return  False ?  ---> When  at  least  one  character  of  the  string  is  not  a  white  space (i.e.  Alphabet, digit (or)  special  character) (or)  When  there  are  no  white  space  characters																					
'''
