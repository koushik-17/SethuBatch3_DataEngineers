...
print( lambda   x  :  x * x(7))     # <function <lambda> at 0x7a103f83c180> Gives Address and type of Function
print( lambda   x  :   x * x)       # <function <lambda> at 0x7a103f83c180> Gives Address and type of Function
...
add = lambda x= 50,y=50 : x+y  # How  to  define  lambda  function   to  return  sum   of  two  arguments
...
print(add())                # 100
print(add)                  # <function <lambda> at 0x7a103f83c180>
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))# <function <lambda> at 0x7d6461aa4180>
...
a  =  lambda  :  'Hyd'
print(a()) # 'Hyd'
print(a)   # <function <lambda> at 0x7a260a318180>
...
s = 'Hyd'
print(lambda  s  :  print(s))      # <function <lambda> at 0x7c7fe2c24180>
print(lambda  x  :  print(x) (s))  # <function <lambda> at 0x7c7fe2c24180>
...
print(a) # [<function f1 at 0x7a4dcfaa0180>, <function f2 at 0x7a4dcfaa0220>]

#-------------------------------------

#19.Find output  (Home  work)
a = {'power_2'  :  lambda   x  :  x ** 2 ,
       'power_3'  :  lambda   x  :  x ** 3 ,
  	   'power_4'  :  lambda   x  :  x ** 4}
key = 'power_3'
print(a[key])   # <function <lambda> at 0x7d2d0a300220>
print(a[key](5))# 125
...
print(lamb(2))   # 9
print(lamb(5))   # 243
print(lamb)      # <function f1.<locals>.<lambda> at 0x7d46a93c0220>
print(lamb())    # Error
...
#22.Nested  lambda  function  (Home  work)
...
'''
24.Write  a  recursive  function  to  determine  gcd (or) hcf  of  two  numbers
...
def  gcd(m , n):
	if n == 0:
	    ...
	    return gcd(n,m%n)
'''
1) gcd(4 , 6)  = gcd(6,4) = gcd(4,2) = gcd(2,0)
'''
...
'''
25.Write  a  recursive  function  to  find  sum of  the  digits  of  a  number
...
'''
26.Write  a  recursive  function  for  fibonacci  term
...
'''
27.Write  a  recursive  power  function
...
'''
28.Write  a   recursive  function  to  reverse  a  number
