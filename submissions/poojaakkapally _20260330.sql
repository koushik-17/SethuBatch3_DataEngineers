...
SELECT * FROM empdept;
#-----------------------------------------------------------------------------------------------------------------------------------------
4. I have created a table T1 and inserted 10 records and based on T1 I have created Viewv1
after that I have deleted 2 records from T1, now when we query from V1 how many recordsfetched.

The view also contains 8 records which are satisfying the condition. View does not store data it always shows latest data from table.
#---------------------------------------------------------------------------------------------------------------------------------------
