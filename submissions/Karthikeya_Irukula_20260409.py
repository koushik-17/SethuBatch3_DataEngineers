...
a . __init__(3.8  , 4.6)
print('a  :  ' , a) #3.8/4.6
#g = Rat(nr1 = 9 , 5) # Positional argument cannot send after keyword argument.
#h = Rat(nr = 9 , dr = 5) #Arguments are nr1 and dr1 in __init__.
...
print('b  :  ' , b . __dict__)
print('c  :  ' , c . __dict__)
#d = Date() #Error missing arguments
#e = Date(dd = 30 , mm = 4 , yy = 2022) #Its dd1, mm1, yy1 in __init__.
#f = Date(dd1 = 26 , mm1 = 8 , 2023) #Missing year argument
...
a = c1() #c1  class constructor
         #Error  __init__ cannot return non null values.
...
class  c1:
	def  __init__(self):
		...
		b = c1()
# End  of  class
a = c1() #Constructor.... infinite loop
