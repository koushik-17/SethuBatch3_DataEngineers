...
f1(50 , 60) # Error both arguments should be keyword arguments
f1(70 , b = 80) # Error both arguments should be keyword arguments
f1(a = 15 , 25) # Error both arguments should be keyword arguments
...
f1(70 , 80 , c = 90) # Error arguments should be keyword arguments
f1(70 , 80 , 90) # Error arguments should be keyword arguments
f1(c = 15 , b = 25 , 35) # Error arguments should be keyword arguments



# Identify error (Home  work)
def   f1(a  , b , *): # Error should before the arguments
        pass
...
# End  of   the  function
f1(10 , 20) # a  :  10  	  b  :  20 
f1(a = 30 ,  b = 40) # Error arguments should be positional arguments
f1(50 , b = 60) # Error arguments should be positional arguments
f1(a = 70 , 80) # Error arguments should be positional arguments
...
f1(a = 70 , b = 80 , c = 90) # Error arguments should be positional arguments

f1(a = 100 , b = 110 , 120)  # Error arguments should be positional arguments

f1(a = 130 , 140 , c = 150)  # Error arguments should be positional arguments

f1(160 , b = 170 , 180)      # Error arguments should be positional arguments

f1(190 , b = 200 , c = 210)  # Error arguments should be positional arguments
...
def  f1(/ , a , b ,  c):  # / Error  It should come after Parameters
        pass              
def   f2(a , b , c , *):  # Error
        pass
...
def  f4(* , a , b , c , /):  # Error cannot use both * a nd / 
	        pass
...
def   f1(a = 10 ,  b ,  c = 20 ,  d): # Error keyword arguments should follow positional arguments
	pass

def   f2(b , d , a = 10 , c = 20): # empty line
	pass
...
print(add(50 , 60 , 70))      # 3-argument  function
                                184

print(add(80 , 90))   # 2-argument  function
                          177
...
f1((10 , 20 , 30) , 10 , 20 , 30) # a : (19,20,30)	b : (10,20,30)
