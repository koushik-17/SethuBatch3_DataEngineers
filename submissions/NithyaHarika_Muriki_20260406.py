...
print(*g)#waiting time and memory issue
...
print(len(g)) #error
print(g * 3)  #error
print(g[0])  #has no indexing
print(g[1 : 3])#has no slicing
print(*g)#1 2 3
...
class   c2:
        pass
class   c3:#error,class must contain either methods or pass
...
print(type(a))#<_main__.c1 object at a>
print(a . _dict_)#converts obj a to dictionary
print(a)#empty
del  a	#deletes
print(a)#error
...
a . m1(30)#arg should contain 2 
a . m1()#there are no args expected 2
