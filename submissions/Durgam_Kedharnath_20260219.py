...
print(range(4) | range(5)) # Error range cannot perform concat operation
print([10 , 20]  |  [30 , 20]) # Error pipe symbol cannot use to concat in list
...
print(8.5 // 3) # prev  integer(2.85)   = 2.0
print(18 // 4) # prev  integer(4.5)   = 4
print(-18 // 4)  # prev  integer(-4.5)   = -5 Tricky
print(-(18 // 4))  # prev  integer(-4.5)   = -4 Tricky
...
print(10 == 10.0) # True
print(3 + 4j >  3 + 4j) # Error >,<,>=,<= this operation cannot perform on commplex object
...
print(id(b)) # Address of the same object 25
print(id(c)) # Address of the same object 25
...
print('Two'); # Two
print('Three'); # Three
print('Hyd')  ; # Hyd  print('Sec')  ; # Sec print('Cyb') # Cyd

#pow()  function  demo  program
import  math
print(math . pow(2 , 3))  #  2 ^ 3 = 8 8.0
