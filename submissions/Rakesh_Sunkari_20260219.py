...
print(range(4) | range(5)) # error bez range obj can never be concatinated
print([10 , 20]  |  [30 , 20]) # [10,20,30,]
...
print(10.5 // 2)	# prev interger(0.5) = 0
print(10 // 3)		# prev interger (1) = 1
...
print(3 + 4 * 5 - 32 / 2 ** 3) # (3+20-32/8)=(23-32/8)=(23-4)= 19
