...
print(a) # range object range(10 , 50 , 5)
print(*a) # from indexes 10 to 49 in steps of 5  i.e 10 15 20 25 30 35 40 45
...
print(a * 2) #  error since range is immutable, no repitition
...
e = range(-10)
print(*e) # empty string as it is error
f = range(2 , 2)
print(*f) # empty string as it is error
g = range(10 , 11 , 0.1)  # error
h = range('A' , 'F')  # error

#  Find  outputs  (Home  work)
r = range(10 ,  17 , 3) # indexes from 10 to 16 in steps of 3
a , b , c = r  
...
a . remove('25')  # error as str '25' not present in list it should be 25
print(a) # [25,10.8,True]
...
print(a * 0)    # []
print(a * -1)   # []
print(a * 4.0) # error as sequence*integer only
a = a * 3
print(a)   # [25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd',25 , 10.8 , 'Hyd']
print(id(a)) # address of obj a
a = [25]
print(a , id(a)) # [25] address of obj a
print(a * a)  # error as sequence * integer only
...
print(list(25)) # error as list arg can only be sequence
...
print(len(a))  # 1
b = list()
print(b)      # returns empty list i.e [] 
print(len(b))  # 0
...
#       -8      -7        -6          -5         -4      -3       -2      -1
print(list[2 : 7]) # [3+4j , 'Hyd' ,True, None, 10.8] i.e list from indexes 2 to 6 in steps of 1
print(list[ : : ])  #  [25 ,  10.8 ,      3 + 4j ,  'Hyd' ,     True , None ,    10.8 , 'Hyd']
print(list[:])      #  [25 ,  10.8 ,      3 + 4j ,  'Hyd' ,     True , None ,    10.8 , 'Hyd']
print(list[ : : -1]) # ['Hyd', 10.8 , None, True , 'Hyd', 3+4j , 10.8 , 25]  i.e reverse string
...
print('y : ' , y)  # True
for  x  in  list[2:7]:
	print(x) # list from indexes from 2 to 6 in steps of 1
...
#    0     1     2    3     4
a =  [10 , 20 , 30 , 40 , 50]
print(a , id(a))  # [10 , 20, 30 , 40 , 50]  address of obj a
a[1 : 4] = [60 , 70] 
print(a , id(a)) # [10,60,70,50]  address of obj a
a[2: 4] = [100 , 200 ,  300]
print(a , id(a)) # [10,20,100,200,300,50]
