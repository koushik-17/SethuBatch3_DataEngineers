...
def  f2():
		print('f2  function')
f1() # f1 Function <nextline> f2 function
...
print(add(10 , '20')) # Error int and str cannot concat
...
f1(40 , 50) # Error required three arguments
f1(60) # Error required three arguments
f1() # Error required three arguments
...
'''
1) prime(25)  --->
    How  many  times  is  for  loop  executed ?  --->25
...
4) prime(49) --->
    How  many  times  is  for  loop  executed ?  --->49
'''
...
f1(10 , 20 , x = 30) # Error x is not defined
f1(10 , 20) # Error one argument is missing
...
print(f1({'c' : 2 , 'b' :  4 , 'a' : 6})) #  Error set is not unpacked
print({**{'c' : 2 , 'b' :  4 , 'a' : 6}}) # {'c': 2, 'b': 4, 'a': 6}
print(f1(**{'c' : 2 , 'a' : 4 , 'x' : 6})) # Error x is not in defined arguments



10)# Identify  Error (Home  work)
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a)) # Error first there should be object and after keyword should be placed
print(sorted(a , rev = True)) # Error keyword is invalid
print(25 , 10.8 , 'Hyd' , separator = '\t') # Error keyword is invalid
print(25 , 10.8 , 'Hyd' , endofline = '\t') Error invalid keyword
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') # Error end should be last