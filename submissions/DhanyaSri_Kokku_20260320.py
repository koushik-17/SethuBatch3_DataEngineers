...
print(sum(a)) # 90
print(sum(a . items())) # Error because dict.items() returns dict_items(list(tuples)) the sum() method cannot add tuples values
...
print(dict(e))  # Error because the inner sequence should contain exactly two elements
f = [[10] , [20] , [30]]
print(dict(f))  # Error because the inner sequence should contain exactly two elements
print(dict([10 , 20])) # Error because the argument for the dict() function should be nested sequence
...
print(a) # {}
del  a
print(a) # Error beacuse object a is not found
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
b = a . values()
print(b) # dict_values([ 10 , 20 , 15 , 18 ])
...
for  x , y   in  a . keys():  # Error due to unsufficient number of variables for unpacking
       print(x , y , sep = ' ... ')
for  x , y   in  a . values(): # Error due to unsufficient number of variables for unpacking
       print(x , y , sep = ' ... ')
for  x , y   in  a: # Error due to unsufficient number of variables for unpacking
       print(x , y , sep = ' ... ')
...
b = {'Y' : 'Yellow', 'G' : 'Gray'}
b . update(a) 
print(b)  # { 'Y' : 'Yellow' , 'G' : 'Gray' , 'B' : 'Blue'}
a . update(b) # Error list does not has update() method

#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)]
b = {}
b.update(a) 
print(b) # Error because the inner sequence should contain exactly two elements
c = [(10,) , (20,) , (30,)]
b . update(c)
print(b) # Error because the inner sequence should contain exactly two elements
