...
print(range(4) | range(5)) # Error  | not support Range object

print([10 , 20]  |  [30 , 20]) # # Error  | not support List object
...
print(18 // 4)  # prev  integer(4.6)   = 4
print(-18 // 4)  #  prev  integer(-4.5)   = 5.0
...
print(not  0) #True  (Zero is False -> not false = true)
print(not  'Hyd') # False
print(not  '')    # True
print(not  -10)   # False
...
i = 10
i = not  i > 14 
print(i) # here 10 > 14 False -> not False = True
...
a , b , c = 3 , 4 , 5
a *= b + c   
print(a)  # b + c = 9, 3 * 9 = 27, output = 27

# Find outputs (Home work)
a = 20
a %= 3 + 2 * 4  
print(a)   # 2 * 4 = 8, 3 + 8 = 11, 20 % 11 = 9 is output 
...
print(math . sqrt(-16)) # Error : negative number
