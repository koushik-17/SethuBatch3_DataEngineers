...
#print(range(4) | range(5)) # Error, bcz range cant be concatenated
#print([10 , 20]  |  [30 , 20]) # Error, bcz List cant be concatenated
...
print(4 * 3 * 2) # 24
print(3 + 4 * 5 - 32 / 2 ** 3) # (3+20-32/8)= 19.0
...
z = x + y * 6
print(z) # 34
#25 = a # Error, bcz reference should be in left side
#a + b = x + y  # Error
...
print(math . pow(4 , math . pow(3 , 2))) # 4 ^ (3^2) = 4^ 9.0 = 262144.0
...
#print(math . sqrt(3+4j)) # Error, no complex
print(math . sqrt(math . sqrt(256))) # sqrt(16.0)=4.0
print(math . sqrt(math . pow(3 , 4))) # sqrt(3^4) =9.0
#print(math . sqrt(-16)) # Error, bcz no negative 
print(sqrt(49)) # Error
...
#print(fabs(-25)) # error, bcz there is no math fuc
...
#print(floor(3.5)) # error, bcz no math func
#print(ceil(3.5)) # error, bcz no math func
