...
import  re
print(re . subn('[a-z]'  ,  '#'  ,  'a7G9c5D8e')) # ('#','7','G','9','#','5','D','8','#')
print(re  .  subn(' '   ,  ':'  ,   '18 52 46')) # ('18',':','52',':','46')
print(re  .  subn('-'  ,  '/'  ,  '15-Aug-1947')) # ('15','/','Aug','/','1947')
print(re  .  subn('is'  ,  'was'  ,  'Hyd is his city')) # ('Hyd','was','hwas','city')
print(re . subn('a' , 'b' , 'Rama rao')) # ('R','b','m','b',' ','r','b','o') 
...
print(re . split('.'  ,  'www.gmail.com')) # ['w','w','w','.','g','m','a','i','l','.','c','o','m']