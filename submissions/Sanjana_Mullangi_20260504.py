...
class   D(C):
	def   m1(self):
		...
		super(D,self)#How  to  call  method  m1()  of  class  C  in  another  way  without  creating  another  object
		super(C, self)#How  to  call  method  m1()  of  class  B  in  another  way  without  creating  another  object
		super(B, self)#How  to  call  method  m1()  of  class  A  in  another  way  without  creating  another  object
		super(A , self) . m1() 
		super(C) . m1()  #Error-super takes either 0 args or 2 args but not 1arg
		super(D , D) . m1()  #Error-the second argument should be self
# End  of  the  class
d=D()
...
c . color()
c . height()
c . m1()#error-child class does not have m1() method
'''
Child Qualification
Mother  Color
Father  Height'''
...
# End  of  the  class
c = child()
c . m1()#Error-class child doesnot have m1() method


# Identify  Error
class  c1(c1):
	     pass
#Error-parent calss and child class is same
...
class  c2(c1):
	pass
#Error-c2 class is aprent as well as child
