...
#  Find  outputs  (Home  work)
def  f1(b):
	b[2] = 25 # Error tuple cannot be modified because it is immutable object
# End  of  the  function
a = (10 , 20 , 15 , 18)
print(a) # (10 , 20 , 15 , 18)
f1(a)
...
print( lambda   x  :  x * x(7)) # Error because the function defination should be in separate brackets and arguments should be in separate brackets
print( lambda   x  :   x * x) # <class 'function'> and address in hexa decimal
...
print(add()) # Error the add() function requires two arguments
print(add) # <class 'function'> and address in hexadecimal
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) # <class 'function'> at hexa decimal address
...
a  =  lambda  :  'Hyd'
print(a()) # Hyd
print(a) # <class 'function'> and address in hexa decimal
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) # <class 'function'> at address in hexa decimal
print(lambda  x  :  print(x) (s)) # <class 'function'> at address in hexa decimal
...
print(a) # Error because the functions cannot be paced into a list
...
key = 'power_3'
print(a[key]) # <class 'function'> and address in hexa decimal
print(a[key](5)) # 125
...
print(lamb(2)) # 9
print(lamb(5)) # 243
print(lamb) # <class 'function'> and address in hexa decimal
print(lamb()) # Error because one argument is required for the function
...
print(add()) # False
add = lambda  x  :   x = 25  # Error the lambda functions cannot modify the arguments
add = lambda  x  :   x := 25 # Error the lambda functions cannot modify the arguments
