...
print(10 // 3)# prev  integer(3.5)= 3
print(10.0 // 3)# prev  integer(3.25) = 3.0
print(8.5 // 3) #prev  integer(2.833)= 2.0
print(18 // 4)# prev  integer(4.45)= 4
print(-18 // 4)  #  (-4.5)= -5
print(-(18 // 4))  #  (-4)=-4
...
# Find outputs (Home work)
a = b = c = 25
print(id(a))#137745177150920
print(id(b))#137745177150920
print(id(c))#137745177150920
