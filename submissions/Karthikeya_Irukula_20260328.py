...
# End  of  the  function
a = [10 , 20 , 15 , 18]
print(a) #[10 , 20 , 15 , 18] 1st o/p
change(a)#[10 , 20 , 15 , 18 , 25]
print(a)#[10 , 17 , 18 , 25] 2nd o/p'''
...
def  change(b):
	b  = [50 , 60 , 70 , 80]
	print(b) #[50 , 60 , 70 , 80] 2nd o/p
# End  of  the  function
a = [10 , 20 , 30 , 40]
print(a) #[10 , 20 , 30 , 40] 1st o/p
change(a)
print(a) #[10 , 20 , 30 , 40] 3rd o/p '''
...
print( lambda   x  :  x * x(7))#<function <lambda> at address>
print( lambda   x  :   x * x)#<function <lambda> at address>
...
print(add(10 , '20')) # '20' string cannot add to integer
#print(add())
#print(add) #Error () missing'''
...
a  =  lambda  :  'Hyd'
print(a()) #Hyd
print(a) #<function <lambda> at address of a>'''
...
'''
s = 'Hyd'
print(lambda  s  :  print(s)) #<function <lambda> at address of s>
print(lambda  x  :  print(x) (s)) # <function <lambda> at address of s>
...
key = 'power_3'
print(a[key]) #<function <lambda> at address of a>
print(a[key](5)) #125'''
...
print(lamb(2)) # 9
print(lamb(5)) # 243
print(lamb) #<function f1.<locals>.<lambda> at address of lamb>
#print(lamb()) 
'''
...
print(add()) #False
add = lambda  x  :   x = 25 #Error due to = after the :
#add = lambda  x  :   x := 25 # Error due to :='''
