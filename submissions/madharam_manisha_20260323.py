...
#print(add(10 , '20'))#error int and str is there
#============================================================================================================================
# Find  outputs (Home  work)
def  f1():
...
#f1(40 , 50)  # Error required  argument: 'z'
#f1(60)  # Error required  arguments: 'y' and 'z'
#f1()# Error required  arguments: 'x', 'y', and 'z'
#============================================================================================================================
'''
...
a = [10 , 20 , 15 , 5 , 12]
#print(sorted(reverse = True , a)) # positional argument (a) should be before keyword arguments
#print(sorted(a , rev = True)) # rev keyword not their in sorted function
#print(25 , 10.8 , 'Hyd' , separator = '\t') # not separator keyword only sep 
#print(25 , 10.8 , 'Hyd' , endofline = '\t') # not endofline keyword only end
#print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') # positional argument (a) should be before keyword arguments	
