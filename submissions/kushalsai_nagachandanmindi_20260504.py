...
# Reason is that, this program has many invalid references inside class bodies, and _init_/_del_ are not real special methods.
...
child().m1()
print('Bye')
# Error as type object 'child' has no attribute '_mro_'
