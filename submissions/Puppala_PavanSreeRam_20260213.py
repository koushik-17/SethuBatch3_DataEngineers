...
a[4] = 32 = Objects Are Immutable
print(a * 2) = Error = Duplicate Elements Are Not Allowed 
...
f = range(2 , 2)
print(*f) = Empty Range 
g = range(10 , 11 , 0.1) = Error = range ( ) does not accept float
h = range('A' , 'F') = Error = String Can’t Be An Integer
...
print(a * 0) = []
print(a * -1) = []
print(a * 4.0) = Error = Only Integers Are Allowed 
a = a * 3
print(a) = Error
print(id(a)) = Address Of The Object a 
a = [25]
...
print(list(25)) = Error = Integers Are Not Iterable
