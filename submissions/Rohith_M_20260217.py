...
print(set(25)) # Error No  becoz  argument  should  be  sequence  only
print(set([25 , 10.8 , [] , 'Hyd'])) #Error No  becoz  argument  should  be  sequence  only
...
a . append(100) #Error  because the append is doesn't exist in set medhods
a . add(set()) 
a . add(())
a . add([])
print(a) # {10.8,"Hyd",True,None,()}
