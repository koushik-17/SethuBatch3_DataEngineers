...
print(sum(a)) # 90
print(sum(a . items())) # Error, because it returns dict_items , which has tuple
...
print(dict(h)) # Error, because keys must be immutable
...
print("Sorted Dictionary : ",b)

'''
Output :
Sorted Dictionary :  {5: 'D', 10: 'A', 12: 'E', 15: 'C', 20: 'B'}
'''
...
del  a
print(a) # Error, it can not print deleted object

# copy()  method demo  program  (Home  work)
a = {'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue'}
b = a . copy()
print(b) # {'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue'}
print(a  is  b) # False, because b and a pointing two different dictionarie
print(a  ==  b) # True , because the a and b dictionaries have same elements
