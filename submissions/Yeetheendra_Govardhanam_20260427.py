#1 sub() function demo program (Home work)
import re
...
#2 subn() function demo program (Home work)
import re
...
#3 split() function demo program (Home work)
import re
...
# Reason: dot in regex means "any character", so it splits at every character.