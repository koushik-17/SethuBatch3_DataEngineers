...
def   f2 (fun):
	print('f2  function')
	fun() # error , f1 function returns None, which cannot be called
	print('Back  to  f2  function')
# end of the function
print('Begin')
f2(f1())
...
fun()
print('Bye')
inner() # error , inner function is only visible to outer function so it cannot be called outside the function directly
'''
Outer Function
Hello
Inner Function
...
print(div(10 , 3))
print(div(10 , 0))
print(inner(10 , 3)) # error , inner function is only visible to outer function so it cannot be called outside the function directly
'''
3.33333333333333
