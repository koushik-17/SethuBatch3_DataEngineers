...
print(tuple(25)) # Error the tuple function can only have sequence as argument
...
a = a * 2  #  Valid / Invalid --- Valid because repetation is allowed in tuple and new tuple object is created
