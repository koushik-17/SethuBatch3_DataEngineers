...
def  disp(m):
	while   True:
		try:
			print(next(m)) # India<nextline>China<nextline>USA<nextline>UK # 150.5<nextline>200.2<nextline>300.3<nextline>210.4
			time . sleep(1)
		except  StopIteration:
			break
#  End  of  the  function
...
# 20
# Element :  0
# Output of print(*c4) is infinite; it will not finish because count() never ends
