...
print(int(3 + 4j))  #error because int cannot accept complex number
print(int('25.4'))  #error because string float cannot be converted into integer
print(int('Ten'))   #error because string Ten cannot be converted into integer
...
print(float(3 + 4j))  # ERROR because complex cannot be convert to float
print(float('Ten'))   # error because string Ten cannot be converted into integer
...
print(complex('3'))  # 3+0j
print(complex('3.8'))  # 3.8+0j
print(complex(3 , '4')) #  error because when 2nd argument is not permitted when 1st argument is string
print(complex('3' , 4))  # error because when 2nd argument is not permitted when 1st argument is string
print(complex('3' , '4')) # error because when 2nd argument is not permitted when 1st argument is string
print(complex('Ten')) # error because string Ten cannot be converted into complex
