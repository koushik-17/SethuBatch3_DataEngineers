...
print(int('Ten'))   #Error string with characters like letters cannot be converted to int
...
print(complex('3')) #3+0j
print(complex('3.8')) #3.8+0j
print(complex(3 , '4'))  #Error second operand cannot be string 
print(complex('3' , 4)) #Error if 1st operator is strong then 2nd operator is not permitted 
print(complex('3' , '4'))#Error if 1st operator is strong then 2nd operator is not permitted  
...
print(oct(195))  #0O303 octal equivalent of decimal number 
print(oct(0B10101110010))  #0O2562 octal equivalent of a binary number 
print(oct(0xA7B9)) #0O123671 octal equivalent of a hexadecimal number

# hex()  function  demo program
print(hex(25))  #hexadecimal equivalent of decimal number 25
print(hex(0B10101111010111)) hexadecimal equivalent of binary number 
print(hex(0O6247)) hexadecimal equivalent of octal number
