...
print(int(3 + 4j))  #error because it should be string to change into integer    
print(int('25.4'))  #25  
print(int('Ten'))   #invalid because we should consider numericals not words in string   
...
print(float(3 + 4j))     #error beacause complex numbers not valid for typecasting
print(float('Ten'))      #error could not convert string to float #'Ten'
...
print(complex('3'))             #3+0j
print(complex('3.8'))           #3.8+0j
print(complex(3 , '4'))         #error second argument can't be a string
print(complex('3' , 4))         #error can't take second arg if first is a string
print(complex('3' , '4'))       #error can't take second arg if first is a string
print(complex('Ten'))           #invalid 
