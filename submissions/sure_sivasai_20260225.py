...
# 2. (Home  work) Write  a  program  to  determine  area  and  perimeter  of  rectangle
'''
...
# 3. (Home  work) Write  a  program  to  determine  volume  of  a  sphere
'''
...
# 4.  (Home  work) Write  a  program  to  determine  simple  interest  and  compound  interest
'''
...
# 5.   (Home  work) Write  a  program  to  swap  values  of  two   objects   using  3rd  object
'''
Let  x = 10  and  y = Hyd
...
# 6. (Home  work) Write  a  program  to  swap  values  of  two  objects  without  using  3rd  object
'''
...
# 7. (Home  work) Write  a  program  to  swap  values  of  two  objects  without  using  3rd  object
'''
...
#9. Identify  error
if  9 > 5
	print('Hello') # Error have to kept colon after condition
print('Bye')
...
if  9 > 12:
	...
	print('Sec')  # the cond1 is False so it comes to else but else does not have any colon it gives Error
