...
while True:
    ...
    if disc > 0:
        ...
        print("Roots 1 : %.1f + %.1fj" % (real, imag))
        print("Roots 2: %.1f - %.1fj" % (real, imag))
...
#Error because No case matches because m = 4
...
#SyntaxError: multiple wildcard patterns
