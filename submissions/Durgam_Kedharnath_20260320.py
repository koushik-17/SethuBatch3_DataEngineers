...
print(sum(a)) # 90
print(sum(a . items())) # Error sum function cannot performs on items
...
print(dict(e)) # Error there should be two elements to convert into dict
f = [[10] , [20] , [30]]
print(dict(f)) # Error ther should be tuple of two elements and an single element
print(dict([10 , 20]))
...
b=sorted(a.items())
c=dict(b)
print(c) # {5: 'D', 10: 'A', 12: 'E', 15: 'C', 20: 'B'}
...
print(a) # {}
del  a
print(a) # Error a sould not be defined
