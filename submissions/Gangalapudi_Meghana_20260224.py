...
x = 25
y = 'Hyd'
x, y = y, x              # Swapping in single statement
print("After swap :")    # After swap :
print("x =", x)          # x = Hyd
print("y =", y)          # y = 25
...
largest = a if a > b and a > c else (b if b > c else c)  # Nested ternary operator
print("Largest  Input  :  ", largest)
...
a = eval(input("Enter 1st input :  "))
b = eval(input("Enter 2nd input :  "))
result = ">" if a > b else ("<" if a < b else "=")  # Nested ternary operator
print(result)
...
result = 1 if n > 0 else (-1 if n < 0 else 0)    # Nested ternary operator
print(result)
...
result = "Even Number" if n % 2 == 0 else "Odd Number"        # Ternary operator
print(result)
