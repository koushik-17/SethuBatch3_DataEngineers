...
print(id(a))    #address of the object range(10,50,5)
print(len(a))   #8
...
a , b , c = *r      #error
m = r               
print(id(r))        #address of the object  
print(id(m))        #address of the object 
...
print(id(a))      #address of the object
a = [25]
print(a , id(a))  #25, #address of the object
print(a * a)      #error
...
print(list[ : : ])    #list[0:8:1]----> list from indexes 0 to 7 in steps of 1 i.e.[25,10.8,'Hyd',True,None,10.8,'Hyd']
print(list[:])        #list[0:8:1]----> list from indexes 0 to 7 in steps of 1 i.e.[25,10.8,'Hyd',true,None,10.8,'Hyd']                                                              
