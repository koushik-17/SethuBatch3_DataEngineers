...
f1(70 , 80 , c = 90) # Error as b cannot be pa
f1(70 , 80 , 90) # Error b,c should be a keyword argument
f1(c = 15 , b = 25 , 35)# Error positional argument doesn't be after keyword argument


# Identify error (Home  work)
def   f1(a  , b , *):# Error as their should be atleast one argunment after *
        pass
...
# End  of   the  function
f1(10 , 20)# a:10	b:20
f1(a = 30 ,  b = 40)# Error as they are Positional  only  arguments 
f1(50 , b = 60)#Error
f1(a = 70 , 80)#Error
...
f1(a = 70 , b = 80 , c = 90)
f1(a = 100 , b = 110 , 120)#Error coz positional argument is after keyword argument
f1(a = 130 , 140 , c = 150)#Error coz positional argument is after keyword argument
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c): # error as before argunment '/' atleast one argunment should be
        pass
def   f2(a , b , c , *):error as after argunment '/' atleast one argunment should be
        pass

# Identify  error  (Home  work)
def  f4(* , a , b , c , /): #error as pa should be before ka
	        pass
...
# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d): #error as non default should be before default
	pass
...
print(add(c = 100 , d = 200 , 300 , 400))#error pa should be before ka
...
disp(40 , 50 , 60 , 70)#error as more argunments
...
print(add(c = 25 , a = 43))# error as b is missing
print(add(1 , 2 , 3))#error as arguments should be ka
...
f1(50 , 60)#a:50    b:(60,)
f1(70)#a:70 b:tuple()
f1(a = 80)#a:80 b:tuple()
f1(b = (10 , 20 , 30) , a = 40)
f1()#a:25   b:tuple()
f1(a = 10 , (20 , 30 , 40))#error as (20 , 30 , 40) before ka
f1(25 , b = (10 , 20 , 30))
f1(25 , a = (10 , 20 , 30))
f1((10 , 20 , 30) , 10 , 20 , 30)#a:(10, 20, 30)  	   b:(10, 20, 30) 
f1(a = (10 , 20 , 30) , 10 , 20 , 30)#error 10,20,30 should be before ka
...
f1(eno = 25 , empname = 'Sita' , salary = 10000.0) #error as empno not eno 
