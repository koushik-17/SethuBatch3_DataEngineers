...
#print(int('Ten'))  # error only convert numbers not letters
...
#print(float('Ten')) # error only convert numbers not letters
...
print(complex('3')) # (3+0j)
print(complex('3.8')) #(3.8+0j)
#print(complex(3 , '4')) # error imag will not be string 
#print(complex('3' , 4)) # error imag not permit
#print(complex('3' , '4')) #error both are string
#print(complex('Ten')) # error only numbers not letters
