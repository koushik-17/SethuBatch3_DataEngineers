...
def   words(s):
	...
	for  x  in  s:
		yield  x
# End of generator
s = input('Enter  any   string  :  ').split()#   M.G.Story
g = words(s) #  Gen  object
print('Words  of  the  string')
for  y  in   g:
	print(y)  #  Hyd , is , green , city
...
class   c2:
        pass
class   c3:# class should contain atleast one method or a pass statement
###############################################################################
 # Find  outputs  (Home  work)
class   c1:
	pass
# End  of  the  class
a = c1()
print(id(a))#addresss of class c1
