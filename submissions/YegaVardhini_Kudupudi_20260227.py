...
match  units // 100:
	...
	case  _:				
				cost = 100*3.00+(units-100) *3.50+(units-200) 4.00+( units -400) +( units - 700) *5.00
...
for  x  in  range(10 , 10):
	print(x)  # 
for  x  in   range():
	print(x) # any arg should be given
for  x  in   (25):
	print(x) #Error
...
if(10 , 20 , 30):
	print('Hyd')
	break# it is only for for and while loops not for if stmt
	print('Sec')