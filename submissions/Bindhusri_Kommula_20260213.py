...
a[4]=32                  # immutable, we cannot modify
print(a*2)               # error, because it does not allow duplicates 
...
b=range(5)             # 0 1 2 3 4
print(*b)              # 0 1 2 3 4
c=range(10,1,-1)       # 10 9 8 7 6 5 4 3 2
...
f=range(2,2)           # 
print(*f)              # No elements 
g=range(10,11,0.1)     # error because range accept only integers, it does not allow float as step
h=range('A','F')       # error because range accept only integers
...
a = [25 , 10.8 , 'Hyd']
print(a)         # [25 , 10.8 , 'Hyd']
print(id(a))     # Address of list object a(like 2000)
...
a[2: 4] = [100 , 200 ,  300]
print(a , id(a)) # [10,60,100,200,300] Address of list object a 



a =  [25]
print(a[1])  # error index of range
print(a[1:]) # empty
