...
i = not  i > 14 # False
print(i)  # True
print(not(6 < 4  or  9 >= 5  and  6 != 6)) # (not False) --> True
...
# Find outputs (Home work)
a = b = c = 25
print(id(a)) # address of the 25 object
...
print('Two'); # Two
print('Three'); # Three
print('Hyd')  ;   print('Sec')  ;  print('Cyb') # Hyd /n Sec /n Cyd


#pow()  function  demo  program
import  math
print(math . pow(2 , 3))  #  2 ^ 3 = 8
print(math . pow(-2 , -3)) # -0.5 ** 3 --> 
...
print(math . sqrt(math . pow(3 , 4))) # 81 --> 9.0
