...
'''
a = 'Rama Rao'
print(a [ : 7 : 2]) # Rm a   --->  string  from  indexes  0  to  6  in  steps  of  2  
print(a [ : 7])     # Rama Ra   --->  string  from  indexes  0  to  6  in  steps  of  0
print(a [2 : 4])    # ma     --->  string  from  indexes  2  to  3  in  steps  of  0
print(a [2 : ])     # ma Rao  --->  string  from  indexes  2  to  end
print(a [ : 4 ])    # Rama  --->  string  from  indexes  0  to  3
print(a [ : : 2])   #  a[0 : 8 : 2]   --->  string  from  indexes  0  to  7  in  steps  of  2  i.e. Rm<space>a
print(a [-6 : -1])  # ma Ra --->  string  from  indexes  2  to  end
print(a [-6 : ])    # ma Rao --->  string  from  indexes  2  to  end
print(a [: -4 : -1])   # oaR  --->  string  from  indexes  -1  to  -3
print(a [-3 : -1])  # Ra   --->  string  from  indexes  -3  to  -2
print(a [-3 : ])    # Rao  --->  string  from  indexes  -3  to  end
print(a [ : : ])    # Rama Rao  --->  entire string
print(a [ : ])      # Rama Rao  --->  Entire string
print(a [ : : -1])  # oaR amaR  --->  string in reverse
print(a [ : : -2])  #  a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
print(a [ -2 : : -2]) # a mR   --->  string  from  indexes  -2  to  end in steps of -2
print(a [2 : 8])       # ma Rao  --->  string  from  indexes  2  to  7
print(a [2 : 8 : -1])   # Empty string ----> the step is negative, the start index must be greater than the stop index
print(a [ : -6 : -1])   # oaR a  --->  Start from the end of the list, move backwards with step -1, and stop before index -6
print(a [2 : -3])       # ma     --->  Start at index 2 and go forward up to (but not including) index -3
print(a [1 : 6 : 2])    # aaR    --->  Start at index 1, move forward in steps of 2, and stop before index 6
print(a [ : -5 : -5])   # o      --->  Start from the end of the list, move backwards with step -5, and stop before index -5
print(a [2 : -5])       # m      --->  Start at index -1, move backwards by 2, and stop before index -8
print(a [2 : -5 : 2])   # m      --->  string  from  indexes  2  to  -4 in steps of 2
print(a [ : 0 : -1])    # oaR ama --->  string  from  indexes  end  to  0 in steps of -1
print(a [-5 : 0 : -2])  # aa     --->  string  from  indexes  -5  to  0 in steps of -2
