...
print(a + 5) # ERROR because list can't be concatenated with non-sequence
print(a + '5') # ERROR because list can't be concatenated with str
print([10 , 20] + (30 , 40)) # ERROR because list can't be concatenated with tuple

# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) #[1, 2, 3], address of list object a
a += b
print(a , id(a)) # [1, 2, 3, 4, 5, 6], address of same list object
...
print(a , id(a)) #[1, 2, 3], address of list object a
a  = a + b
print(a , id(a)) # [1, 2, 3, 4, 5, 6], address of new list object
...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # ERROR because left side we have 5 references but in right we have 4 which can't be assigned
a , b , *c , d , e = list 
print('a : ' , a) # a :  25
print('b : ' , b) # b :  10.8
print('c : ' , c) # c :  []
print('d : ' , d) # d :  Hyd
print('e : ' , e) # e :  True
a , b , *c , d , e , f = list # ERROR because not enough values to unpack
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # ERROR because only single * operator used in unpacking.
...
print(sum(d)) # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # ERROR because str can't be added
'''
...
#  Find  outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a)) # ERROR because list and int can't be added
print(a[0])#How  to  determine  sum  of  inner  list  elements
print(sum(sum(a, []))) # How  to  determine  sum  of  inner  list  elements  in  another  way)
...
print(min(b)) # Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c)) # ERROR because different types of non sequences can't be compared
d = [25 , '35']
print(max(d)) # ERROR because different types of sequences can't be compared
print(max([])) # ERROR because in max() arg needed
print(min([])) # ERROR because in max() arg needed
'''
...
a = list()
print(a) # []
print(list(25)) # ERROR int object can't be used with sequence
print(list(10.8)) # ERROR float object can't be used with sequence
print(list(True)) # ERROR bool object can't be used with sequence
print(list(None)) # ERROR NoneType object can't be used with sequence
'''
list()  function
-----------------
...
del    a[2]
print(a) # [10, 20, 18]
del  a[3] # ERROR because index 3 doesn't exist
del  a 
print(a) # Empty []
...
print(a . pop(2)) # 15
print(a) # [10, 20, 18, 12]
print(a . pop(len(a))) # ERROR because index doesn't exist
print(a . pop(-3)) # 20
print(a) # [10, 18, 12]
print(a . pop(-4)) # ERROR because index doesn't exist
print(a . pop()) # 12
print(a) # [10, 18]
b = []
b . pop() # ERROR because it need atleast one element in list
'''
pop()   method
------------------
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # ERROR because different non-sequences can't be sorted
