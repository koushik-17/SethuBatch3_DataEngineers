...
def  f1(b):
	b[2] = 25 # TypeError:'tuple' does not support item assingeent
# End  of  the  function
a = (10 , 20 , 15 , 18)
print(a)
f1(a)
...
print( lambda   x  :  x * x(7)) # <function <lambda> at 0x000001F597D03E20>
print( lambda   x  :   x * x) # <function <lambda> at 0x000001F597D03E20>
...
print(add(10 , 20)) # 30
print(add(10.6 , 20.8)) # 31.14
print(add('Hyder' , 'abad'))#Hyderabad
print(add(True , False)) # 1
print(add(25 , 10.8)) # 35.8
print(add(3 + 4j , 5 + 6j)) # (8+10j)
#print(add(10 , '20')) # TypeError
#print(add()) # TypeError: <lambda>() missing 2 required positional arguments: 'a' and 'b'
print(add) # <function <lambda> at 0x000001C654B03E20>
...
print((lambda  x , y : x + y) (10.8 , 20.6)) # 31.40
print((lambda  x , y : x + y) ('Hyder' , 'abad')) #Hyderabad
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) # <function <lambda> at 0x000001B4293CA170>
...
a  =  lambda  :  'Hyd'
print(a()) # Hyd
print(a) # <function <lambda> at 0x0000026B75E63E20>
...
(lambda  x  :  print(x)) (s)
'''
<function <lambda> at 0x000002659DB13E20>
<function <lambda> at 0x000002659DB13E20>
Hyd
None
Hyd
...
Hyd
Sec
[<function <lambda> at 0x0000018CCFCEA200>, <function <lambda> at 0x0000018CCFCEA290>]
'''
...
key = 'power_3'
print(a[key]) # <function <lambda> at 0x000002195497A200>
print(a[key](5)) # 125
...
print(lamb(2)) # 9
print(lamb(5)) # 243
print(lamb) # <function f1.<locals>.<lambda> at 0x0000021DA3A5A200>
...
print(add()) # False
#add = lambda  x  :   x = 25 # SyntaxError: cannot assign to lambda
