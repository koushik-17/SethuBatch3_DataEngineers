...
print(a[1])	# How  to  print  2nd   inner  list)
print(a[2])	# How  to  print  3rd   inner  list)
print(len(a[0])) # 2	# How  to  print  number  of  elements  in  1st  inner  list)
print(len(a[1])) # 3 	# How  to  print  number  of  elements  in  2nd  inner  list)
print(len(a[2])) # 4	# How  to  print  number  of  elements  in  3rd  inner  list)
...
print()
for  x , y  in  a:
	print(x , y , sep = '...') 	 # [10...20] [30...4] [50...60] [70...80]
...
a = eval(input('Enter list of lower case strings : ').upper())
b = []
...
b = int(input('How many elements in a list : '))
c = []
...
a = eval(input('Enter 1st list : '))    # [10 , 20 , 15 , 18 , 25 , 32]
b = eval(input('Enter 2nd list : '))    # [30 , 40 , 10 , 25 , 15]
c = []

for i in a:
    if i not in b:
        c.append(i)
print('Elements of 1st list which are not in 2nd list : ',c)    # Elements of 1st list which are not in 2nd list :  [20, 18, 32]
...
print('squares of 1 to 20 which are divisibel by 2 : ',a)
...
print('squares of 1 to 20 which are divisibel by 2 : ',a)
                        # squares of 1 to 20 which are divisibel by 2 :  [4, 16, 36, 64, 100, 144, 196, 256, 324, 400]
...
b = eval(input('Enter 2nd list : '))    # [30 , 40 , 35 , 32]
c = []
