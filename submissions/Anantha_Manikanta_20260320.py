...
print(sum(a))  # 90
print(sum(a . items()))  #  Error because they are tuples
'''
...
print(dict(e))  # Inner list should have 2 elements but it has 3 elements
f = [[10] , [20] , [30]]
print(dict(f))  # Inner list should have 2 elements but it has 1 element
print(dict([10 , 20]))  # Error
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g))  # {10: [20, 30], 40: [50, 60], 70: [80, 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h))  # Error because jeys cannot be lists
...
print(a)  # {}
del  a
print(a)  # Error because 'a' is not defined the 'a' which we created is deleted
'''
...
for  x  in   b:
        print(x)  # 10 <next line> 20 <next line> 50 <next line> 18
'''
...
a . update(b)  # Error because list dont have update method
'''
...
b = {}
b.update(a)
print(b)  # Error because update method has 3 elements only 2 should be there
c = [(10,) , (20,) , (30,)]
b . update(c)
print(b)  # Error because only 1 element is in the update method
'''
