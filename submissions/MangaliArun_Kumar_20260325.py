...
def  prime_divisors(n):
	...
	for i in range(1,n+1):
		if n%i == 0 and prime_divisors(i):
			i.append(lst)
	return lst
n = int(input())
a = prime_divisors(n)
print("Prime divisors : ",a)
print("Number of prime divisors : ",len(a))
...
f1(70 , 80 , 90)
f1(c = 15 , b = 25 , 35)
[11:35, 25/03/2026] +91 99482 50500: # Identify error (Home  work)
def   f1(a  , b , *):
        pass
[11:40, 25/03/2026] +91 99482 50500: #  Positional  only  arguments  demo  program
def   f1(a , b , /):
        print(F'a  :  {a}  \t  b  :  {b}')
# End  of   the  function
f1(10 , 20)
...
f1(50 , b = 60)
f1(a = 70 , 80)
[11:40, 25/03/2026] +91 99482 50500: # Find  outputs (Home  work)
def  f1(a , b , / , c):
        print(F'a  :  {a}  \t  b :  {b}  \t  c  :  {c} ')
# End  of  function
f1(10 , 20 , 30)
...
[11:40, 25/03/2026] +91 99482 50500: # Identify error (Home  work)
def  f1(/ , a , b ,  c):
        pass
def   f2(a , b , c , *):
        pass
...
def  f4(* , a , b , c , /):
	        pass
[11:43, 25/03/2026] +91 99482 50500: # Find  outputs  (Home  work)
def  f1(x):
...
f1(y = 20)
f1(x = 30)
[11:46, 25/03/2026] +91 99482 50500: # Default  arguments  demo  program
def   add(a , b = 20 , c = 30):
        return   a + b + c
#end  of  the  functiom
print(add(100))   #  150
...
print(add(100 ,  , 300))
print(add(100 ,  b , 300))
[11:56, 25/03/2026] +91 99482 50500: # Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass
def   f2(b , d , a = 10 , c = 20):
	pass
[11:56, 25/03/2026] +91 99482 50500: #  Find  outputs (Home  work)
def   f1(a = 10):
        print(a)
# End  of  the  function
f1(20)
f1()
f1(a = 30)
[11:57, 25/03/2026] +91 99482 50500: # Find  outputs (Home  work)
...
def   add(a , b = 10 ,  c ,  * , d  , e = 20 , f):
		pass
[12:04, 25/03/2026] +91 99482 50500: # Find  output (Home  work)
def   f1(a = []):
        pass
print(f1 . _defaults_)
[12:31, 25/03/2026] +91 99482 50500: # Find  outputs (Home  work)
def   f1(x , a = []):
	a . append(x)
	print('List :  ' ,  a)
#end  of  the  function
...
print(f1(6))
print('_defaults  :  ' , f1._defaults_)
[12:31, 25/03/2026] +91 99482 50500: # Find  outputs
def   f1(a = 'Hyd' , b = []):
	a += "Sec"
	b += [1 , 2 , 3]
	print('a :  ' , a)
...
print('Default Values  :  ' , f1 . _defaults_)
f1()
[12:36, 25/03/2026] +91 99482 50500: #  Variable  number  of  arguments  demo  program
def   f1(*t):
	print(t)
	print(type(t))
	print(len(t))
...
f1(tpl)
f1(t = (10 , 20 , 30)) #   Error
[12:46, 25/03/2026] +91 99482 50500: #  Write  a  function  to  determine  average  of  arguments  passed  to  the  function (Home  work)
def  avg(*a):
...
tpl = (10 , 20 , 15 , 18)
print(avg(tpl))
[12:47, 25/03/2026] +91 99482 50500: # Write  a  function  to  concatenate  strings  passed  to  the  function ? (Home  work)
def  concat(*a):
...
print(concat('Python'))
print(concat(1, 2, 3))
[12:47, 25/03/2026] +91 99482 50500: #Find  outputs (Home  work)
def   f1(a = 25  , *b):
        print(F'a : {a}  \t   b  :  {b} ')
# End  of  the  function
f1(10 , 20 , 30 , 40)
...
[12:47, 25/03/2026] +91 99482 50500: # Which  of  the  following  are  valid  ?  (Home  work)
def   f1(*a , *b):
        pass
def  f2(*a , b):
        pass
...
def   f7(a , *b , c ,  /):
       pass
[12:51, 25/03/2026] +91 99482 50500: # Find  outputs  (Home  work)
def   f1(*a):
	print(a)
	print(type(a))
	for  x  in  a:
...
[12:53, 25/03/2026] +91 99482 50500: # Variable  number  of  keyword  arguments  demo  program
def   disp(**a):
	print('Results')
	print(type(a))
	print(a)
...
f1()
[13:01, 25/03/2026] +91 99482 50500: # Find  outputs (Home  work)
def   f1(*a):
	print(type(a))
	print(a)
def   f2(**a):
