...
print(id(a)) # address of object 
a = [25] 
print(a , id(a)) # 25 and address of object 
print(a * a) # Error 
...
print(list[-2 : : -2])  #   list[-2 : -9 : -2]   --->  List  from  indexes  -2  to  -8  in steps  of  -2  i.e.   [10.8 , 
True , 3+4j , 25] 
...
print('y : ' , y) # ‘True’ 
for  x  in  list[2:7]:  
print(x) # 3+4j <another line> ‘Hyd’< another line>True< another line> None <line> 10.8 
#  Find  outputs  (Home  work) 
#    
 0    
 1    
...
3     4 
a = [10 , 20 , 30 , 40 , 50] 
print(a , id(a)) [10 , 20 , 30 , 40 , 50] and address of object 
a[1 : 4] = [60 , 70]  # [10, 60, 70, 50] 
print(a , id(a)) # # [10, 60, 70, 50] and address of object 
a[2: 4] = [100 , 200 ,  300] #[ 10, 100,200,300,50] 
print(a , id(a)) #[ 10,60, 100,200,300] and address of object 
#  Find  outputs  (Home  work) 
a =  [25] 
print(a[1])# Error 
print(a[1:]) # Empty              