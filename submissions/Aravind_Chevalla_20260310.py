...
a += b
print(a , id(a)) [1,2,3,4,5,6] #same address of a
...
a = [[10 , 20 , 15 , 18]]
print(sum(a))  #Error
 #sum(a[0] #print(How  to  determine  sum  of  inner  list  elements)
...
print(a)#['Vamsi', 'Sita', 'Rama  Rao', 'Rama', 'Rajesh', 'Kiran', 'Amar']
 ...
 # Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() #Str and int cant be sorted
