...
print(range(4) | range(5)) # error not possible 
print([10 , 20]  |  [30 , 20]) # can't use for list
...
print(-18 // 4)  #  Tricky prev  integer(-4.5) = - 5 (one step back) - 4 - 1 = -5
print(-(18 // 4))  #  Tricky prev integer(-4.5) = - 4

#Topic-3
# Find outputs
print(7 / 0) # error division with zero 
print(7 // 0) # error division with zero
print(7 % 0) # error division with zero
...
print(10 == 10.0)# True
print(3 + 4j >  3 + 4j) #  error we can't use > in complex numbers 
...
print(not  '')# True
print(not  -10)#  False
print(not  not  'Hyd') # first not is executed True
...
a = 25
b = 25.0
print(a is b) #  False (checks by address) 
...
print('' in s)# True (it is string or not) 
...
print(math . pow(4 , math . pow(3 , 2))) #4^9 = 256*256*4 = 262144
...
#print(math . sqrt(3+4j)) # error complex number 
print(math . sqrt(math . sqrt(256))) #4.0
print(math . sqrt(math . pow(3 , 4))) #9.0
#print(math . sqrt(-16))# error negative number not allowed 
#print(sqrt(49)) #error no function in this module 
...
print(fabs(-25)) #error no function in this module
...
print(floor(3.5)) #error no function in this module
print(ceil(3.5)) #error no function in this module
