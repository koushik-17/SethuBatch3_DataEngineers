...
def   f2 (fun):
	print('f2  function') # f2 function
	# fun() # Error the None Type is not callable
	print('Back  to  f2  function') # Back  to  f2  function
# end of the function
print('Begin') # Begin
f2(f1())
...
fun()
print('Bye') # Bye
# inner() # Error inner function is not declared outside the outer function
...
print(inner(10 , 3)) # Error because inner function is not defined
