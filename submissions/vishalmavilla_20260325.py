...
def   f1(a  , b , *):
        pass   # error as there is * after  the arguments
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c):    # error as there / before the arguments
        pass   
def   f2(a , b , c , *):    # error as there * after the arguments
        pass



# Identify  error  (Home  work)
def  f4(* , a , b , c , /):   # error / must be 1st and then *
	        pass
...
# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d):  # error  becoz non-deafault argument  should  not be after default arguments
	pass
...
print(add(c = 100 , d = 200 , 300 , 400))    #  error as positional arguments should be at beginning
print(add(100 , 200 , c = 300 , x = 400))   #  error x is not defined
print(add())  # error no 2 other arguments are given
...
print(power(True))    # 1
def   power(b = 2 , a):   # error non-default parameters should be at beginning
 	 pass
...
disp(40 , 50 , 60 , 70)   # error as there are more positional arguments than defined
...
print(add(1 , 2 , 3))   # error becoz only keyword arguments are allowed  
...
def   f1(a = []):
        pass
print(f1 . _defaults_)   # error it should __defaults__ not _default_
...
print(f1(3))   #  [4]
print('_defaults  :  ' , f1._defaults_)
print(f1(4 , [10 , 20 , 15 , 18]))   [10,20,15,18,9]
print('_defaults  :  ' , f1._defaults_)
print(f1(5))    # [4,16]
print('_defaults  :  ' , f1._defaults_)
print(f1(a = [100 , 200 , 300],   x = 6 ))  #  [100,200,300,25]
print('_defaults  :  ' , f1._defaults_)
print(f1(6))   #  [4,16,25]
print('_defaults  :  ' , f1._defaults_)
