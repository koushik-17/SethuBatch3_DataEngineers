...
1) sod(9427) =
'''
n = int(input('Enter  any  number :  9427 '))
print('Sum of the digits :   ' , 22)
...
3) How  to  obtain  length  of a  number ?  ---> len(str(number)) # 3
'''
from math import *
def  rev(n):
	if  == 0
		...
		return last_digit * (10**(length - 1)) + rev(n//10)
'''
rev(946)  =
'''
n = int(input('Enter  any  number :  '))
print('Reverse   Number :  ' , rev(n)) # 649