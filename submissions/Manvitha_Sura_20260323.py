...
'''
1) prime(25)  --->  
    How  many  times  is  for  loop  executed ?  --->  11(2 , 3 , 4 , 5 , 6 , .....  12)

2) prime(11) --->  
    How  many  times  is  for  loop  executed ?  ---> 4(2 , 3 , 4 , 5) 

3) prime(2) ---> 
    How  many  times  is  for  loop  executed ?  ---> 1

4) prime(49) ---> 
    How  many  times  is  for  loop  executed ?  --->  24
'''
...
if  n == 0:
    ...
    if crores!=0:
        print(words(crores,'Crores'),end=' ')
    if lakhs!=0:
        print(words(lakhs,'Lakhs'),end=' ')
    if thousand!=0:
        print(words(thousand,'Thousand'),end=' ')	
    if hundred!=0:
        print(words(hundred,'Hundred'),end=' ')	
    if n%100!=0:
        print(words(n%100,''))
...
f1(True , None , b = 'Hyd')#error-missing argument for c
f1(10 , 20 , x = 30)  #error
f1(10 , 20)  #error-need 3 arguments
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))  #pa after ka is not permitted
print(sorted(a , rev = True))  #argument name is reverse but not rev
print(25 , 10.8 , 'Hyd' , separator = '\t')  #argument name is sep,not seperator
print(25 , 10.8 , 'Hyd' , endofline = '\t')  #argument name is end,not endofline
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')  #end and sep must be written at last and there cannot be positional arguments after keyword arguments
