...
match  m:
	...
	case  _:  
		print('Bye')
print('End') # Hello <next line> Bye <next line> End
...
2) What  are  the  outputs  if  input  is  15  ?  ---> Hyd Sec Cyb Bye
...
2) What  is  the  output  when  input  is  (10 , 0) ?  ---> y - axis
...
match  units:
	case  100:      cost = 100 * 3.00
	case  100:      cost = 100 * 3.50
	case  200:      cost = 200 * 4.00
	case  300:      cost = 300 * 4.50
	case  700:	cost = 500 * 5.00
        case_:          cost = 100 * 3.00 + 100 * 3.50 + 200 * 4.00 +  300 * 4.50 + 500 * 5.00
print('Bill  amount  :  ' , cost)

#  Find  outputs
while  True:
	print('Hello')
print('Bye')# infinte Time true 
