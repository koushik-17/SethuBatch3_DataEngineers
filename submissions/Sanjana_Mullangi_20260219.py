...
# Find outputs
print(7 / 0) # ERROR because division with zero is not possible
print(7 // 0) # ERROR because division with zero is not possible
print(7 % 0) # ERROR because division with zero is not possible
...
print(a) # 27
 ...
 # Find outputs (Home work)
a = 20
a %= 3 + 2 * 4 # a= 20 %(3+2*4) --> 20 %(3+8) --> 20 % 11 -->1.0
print(a) # 9
...
print(fabs(-25)) # ERROR because fabs() is not in math module and not defined
...
print(floor(3.5)) # ERROR because floor() is not in math module and not defined
print(ceil(3.5)) # ERROR because ceil() is not in math module and not defined