...
# Find outputs
print(7 / 0) #Error cannot be divided with 0
print(7 // 0) #Error cannot be divided with 0
print(7 % 0) #Error cannot be divided with 0
...
print(id(b))!#1000 b refers to same object 
print(id(c)) #1000 c refers to same object 
