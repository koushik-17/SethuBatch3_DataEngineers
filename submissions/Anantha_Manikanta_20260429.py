...
con.close()
'''
6) Parent and Child classes have different class methods
'''
class parent:
    @classmethod
    def m1(cls):
...
child.m1()
'''
7) Parent and Child classes have same class method
'''
class parent:
    @classmethod
    def m1(cls):
...
child.m1()
'''
8) Parent and Child classes have different static methods
'''
class parent:
    @staticmethod
    def m1():
...
child.m1()
'''
9) Parent and Child classes have same static method
'''
class parent:
    @staticmethod
    def m1():
...
child.m1()
'''
10) Parent and child classes have static variables with different names
'''
class parent:
    x = 10
    def m1(self):
...
child().m2()
'''
11) Parent and Child classes have static variables with same name
'''
class parent:
    x = 10
    def m1(self):
...
child().m1()
'''
12) What are the outputs if inputs are 10, 20, 30, 40, 50, 60
class parent:
    def get(self):
...
'''
'''
13) Write a program to determine area and circumference of circle.
...
while True:
    ...
    match ch:
        ...
        case 3:
            break
'''
14) Write a program to determine area and perimeter of rectangle and square.
...
'''
'''
16) Write a program to delete a directory.
...
'''
17) Write a program to delete a group of directories
...
'''
18) Write a program to rename a file
'''
import os
...
#19) Write a program to rename a directory
import os
...
'''
20) Write a program to print all the files and sub-directories of input directory
