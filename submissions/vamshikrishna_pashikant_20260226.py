...
match  m:
	...
	case  3:
		print('Three')
print('Bye')                #Bye because there is no match case of 4
...
match  i:
	case  1:
		print('One')
	case  _:                                    # in match case _ is always used in end
...
match  m:
	...
	#	print('Hello')           #error
	case  _:  
		print('Bye')             # Bye  becoz '_' replaces the value of m
print('End')                     # End
...
#  Find  outputs  (Home  work)
m = 1
match  m:                             # match case allows duplicate values, if there is multiple values it gives
	case  1:                                             #first occurance of match case
		print('Hyd')              # Hyd
	case  1:            
		print('Sec')
	case  1:
...
print('Bill amount :', round(cost, 2))

#==============================================================================================================

#  Find  outputs
while  True:
	print('Hello')   # Hello , it prints until while condition will false 
print('Bye') 
...
while  False:
	print('Hello')
print('Bye')        # Bye , becoz while condition is false
