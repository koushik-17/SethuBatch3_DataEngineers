...
print(b)#<__main__.c2 object at some address
...
# End  of  the  class
a = f1()#Constructor
print(a)#__main__.f1 object at address
############################################################################################
# Find outputs  (Home  work)
class    c1:
        def  __init__(self):
...
class c1:
    def __init__(self):
        print('c1 class of current program')

# create object of current class
obj1 = c1()

# create object of prog9a class
obj2 = prog9a.c1()