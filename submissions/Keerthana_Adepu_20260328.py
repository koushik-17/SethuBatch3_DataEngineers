...
print( lambda   x  :  x * x(7)) # error , brackets are mandatory for function definition when function definiton and function call are in the same line for lambda function
print( lambda   x  :   x * x) #
...
print(add(10 , '20')) # error , str and int cannot be added
print(add()) # error , no arguments given for a and b
print(add) # function <lambda> and hexadecimal address of the function
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad')) # error , brackets are mandatory for function definition when function definiton and function call are in the same line for lambda function
...
a  =  lambda  :  'Hyd'
print(a()) # 'Hyd'
print(a) # function 'lambda' and hexadecimal address of the function
...
#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) # error , brackets are mandatory for function definition when function definiton and function call are in the same line for lambda function
print(lambda  x  :  print(x) (s)) # error , brackets are mandatory for function definition when function definiton and function call are in the same line for lambda function
...
print(a) # type and hexadecimal addresses of functions f1 and f2
...
key = 'power_3'
print(a[key]) # type and hexadecimal addresses of the function
print(a[key](5)) # 125
...
print(type(lamb)) # <class 'int'>
print(lamb(2)) # 9
print(lamb(5)) # 3 ^ 5
print(lamb) # type and hexadecimal address of the function
print(lamb()) #error
...
lam  = eval(3 , 4 , 5)
print(lam(2)) # 3 * 4 + 8 + 5 = 12 + 13 = 25
print(lam(2.5)) # 3 * 6.25 + 10 + 5 = 18.75 + 15 = 33.75
print(lam(4)) # 3 * 16 + 16 + 5 = 48 + 21 = 69
...
print(add()) # False
add = lambda  x  :   x = 25 # error , cannot assign values in lambda function
add = lambda  x  :   x := 25 # error , cannot assign values in lambda function
