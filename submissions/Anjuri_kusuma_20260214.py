...
a . append('Sec') #no modifications because tuple is immutable
a . remove('Hyd')#no modifications because tuple is immutable
b =  10 , 20 , 30
print(b) #10,20,30
...
print(tuple(25))  #argument should be sequence
