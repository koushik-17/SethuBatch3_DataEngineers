...
print(int(3 + 4j))  # error as int argument can't be a complex
print(int('25.4'))  # error as string-float is invalid
print(int('Ten'))   # error as argument is a string
...
print(float(3 + 4j))   # error as float argument can't be a complex
print(float('Ten'))    # error as float argument is string
...
print(complex('3'))             # 3+0j
print(complex('3.8'))           # 3.8+0j
print(complex(3 , '4'))         # error bcoz only first arg can be a string ,second arg can't be a string
print(complex('3' , 4))         # error bcoz when first arg is string second arg is not permitted 
print(complex('3' , '4'))       #error bcoz when first arg is string second arg is not permitted 
print(complex('Ten'))          #  error bcoz arg is a string
