...
print('3rd  list : ' , c)
How  to  add  lists  'a'  and  'b'  and  store  results  in  list  'c'  with  for  each  loop (Do  not  use  2nd  variable)#  How  to  print  list  elements  from  indexes  2  to  4  without  slice
...
Hint:  Use  for  loop
[1:07 pm, 27/02/2026] +91 99482 50500: # Find  outputs  (Home  work)
for  i   in   range(1 , 8):
	print(i)
	if  i % 3  == 0:
			continue
...
# End of loop
print('Outside loop')
[1:07 pm, 27/02/2026] +91 99482 50500: # Identify Error  (Home  work)
if ():
	print('Hyd')
	continue
	print('Sec')
[1:13 pm, 27/02/2026] +91 99482 50500: # Find outputs (Home  work)
for  i   in   range(1 , 8):
	print(i)
	if   i % 3 == 0:
		break
...
# End  of  the  loop
print('Outside loop')
[1:13 pm, 27/02/2026] +91 99482 50500: # Identify Error  (Home  work)
if(10 , 20 , 30):
	print('Hyd')
	break
	print('Sec')#error
