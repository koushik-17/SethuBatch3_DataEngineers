...
#End of the function
x = 10
f1(x, x := x + 1) # x becomes 11, f1 called with (10, 11). --> 52, 31, 10 (Recursive unwinding)
print(x) # 11
...
def f1():
    print('f1 function')
    # f2() # Error as maximum recursion depth exceeded
    print("End of f1 function")
def f2():
    print('f2 function')
    # f1()
    print("End of f2 function")
# f1() # Error as cyclic calling causes a crash.
...
f2() # f1 function
print(f1 is f2) # True
# f2 = f1() # f2 now holds the return value of f1 (None)
# print(f2) # None
# f2() # Error as 'NoneType' object is not callable




#Find outputs (Home work)
# p = print (Assign ref 'p' to print)
# p('Hyderabad') (Call thru 'p')
# print = None (Deletes the global reference to print)
# print('Hello') # Error as 'NoneType' object is not callable
# p('Hello') # Works because 'p' still points to the original function




#Find outputs (Home work)
x_id = id # Assign ref 'x' to id()
print(x_id(25)) # Call thru ref
p_len = len # Assign ref 'p' to len()
print(p_len('Hyd')) # 3
