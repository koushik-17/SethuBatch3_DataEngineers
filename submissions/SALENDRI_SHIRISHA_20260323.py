...
print(add('Hyder' , 'abad'))  # print('Hyderabad')  # Hyderabad 
print(add(10.8 , 20.6))  #  print(31.4)  # 31.4
print(add(True , False))  #  print(1)  # 1
print(add(3 + 4j , 5 + 6j))  #  print(8 + 10j)  # 8 + 10j
print(add(25 , 10.8))  #  print(35.8)  # 35.8
...
f1(25 , c = 10.8 , b = 'Hyd')
#f1(a = 100 , 200 , 300)  #   Error, In this positional argument is after keyword argument, which is not permitted.
f1(True , None , b = 'Hyd')
f1(10 , 20 , x = 30)
f1(10 , 20)
...
print({**{'c' : 2 , 'b' :  4 , 'a' : 6}})
print(f1(**{'c' : 2 , 'a' : 4 , 'x' : 6}))  # 16


# Identify  Error (Home  work)
a = [10 , 20 , 15 , 5 , 12]
#print(sorted(reverse = True , a))  # In this positional argument is after keyword argument, which is not permitted.
#print(sorted(a , rev = True))  # In sorted there is no rev method, it is reverse.
#print(25 , 10.8 , 'Hyd' , separator = '\t')  # There is no separator in print, it is sep.
#print(25 , 10.8 , 'Hyd' , endofline = '\t')  # There is no endofline, it is end.
#print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')  # In this 10.8 and 'Hyd' are the culprits for error.