#3.Python H/W (Karthikeya Irukula)
...
print(int(3 + 4j)) # Error due to complex object not converted to int
print(int('25.4')) #Error due to conversion of string object with float number into int.
print(int('Ten')) #Error due to object/data in alphabets.
...
print(float(3 + 4j)) #Error due to complex cannot be converted to float.
print(float('Ten')) #Error due to object/data in alphabets.
...
print(complex('3')) # 3+0j
print(complex('3.8')) #3.8+0j
print(complex(3 , '4')) #Error due to 2nd argument cannot be a string.
print(complex('3' , 4)) # Error due to 2nd argument is not permitted when 1st argument is a string.
print(complex('3' , '4')) # Error due to both arguments cannot be string.
print(complex('Ten')) # Error due to object/ data is in string value.
