...
#print(a . split(''))    # error becoz '' empty separator is not applicable
...
a = input('Enter input : ')         # Enter input :  23 + 456 + 7 + 8912
b = a.split('+')
c = 0
for i in b:
    c += int(i)
...
e = [15 , 36 , 48]
#print(':' . join(e))                        # error becoz join is a string method so all elements should be strings
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f))                         # SankarDayalSarma
g = range(5)
#print('-' . join(g))                        # error becoz join is a string method so all elements should be strings
...
print('Rama  Rao'  . isalpha())     # False  it consider ' ' <space> as non-alphabet
...
print('' . isdigit())           # False
print(' ' . isdigit())          # False
#print(9247 . isdigit())         # error becoz input should be a string , isdigit is a string method
...
print('' . islower())               # False
print('a2#' . islower())            # True     if one character is lowercase it's considered
...
a = input('Enter any sentence : ')          #  Please write todays exam well
b = a.split()
c = ''

for i in range(1,len(b)+1):
    c += b[-i] + ' '
print(f'Reverse order of words : {c}')      #  Please write todays exam well
...
a = input('Enter any sentence : ')		# Hyd  is  green  city
b = a.split()

for i in b:
    print(i[::-1], end=' ')				# dyH si neerg ytic
...
a = input('Enter any string : ')    # RAJESH
b = ''

for i in sorted(a):
    b += i

print(f'sorted string : {b}')		# AEHJRS
...
a = input('Enter string with alphabets and digits : ')      # 13579ADKPZ
alpha = ''
digit = ''
...
print('Result : ',alpha+digit)                       # Result :  ADKPZ13579