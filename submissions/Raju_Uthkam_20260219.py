...
print({10 : 'Hyd' , 20 : 'Sec'} |  {30 : 'Cyb' , 20 : 'Vja'}) #{10:'Hyd',20:'Vja',30:'Cyd'}
#print(range(4) | range(5)) #Range is immuatable we can't concatenate range object
#print([10 , 20]  |  [30 , 20]) #Error list can't concatenate through pipe 
...
print(not  '') #True
print(not  -10) #False 
print(not  not  'Hyd') # not False = True 


#  Find   outputs (Home work)
i = 10
i = not  i > 14 #10> 14 = False --> not False = True 
print(i) #True 
...
#print(fabs(-25)) #Error there is no math function
