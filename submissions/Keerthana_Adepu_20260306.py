...
'''
a = 'Rama Rao'
print(a [ : 7 : 2]) # a[0 : 7 : 2] # string from indexes 0 to 6 in steps of 2 # Rm<space>a
print(a [ : 7]) # a[0 : 7 : 1] # string from indexes 0 to 6 in steps of 1 # Rama<space>Ra
print(a [2 : 4]) # a[2 : 4 : 1] # string from indexes 2 to 3 in steps of 1 # ma
print(a [2 : ]) # a[2 : 8 : 1] # string from indexes 2 to 7 in steps of 1 # ma<space>Rao
...
print(a [-6 : -1]) # a[-6 : -1 : 1] # string from indexes -6 to -2 in steps of 1 # ma<space>Ra
print(a [-6 : ]) # a[-6 : 8 : 1] # string from indexes -6 to 7 in steps of 1 #ma<space>Rao
...
print(a [ : : ]) # a[0 : 8 : 1] # string from indexes 0 to 7 in steps of 1 # Rama<space>Rao
print(a [ : ]) # a[0 : 8 : 1] # string from indexes 0 to 7 in steps of 1 # Rama<space>Rao
print(a [ : : -1]) # a[-1 : -9 : -1] # string from indexes -1 to -8 in steps of -1 # oaR<space>amaR
print(a [ : : -2])  #  a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
print(a [ -2 : : -2]) # a[-2 : -9 : -2] # string  from  indexes  -2  to  -8  in  steps  of  -2 # a<space>mR
print(a [2 : 8]) # a[2 : 8 : 1] # string from indexes 2 to 7 in steps of 1 # ma<space>Rao
print(a [2 : 8 : -1]) # a[2 : 8 : -1] # string from indexes 2 to 7 in steps of -1 # empty because 2 to 8 with negative steps can't be possible
print(a [ : -6 : -1]) # a[-1 : -6 : -1] # string from indexes -1 to -5 in steps of -1 # oaR<space>a
...
print(a [ : -5 : -5]) # a[-1 : -5 : -5] # string from indexes -1 to -4 in steps of -5 # o
print(a [2 : -5]) # a[2 : -5 : 1] # string from indexes 2 to -6 in steps of 1 # m
print(a [2 : -5 : 2]) # a[2 : -5 : 2] # string from indexes 2 to -6 in steps of 2 # m
print(a [ : 0 : -1]) # a[-1 : 0 : -1] # string from indexes -1 to 0 in steps of -1 # oaR<space>amaR
print(a [-5 : 0 : -2]) # a[-5 : 0 : -2] # string from indexes -5 to 1 in steps of -2 # aa
...
for i in range(len(x)):
    print(f'The character at index {i} is {x[i]}')
    index += 1
...
'''
x = input('Enter an input with alternating alphabets and digits:')
out = ''

try:
    for i in range(0 , len(x) , 2):
        out = out + x[i] * int(x[i+1])
...
print(f'Slice without duplicates: {out}')
...
print(len(' ')) # 1
print(len('A2#')) # 3
print(len(3456)) # error , needs a string argument
print('Sec'. len()) # error , object should be the argument
...
'''
x = input('Enter an input with alternating characters and digits:')
out = ''
