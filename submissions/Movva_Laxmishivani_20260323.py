...
def  f1(x , y , z):
	print('Three  argument  function : ' , x , y , z) # RECOGNISED and output is Three argument function :  10 20 30
f1(10 , 20 , 30)
f1(40 , 50)  
f1(60)  
f1()
...
f1(a = 100 , 200 , 300)  #   Error because positional arguments cannot come after keyword arguments
f1(True , None , b = 'Hyd') # ERROR because b can't take 2 values
f1(10 , 20 , x = 30) # ERROR because x is not a parameter
f1(10 , 20) # ERROR because 3rd parameter is missing
...
def    f1(a , b , c):
	return  a + b * c
#end  of  the  function
print(f1(3 , 4 , 5)) # a + b*c = 3 + 4*5 = 3 + 20 = 23
print(f1(*[6 , 7 , 8])) # 6 + 7*8 = 6 + 56 = 62
print(f1([6 , 7 , 8])) # ERROR because function got only one argument to perform task but needed 3
print(f1(*{1 : 2 , 3 : 4 , 5 : 6})) # keys--> 1 + 3*5 = 16
print(f1(**{'c' : 2 , 'b' :  4 , 'a' : 6})) # 6 + 4*2 = 14
print(f1({'c' : 2 , 'b' :  4 , 'a' : 6})) # ERROR because function got only one argument to perform task but needed 3
print({**{'c' : 2 , 'b' :  4 , 'a' : 6}}) # {'c': 2, 'b': 4, 'a': 6}
print(f1(**{'c' : 2 , 'a' : 4 , 'x' : 6})) # ERROR because x is not an actual parameter of f1()

# Identify  Error (Home  work)
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a)) # ERROR because positional argument (a) cannot come after keyword argument (reverse).
print(sorted(a , rev = True)) # ERROR because rev is invalid keyword argument reverse is correct keyword.
print(25 , 10.8 , 'Hyd' , separator = '\t') # ERROR because correct keyword is sep, not separator.
print(25 , 10.8 , 'Hyd' , endofline = '\t') # ERROR because correct keyword is end, not endofline.
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') # ERROR because positional arguments (10.8, 'Hyd') are given after keyword arguments.