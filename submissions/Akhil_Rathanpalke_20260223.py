...
print(a , b , c , separator = ':') # Error the print() function does not have the argument seperator
...
print('%s'  %a) # 'Hyd'
print('%s' , a) # '%s' 'Hyd'
print('%s'  a) # Error due to missing percentile
print('%s' , %a) # Error due to comma between them
print(a) # 'Hyd'
...
print('%s'  a) # Error due to the missing percentile
print('%s' , %a) # Error due to the comma between them
print('%l'  %a) # Error %l format type does not exist
print(a) # [ 10 , 20 , 30 , 40 ]
...
print('%d    %g      %s'   a , b , c) # Error due to the percentile does not present
print('%d    %g    %s'  ,  %(a , b , c)) # Error due to the comma present
print('%d    %g    %s'    %a%b%c) # Error because of invalid syntax
...
print(F'{a=}  \t   {b=}   \t  {c=}') # a=25	    b=10.8        gc=Hyd
print(F'{a:}  \t   {b:}   \t  {c:}') # 25	10.8	      Hyd
print('a  =  {a}  \t  b  =  {b}  \t  c  =   {c}') # a  =  {a}  \t  b  =  {b}  \t  c  =   {c}
print(F'a  =  a  \t  b  =  b  \t  c  =  c') # a  =  a  \t  b  =  b  \t  c  =  c
print(F'{x =}  \t   {y =}   \t  {z =}') # Error here x,y,z are not defined
