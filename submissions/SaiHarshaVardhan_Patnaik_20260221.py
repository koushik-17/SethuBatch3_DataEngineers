...
x = complex(input('Enter  complex  number  :  ')) # 3 + 1j
...
x = eval(input('Enter  any  input  :  ')) # 45
print(type(x)) # <class 'int '>
print(x) # 45

# What  is  a  better  approach  to  read  string  input ?
a = input('Enter  any  string  :  ') # Harsha
print(len(a)) # 6
print(a) # Harsha 
b = eval(input('Enter   any  string  : ')) # Harsha 
print(len(b)) # 6
print(b) # Harsha 