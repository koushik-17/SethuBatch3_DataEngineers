...
x = all(10 , 7) #a = 10 ,b = 7 (17,3,70,1.42)
...
a  =  lambda  :  'Hyd'
print(a()) # Hyd
print(a) #<function <lambda> at memory address>
...
a() #Sec,Cyb,Hyd
 ...
 #  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s)) #<function <lambda> at memory address>
...
# Find  outputs
x = 5
adder1 = lambda    y  :  x + y #y=100 x= 20 (y:120)
x = 10
adder2 = lambda    y  :  x + y #y=200 x=30 (y:230)
x = 20
adder3 = lambda    y  :  x + y #y=300 x=40 (y:340)
...
print(adder3(300)) #340
 ...
 #Find  outputs  (Home  work)
a = [lambda   x  :  x * 2 , lambda   x  :  x * 3 ,  lambda   x  :  x ** 4] #(5 * 2 = 10,5 * 3 = 155 ** 4 = 625)
for   fun   in   a:
        print(fun(5)) # 10
                        15
                        625
...
key = 'power_3'
print(a[key]) #<function <lambda> at Memory Address>
...
print(lamb) #<function <lambda> at Memory Address>
print(lamb()) #Error there is no input
...
# Find  output  (Home  work)
add = lambda  x  :   x == 25
print(add(10)) #10 == 25 → False
add = lambda  x = 25 :   x == 35
print(add()) # 25 == 35 → False
add = lambda  x  :   x = 25 #Error becz = operator is not allowed
add = lambda  x  :   x := 25 #Error becz := cannot be used like this in lambda without parentheses
...
'''
1) power(4.5 , 3) =4.5 × 4.5 = 20.25
20.25 × 4.5 = 91.125

2) power(4.5 , -3) = 1 / 91.125 ≈ 0.01097
