...
print(a + 5)  # error list cannot concatenate non-sequence
print(a + '5')  # error list cannot concatenate non-sequence
print([10 , 20] + (30 , 40)) # error list cannot concatenate tuple
...
a += b #[1 , 2 , 3 , 4 , 5 , 6]
print(a , id(a)) # [1 , 2 , 3 , 4 , 5 , 6] , address of obj a
...
print(a , id(a))  # [1 , 2 , 3]
a  = a + b   #  [1 , 2 , 3 , 4 , 5 , 6]
print(a , id(a))  # [1 , 2 , 3 , 4 , 5 , 6] , address of the obj a
...
list = []
print(list)  # []
list . append(25)  # [25 , 10.8 ,  'Hyd' , True]
list . append(10.8)
list . append('Hyd')
list . append(True)
...
b = [50 , 60 , 70]
a . insert(2 , b)
print(a)  # [10 , 20 , 30 ,[50 , 60 , 70] , 40]
print(len(a))  # 5
print(How  to  print  inner  list)  # a[4]
print(How  to  print  50) # a[4][0]
print(How  to  print  60) # a[4][1]
print(How  to  print  70) # a[4][2]
