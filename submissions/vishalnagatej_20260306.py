...
a = input('Enter any string : ')         # PYTTHON
if len(a) < 4:
    print(F'Result : {''}')
else:
    print(f'Result : {a[:2] + a[-2:]}')  # PYON
...
a = input('Enter any string with alternate character and digit : ')     # A4B3C2$5
out = ''
...
try:
    ...
    print('Result : ',out)              # Result :  AAAABBBCC$$$$$

except:
    print('String should have character and digit')
...
a = input('Enter any string : ')            # MISSISPI
b = ''
for i in a:
    if i not in b:
        b += i
        ...
        b += ''
print(f'String without duplicates : {b}')   # MISP
...
print(len(' '))           # 1
print(len('A2#'))         # 3
#print(len(3456))          # ERROR BECOZ INTEGERS ARE NON-SEQUENCE ELEMENTS SO LEN IS NOT APPLICABLE FOR INT
#print('Sec'. len())       # ERROR
