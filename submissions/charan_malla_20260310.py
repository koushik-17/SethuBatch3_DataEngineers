...
a = [10, 20, 15, 18]
b = a # ref b is pointing to list a.
print(a  is  b) # True
print(a  ==  b) # True
b[2] = 12 # index 2 is modified 
print(a) # [10,20,12,18]
...
print(a + 5) # error: seq and non-seq cannot concatenated
print(a + '5') # error: list and str cannot concatenate
print([10 , 20] + (30 , 40)) # error: list and tuple cannot concatenated

#  Find  outputs
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1, 2, 3] address of list a
a += b # list is modified
...
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a)) # [1,2,3] addrees of list a
a  = a + b # ref is modified
print(a , id(a)) # [1,2,3,4,5,6] new list address
...
a , *b , c = list
print('a : ' , a) # a : 25
print('b : ' , b) # b : [10.8, 'Hyd'] '*b' returns list of remaining elements
print('c : ' , c) # c : True
...
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # not enough elements to unpack
a , b , *c , d , e = list 
print('a : ' , a) # a : 25
print('b : ' , b) # b : 10.8
print('c : ' , c) # c : []
print('d : ' , d) # d : 'Hyd'
print('e : ' , e) # e : True
a , b , *c , d , e , f = list # not enough elements to unpack 


# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , _  , d = list # elements are unpacked to variables
print('a : ' , a) # a : 25
print('b : ' , b) # b : 10.8
print('_ :  ' , _) # _ : 'Hyd'
print('d : ' , d) # d : True
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # error: we can use * only once
...
print('c : ' , c) # c : 'Hyd'
print('d : ' , d) # d : True
a , b , c , d = list # error: not enough elements to unpack 
...
print(How  to  determine  sum  of  inner  list  elements  in  another  way) # for x in a:
                                                                                  print(sum(x))
...
a = list()
print(a) # []
print(list(25)) # error: argument cannot be non seq
print(list(10.8)) # error: argument cannot be non seq
print(list(True)) # error: argument cannot be non seq
print(list(None)) # error: argument cannot be non seq
...
a = [10 , 20 , 15 , 5 , 12]
b = sorted(a) # sorts elements  of  the  list  in  ascending  order
print(b) # [5 , 10 , 12 , 15 , 20]
print(type(b)) # <class'list'>
c = sorted(a , reverse = True)  # sort  list  in  descending  order
...
list . append(19) # adds 19 at the end of list
...
try:
	...
	list . remove(15) # removes first occurance of 15 from list
