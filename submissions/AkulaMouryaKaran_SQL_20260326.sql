...
INSERT INTO emp_dtls VALUES ((101, 'RAJ',  'IT',   'US'), (102, 'RAM',  'MED',  'US'), (103, 'RAKI', 'MECH', 'AUS'), (104, 'ABC',  'MECH', 'IND'), (105, 'XYZ',  'IT',   'IND'));
...
INSERT INTO country_details VALUES (('US',  'United States', 01), ('AUS', 'Australia',    61), ('MAL', 'Malaysia',     65));	

#7. Write a query to display employees information who are working as IT in INDIA and MECH from AUS. 
SELECT e.*
FROM emp_dtls e
WHERE (e.job = 'IT' AND e.country_code = 'IND')
   OR (e.job = 'MECH' AND e.country_code = 'AUS');
