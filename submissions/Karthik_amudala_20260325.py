...
# End of the function
  ...
  f1(1 , b = 2 , c = 3 , d = 4 , e = 5 , f = 6) #error b should be positional arguement
...
# # End  of  the  function
  ...
  print(avg(10.8 , 20.6 , 15.2 , 14.9 , 9.8)) #Error
  print(avg())   #Error
  print(avg(25))  #Error
  print(avg(3 + 4j , 5 + 6j)) #Error
  tpl = (10 , 20 , 15 , 18)  
  print(avg(tpl))  #Error
...
# End   of  the   function
  ...
  print(concat('Python', 'Is', 'A', 'Great', 'Language')) #Python IS A Great
  print(concat())   #Error
