...
print(kwlist) # kwlist = keyword.kwlist;print(kwlist)
...
cyb = 10.8
print(eval('cyb')) # 10.8
print(eval(cyb)) # ERROR because arg in eval() should be str or int but not float
...
print(bool('')) # False
print(eval('  ""  ')) # ""
print(eval('')) # ERROR because no arg inside the eval()
print(eval('  " "   ')) # " "
print(eval(' ')) # ERROR because its just whitespace so throws error

 # What  is  the  advantage  of  eval(input()) ? --> automatically converts input into its class 
...
print(len(a)) #5
print(a) #'Hyd'
b = eval(input('Enter   any  string  : ')) # Enter   any  string  : 'Hyd'
print(len(b)) # 3
print(b) # Hyd