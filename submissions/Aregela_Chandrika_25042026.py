...
m  =  re . match(pattern , str ing , re . IGNORECASE)
if  m:
...
5) Which  of  the  following  are  valid ?
     a) 00/05/2025  --->  Invalid  due  toblob:https://web.whatsapp.com/4cb4a860-f1a8-441a-a647-64a4ea39c6fe  date  00
