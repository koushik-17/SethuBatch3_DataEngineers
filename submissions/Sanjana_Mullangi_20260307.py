...
e = [15 , 36 , 48]
print(':' . join(e))#error-the elements of e does not belong to str class and hence cannot use str method
f = ['Sankar' , 'Dayal' , 'Sarma']
print('' . join(f))#'SankarDayalSharma
g = range(5)
print('-' . join(g))#error-range object cannot be joined 
...
print('' . isdigit()) #   False
print(' ' . isdigit())# False
print(9247 . isdigit())#error-the argument is int not str and we cannot apply string methods to int object
