...
a = input('Enter  input  string :  ').upper()
b = ''
for x in a:
    if x in "AEIOU" and x not in b:
        b = b + x
...
print(50  in  a) #True
print(20  in  a) #False because we have to mention a.values() for value element.
...
d = {*a , *b , *c}
print(d) #{10, 14, 15, 18, 19, 20, 25} it prints values as unpacked.
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
#print(a + b) #Error due to + operator not used in dict.
c = {**a , **b}
print(c) #{10:60 , 30:50}
d = a | b
print(d) #{10:60 , 30:50}
...
for i in range(n):
    ...
    a[name] = salary   # appending to dictionary
