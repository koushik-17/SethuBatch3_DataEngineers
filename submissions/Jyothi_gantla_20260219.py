...
# Error: Cannot use | with range objects

print([10 , 20]  |  [30 , 20])  
# Error: Cannot use | with lists
...
print(3 + 4j >  3 + 4j) 
# Error: Cannot compare complex numbers
...
print('HYD'  <   'hyd')
# True (uppercase < lowercase in ASCII)
...
print(10  or  20)  
# 10 (first truthy value)

print(0   or  20)  
# 20 (first truthy value)
...
print(6j  or  'Hyd') 
# 6j (non-zero complex number is truthy)
...
n = (1 , 2 , 3 , 4)
print(m  is  n) 
# True (may vary depending on Python implementation)
...
print(a++)   
# Error: Python does not have ++ operator
...
# Error: Cannot take sqrt of complex number with math.sqrt
