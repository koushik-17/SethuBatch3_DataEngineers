...
# End  of  the  class
t = Test()
print(t . __init__())#Constructor :  id \n None
...
b = c1(20)
print(a >= b)#__gt__ method  :   10 20 \n False
print(a <= b)  #  b >= a __gt__ method  :   20 10 \n True
...
b = c1(20)
print(a == b)#__gt__ method  :   10 20 \n False
print(a != b)  # not (a == b)#__gt__ method  :   10 20 \n True
...
a = c1()
b = c1()
print(a > b)#False and recursion error
