...
2) When  does  it  return  True ?  ---> When  there  are  no  uppercase  alphabets  in  the  string at  least  one  character  is  lowercase  alphabet
Note:
