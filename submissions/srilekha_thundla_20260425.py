...
What  is  the  regular  expression  for  the  above  rules ?  ---> r'^[Tt][Ss](0[1-9]|1[0-9]|2[0-9])[A-Za-z]{2}[0-9]{4}$' '''    
...
import re 
pattern = '^[A-Za-z ]+ , [A-Za-z ]+ , [A-Za-z ]+ - \d{6}$'
...
import re 
pattern = '^(4|5|6)\d{15}$|^(4|5|6)\d{3}(-\d{4}){3}$'
