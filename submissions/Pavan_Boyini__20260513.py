...
def  count_all(f):
	...
	a = [0]*8
	a[0]=re.count('\n')
	a[1]=len(re)#How  to  append  number  of  characters  in  the  file  to  list  'a'
	a[2]=len(re.split())#How  to  append  number  of  words  in  the  file  to  list  'a'
	a[3]=re.count(' ')#How  to  append  number  of  spaces  in  the  file  to  list  'a'
	a[4]=re.count("\t")#How  to  append  number  of  tabs  in  the  file  to  list  'a'
	a[5]=re.count(".")#How  to  append  number  of  sentences  in  the  file  to  list  'a'
	count=0
	cons=0
	for x in re:
		if x in 'aeiou':
		...
		if x not in 'aeiou' and x.isalpha():
			cons+=1#How  to  append  number  of  vowles  in  the  file  to  list  'a'
	a[6]=count
	a[7]=cons
	#How  to  append  number  of  consonants  in  the  file  to  list  'a'
	return a#How  to  return  list
#  End  of   function
f=input('enter filename: ')#How  to  read  filename
a=count_all(f)
