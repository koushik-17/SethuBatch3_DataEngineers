...
print(float(0B1010101)) # 1010101-->128+ 32+8= 168  
print(float(0O6247)) # 512*6+64*2+8*4+8*7
print(float(0XA7B9))  # 11*16^3+7*16^2+12*16^1+7*16^0
print(float(3 + 4j)) # 3.0 + 4.0
print(float('Ten')) # 10.0
...
print(complex(3 , 4)) # 3.0 + 4.0
print(complex(0 , 4)) # 0.0 + 4.0
print(complex(3)) # 3.0 + 0.0
print(complex(3.8 , 4.6)) # 3.8 + 4.6
print(complex(3.8)) # 3.8 + 0.0
print(complex(3 , 4.5)) # 3.0 + 4.5
print(complex(True , False))  # 1.0 +0.0
print(complex(True)) # 1.0 +0.0
print(complex(False)) # 0.0 + 0.0
print(complex(True , 4)) # 1.0 + 4.0
print(complex('3')) # 3.0 +0.0
print(complex('3.8')) # 3.8 + 0.0
print(complex(3 , '4'))  # Error because 2nd arg cant be a string 
print(complex('3' , 4))  # Error because 2nd arg cant be permited when 1st arg is string
print(complex('3' , '4')) # Error because both arg are string
print(complex('Ten')) # Error 2nd arg cant be permited when 1st is string
...
print(str(25))    #  '25'
print(str(10.8))  # 10
print(str(3 + 4j)) #  Error because its a complex
print(str(True)) # True
...
print(oct(195))  # 1*8^2+9*8^1+5*8^0
print(oct(0B10101110010))  # 1*8^10+1*8^8+1*8^6+1*8^5+1*8^4+1*8^1
print(oct(0xA7B9))  # 1010 0111 1011 1001
