...
# print(9 // 2.0)   #   prev  integer(4.0)   = 4.0
# print(9.0 // 2.0)   #   prev  integer(4.0)   = 4.0
# print(10.5 // 2) #prev  integer(5.2)  = 5.0
# print(10 // 3) #prev  integer(3.3)  = 3.0
...
# # Find outputs (Home work)
# a = b = c = 25
# print(id(a)) #address of an object 25
...
print(math . sqrt(math . sqrt(256)))#4.o
print(math . sqrt(math . pow(3 , 4)))#9.0
print(math . sqrt(-16))#error
print(sqrt(49))#error because no math module
...
print(fabs(-25)) #error because no math module
...
print(floor(3.5)) #error because no math module
print(ceil(3.5)) #error because no math module
