...
a = add() #Error because we need to pass arguments.
print(a(20)) #30
print(add(30)(40)) #70
...
f1()
#outputs:RecursionError: maximum recursion depth  exceeded.
...
#  Identify  Error
def   f1():
        nonlocal   x  #SyntaxError: no binding for non local 'x' found.
