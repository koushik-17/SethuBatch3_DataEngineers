...
b = dict(a)#{10 : 'Hyd' ,20 :'Sec', 15 : 'Cyb' , 20 :'Pune'}
print(b)#{10 : 'Hyd' ,20 :'Sec', 15 : 'Cyb' , 20 :'Pune'}
c = ( ['R' , 'Red'] , ['G' , 'Green'] , ['B' , 'Blue'] , ['G' , 'Gray'])
d = dict(c)
print(d)# {'R' : 'Red' , 'G' : 'Green' , 'B' : 'Blue' , 'G' : 'Gray'}
e = [[10 , 20 , 30] , [40 , 50 , 60] , [70 , 80 , 90]]
print(dict(e))#error nested sequence should have the 2  values only but here 3 values 
f = [[10] , [20] , [30]]
print(dict(f))#error nested sequence should have the 2  values only but here 3 values 
print(dict([10 , 20]))#{10:20}
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g))#{10:[20 , 30],40:[50,60],70:[80,90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h))#error a key should be a single value only not nested of two values 
i = [[(10 , 20) , 30] , [(40 , 50) , 60] , [(70 , 80) , 90]]
print(dict(i))##error a key should be a single value only not nested of two values 
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
b = a . items()
print(b)#dict_item[(10 ,'Hyd') , (20 , 'Sec') , (15 ,'Cyb') , (18 , 'Pune')]
print(type(b))#<class list>
for  x   in   b:
...
for  x , y   in  a . items():
       print(x , y , sep = ' ... ')#(10 ...'Hyd')<nextline>(20 ...'Sec')<nextline>(15 ...'Cyb') <nextline> (18 ... 'Pune')
for  x , y   in  a . keys():
       print(x , y , sep = ' ... ')#error because keys() as needed only one x but not x and y .
for  x , y   in  a . values():
       print(x , y , sep = ' ... ')#error because values() as needed only one x but not x and y .
for  x , y   in  a:
       print(x , y , sep = ' ... ')#(10 ...'Hyd')<nextline>(20 ...'Sec')<nextline>(15 ...'Cyb') <nextline> (18 ... 'Pune')
...
print(y)#20
print(z)#15
print()#nothing moves to nextline 
x , y , z = a . values()
print(x)#'Rama'
print(y)#'Sita'
print(z)#'Rajesh'
...
a . update(b)
print(a)#{'R': 'Red', 'G' : 'Gray','B': 'Blue','Y' : 'Yellow'}
#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)]
b = {}
b.update(a)
print(b)#error because 3 elements dictionary supports only 2 elements in tuple 
c = [(10,) , (20,) , (30,)]
b . update(c)
print(b)#{10:0,20:0,30:0}
 #  Find  outputs (Home  work)
