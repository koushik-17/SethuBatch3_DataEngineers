...
import  re
s1 = input('Enter first string  : ')
m  = re . fullmatch( r"^[Tt][Ss](0[1-9]|1[0-9]|2[0-9])[A-Za-z]{2}[0-9]{4}$",s1  )
if  m:
        print('valid')
else:
        print('invalid')
...
import  re
s1 = input('Enter first string  : ')
m  = re . fullmatch(  r"^(0?[1-9]|1[0-9]|2[0-9]|3[01])/(0?[1-9]|1[0-2])/[0-9]{4}$",s1  )
if  m:
        print('valid')
else:
        print('invalid')
...
import  re
s1 = input('Enter first string  : ')
m  = re . fullmatch(  r"^[A-Za-z ]+ , [A-Za-z]+ , [A-Za-z]+ - [0-9]{6}$", s1  )
if  m:
        print('valid')
else:
        print('invalid')
...
import  re
s1 = input('Enter first string  : ')
m  = re . fullmatch(  r"^[456][0-9]{3}-?[0-9]{4}-?[0-9]{4}-?[0-9]{4}$", s1  )
if  m:
        print('valid')
else:
        print('invalid')