...
print(add(10 , '20'))#error-non sequence and sequence cannot be added
...
f1(40 , 50)#error-the function f1(x,y) is discarded because it has another function with same name
f1(60) #error-the function f1(x) is discarded because it has another function with same name
f1() #error-the function f1() is discarded because it has another function with same name
