...
e = range(-10)
print(*e) #empty string because 0 never meets -10
f = range(2 , 2)
...
#a , b , c = *r  # error
m = r  
print(id(r)) # address of m or r object (both stores same address)
...
print(id(a)) # address of a object
a = [25]
print(a , id(a)) # [25] address of a object
#print(a * a) #error
...
#     0     1     2    3     4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a)) # [10 , 20 , 30 , 40 , 50]  address of a object 
a[1 : 4] = [60 , 70]
print(a , id(a)) # [10,60,70,50] address of a object (same address)
a[2: 4] = [100 , 200 ,  300]
print(a , id(a)) # [10,60,100,200,300] address of a object (same address)


#  Find  outputs  (Home  work)
a =  [25]
#print(a[1]) #error because at 1st index value not avaliable
print(a[1:]) # empty list because at 1st index value not avaliable
