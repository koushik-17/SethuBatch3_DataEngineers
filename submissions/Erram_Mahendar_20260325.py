...
x=int(input("Enter no for getting the devisors:"))
d=[]
prime_devisor(x)
...
f1(a = 40 , b = 50 , c = 60)    # a : 10 	b : 20 		c : 30
f1(c = 100 , b = 90 , a = 80)   # a : 10 	b : 20 		c : 30
f1(70 , 80 , c = 90)            #Error
f1(70 , 80 , 90)                #Error
...
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass  #positional arg should be before default arg
...
#end
disp(10 , 20 , 30)        #3-argument function # 60
...
print('_defaults  :  ' , f1._defaults_)      #_defaults : [0, 1, 4, 0, 1, 4, 9, 16]
print(f1(6))
print('_defaults  :  ' , f1._defaults_)      #_defaults : [0, 1, 4, 0, 1, 4, 9, 16, 0, 1, 4, 9, 16, 25, 36, 49, 64]
...
f1()
print('Default Values  :  ' , f1 . _defaults_)  #a = 'HydSec', b = [1, 2, 3, 1, 2, 3]
f1()
...
f1('Hyd')                  #Hyd #<class str> #1
tpl = (100 , 200 , 150)    
f1(tpl)                    #(100, 200, 300) #<class tuple #1
f1(t = (10 , 20 , 30)) #   Error
