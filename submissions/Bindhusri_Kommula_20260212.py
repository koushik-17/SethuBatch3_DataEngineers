...
print(float(0B1010101))  # 64*1 + 32*0 + 16*1 + 8*0 + 4*1 + 2*0 + 1*1=64+16+4+1=85.0
print(float(0O6247))     # 512*6 + 64*2 + 8*4 + 1*7=3239.0
print(float(0XA7B9))     # 4096*10 + 256*7 + 16*11 + 1*9=40960+1792+176+9=42937.0
...
print(complex('3'))            # 3+0j
print(complex('3.8'))          # 3.8+0j
print(complex(3 , '4'))        # No because 2nd arg cannot be a string
print(complex('3' , 4))        # No because 2nd arg is not permitted when 1st arg is string
