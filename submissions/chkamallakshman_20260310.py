...
print(a + 5)                      # Error list and int cannot concatinate
print(a + '5')                    # Error list and str cannot concatinate
print([10 , 20] + (30 , 40))      # Error list and tuple cannot concatinate

# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a))                  # [1, 2, 3]   it shows the id of the object list a
a += b
print(a , id(a))                  # [1, 2, 3, 4, 5, 6] it shows the id of the same object list

# Tricky  program
#  Find  outputs
a = [1 , 2 , 3]
b = [4 , 5 , 6]
print(a , id(a))                  # [1,2,3,4,5,6]  it shows the id of the object list 
a  = a + b
print(a , id(a))                  # [1,2,3,4,5,6]  it shows the id of the new object list
...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # Error elements not equal to object
a , b , *c , d , e = list
print('a : ' , a) # a: 25
print('b : ' , b) # b: 10.8
print('c : ' , c) # c: []
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # Error there should not be multiple star elements
...
print(sum(d)) # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # Error str and int cannot concat
...
print(max(c)) # Error  
d = [25 , '35']
print(max(d)) # Error in the str and int list cannot find max
print(max([])) # Error there should be atleast one argurment
print(min([])) # Error there should be atleast one argurment
...
a = list()
print(a) # []
print(list(25)) # Error int cannot convert to list
print(list(10.8)) # Error float cannot convert to list
print(list(True)) # Error bool cannot convert to list
print(list(None)) # Error none cannot convert to list
...
print(len(a)) # 4
print(How  to  print  4th  element  of  list  'a') # a[4]
print(How  to  print  'H') # a[4][0]
print(How  to  print  'y') # a[4][1]
print(How  to  print  'd') # a[4][2]
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # Error cannot sort str and float
