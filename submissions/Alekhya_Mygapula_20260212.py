...
print(complex('3')) #3+0j
print(complex('3.8'))  #3.8+0j
print(complex(3 , '4'))   #Error secound one should not be str
print(complex('3' , 4))  #Error becoz 1st one str meand 2nd one not permitted
print(complex('3' , '4')) #Error becz str
print(complex('Ten')) #Error becoz not value
