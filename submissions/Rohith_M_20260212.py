...
print(int(3 + 4j))  # Error complex can't convert into int
...
print(float(0B1010101)) # 1*64+0*32+1*16+0*8+1*4+0*2+1*1 =85.0
print(float(0O6247)) # 6*512+2*64+4*8+7*1 = 3239.0
print(float(0XA7B9))  # 11*4096+7*256+12*16+9*1 =42937.0
print(float(3 + 4j)) # Error because complex can't be convert to float
...
print(oct(195))  #0o303
print(oct(0B10101110010)) # 0b2652
print(oct(0xA7B9)) #0b1829


# hex()  function  demo  program
print(hex(25)) # 0x19 
print(hex(0B10101111010111)) #2bd7
print(hex(0O6247)) #0oca7
