...
print(a + 5) # Error a non sequence cannot be added to a sequence
print(a + '5') # Error list only concatenated with list
print([10 , 20] + (30 , 40)) # Error for two different sequences cannot be concatenated  
...
print(a , id(a)) # [ 1 , 2 , 3] Address of list a
a  = a + b
print(a , id(a)) # [ 1 , 2 , 3 , 4 , 5 , 6] Address of new list a
...
# Find  outputs  (Home  work)
list = [25 , 10.8 , 'Hyd' , True]
a , b , c , d , e = list # Error because of more number of values while unpacking
a , b , *c , d , e = list
print('a : ' , a) # a : 25
print('b : ' , b) # b : 10.8
print('c : ' , c) # c : []
print('d : ' , d) # d : 'Hyd'
print('e : ' , e) # e : True
a , b , *c , d , e , f = list # Error because of more number of values while unpacking
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list
# The unpacking of list statement should have only one * expression
...
print('c : ' , c) # c : 'Hyd'
print('d : ' , d) # d : True
a , b , c , d = list # Error the excess number of values then the list elements
...
print(sum(d)) # 63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e)) # Error cannot add integers with string values
...
#  Find  outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a)) # Error because the list contains a list of integers
print(sum(a[0])) # How  to  determine  sum  of  inner  list  elements
# To determine  sum  of  inner  list  elements  in  another  way)
sum = 0
for x in a[0]:
   sum+=x
print(sum)
...
print(min(b)) # 'Amar'
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c)) # Error because max() method can only used between same objects
d = [25 , '35']
print(max(d)) # Error because max() method can only used between same objects
print(max([])) # Error the max() function should have at least one parameter
print(min([])) # Error the min() function should have at least one parameter
...
a = list() 
print(a) # []
print(list(25)) # Error the argument should not be a non-sequence
print(list(10.8)) # Error the argument should not be a non-sequence
print(list(True)) # Error the argument should not be a non-sequence
print(list(None)) # Error the argument should not be a non-sequence
...
print(list(b)) # [(10 , 20) , (30 , 40 , 50) , (60 , 70 , 80 , 90)] in any order because set is unordered
c = ([10 , 20] , (30 , 40) , {50 , 60})
...
del    a[2]
print(a) # [10 , 20 , 18]
del  a[3] # Error index 3 does not exists
del  a # Entire list object a ia deleted
print(a) # Error object a is not defined
...
n = eval(input("Enter the element to be deleted : "))
try :
    for x in a:
        if x == n:
            a.remove(n)
    print(f"List without {n}'s : {a}")
except:
...
print(a . pop(2)) # 15
print(a) # [10 , 20 , 18 , 12]
print(a . pop(len(a))) # Error because of index out of bounds
print(a . pop(-3)) # 20
print(a) # [10 , 18 , 12]
print(a . pop(-4)) # Error because of index out of bounds
print(a . pop()) # 12
print(a) # [10 , 18]
b = []
b . pop() # Error because list is empty
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # The objects should be of same type
...
'''Output:
Enter list : [25 , 25 , 25 , 25]
All the list elements are identical 

Enter list : [10 , 10 , 20 ,  10]
