...
a += b
print(a , id(a))#[1, 2, 3, 4, 5, 6] address of 'a' same
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list#multiple unpack error
...
try:
	...
	d=eval(input("Enter element to be deleted : "))
	for i in lt:
		if i==d:
			lt . remove(i)
	print(F"List Without {d}'s : {lt}")
except:
...
print(a . pop(2))#15
print(a)#[10,20,18,12]
print(a . pop(len(a)))#error out of range
print(a . pop(-3))#20
print(a)#[10,18,12]
print(a . pop(-4))#error out of range
print(a . pop())#12
print(a)#[10,18]
b = []
b . pop()#error
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort()#sort won't work between str and float
...
total_length=len(lt)
if total_length==0:
    print("List is Empty Enter Elements")
else:
    if lt.count(lt[0])==total_length:
