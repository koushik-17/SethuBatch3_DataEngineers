...
print(a [2 : -5])#m
print(a [2 : -5 : 2])#m
print(a [ : 0 : -1])#0aR<space>ama
print(a [-5 : 0 : -2])#aa

B) Write  a  program  to  concatenate  two  strings  separated  by  space  but  swap  first  two
...
print("Result:", result)
'''
C) Write  a  program  to  print  first  two  and  the  last  two  characters  of  the  string
...
D) Write  a  program  to  print  characters  of  the  string  in  forward  and  reverse  directions  without  slice
...
E) Write  a  program  to  print  characters  at  even  and  odd  indexes  without  slice
...
2)  i        a[i]       a[i + 1]          out
   ...
   -------------------------------------------------------
What  is  the  difference  between  a[i]   and  a[i]   and  a[i + 1] ?  --->  a[i]  is  ith  char  of  string  and  a[i + 1]  is  (i + 1)th  char  of  string
#Program
...
G) Write  a  program  to  merge  two  strings  to  form  a  new  string
...
H) Write  a  program  to  remove  duplicate  characters  of  the  string  without  using  set
...
print(len(' '))#1
print(len('A2#'))#3
print(len(3456))#Error because of int
print('Sec'. len())#Error not valid


'''
What  does  len(string)  do  ?  --->  Returns  number  of  characters  in  the  string
'''
J) chr()  function  demo  program
print(chr(65))#A
print(chr(90))#Z
print(chr(97))#a
print(chr(122))#z
...
M) Modify  following  program  with  walrus  operator
...
while (index := a.index('is', index)) >= 0: 
    print(index)
    index += 1  
print("End")
