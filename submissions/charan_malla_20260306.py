...
print(a [-6 : -1]) #a[-6:-1:1] string from indexes -6 to -1 in steps of 1 i.e. ma<space>Rao
...
print(a [-3 : -1]) #a[-3:-1:1] string from indexes -3 to -1 in steps of 1 i.e. Rao
...
print(a [ : 0 : -1]) #a[-1:-0:-1] string from indexes -1 to 0 in steps of -1 i.e. oaR<space>amaR
