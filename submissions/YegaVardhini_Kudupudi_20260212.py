...
print(int(3 + 4j))  # Error /-1
print(int('25.4'))  # 25
print(int('Ten'))   # Error cause it is not a number
...
print(float('Ten')) # Error cause convert it into an integer
...
print(complex('3')) # 3+0j
print(complex('3.8')) # 3.8+0j
print(complex(3 , '4'))  # Error cause arg2 cannot be a string
print(complex('3' , 4))  # Error cause arg2 cannot be mentioned if arg1 is string
print(complex('3' , '4')) # Error cause arg2 cannot be mentioned if arg1 is string
