...
def  f1(x):
	print('Single  argument  function  : ' , x)#'Single  argument  function  : ' , 10 20 30
def  f1(x , y):
	print('Two  argument  function : ' , x , y)#Error
def  f1(x , y , z):
	print('Three  argument  function : ' , x , y , z)#Error
f1(10 , 20 , 30)
f1(40 , 50)  
f1(60)  
f1()
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))# (a,reverse = True )
print(sorted(a , rev = True))#sorted(a, reverse=True)
print(25 , 10.8 , 'Hyd' , separator = '\t')#print(25, 10.8, 'Hyd', sep='\t')
print(25 , 10.8 , 'Hyd' , endofline = '\t')#print(25, 10.8, 'Hyd', end='\t')
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')#print(25, 10.8, 'Hyd', sep='\t', end='\t')