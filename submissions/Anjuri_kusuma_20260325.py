...
def  f1(z):
	print('3rd  function : ' , z)  #only this is printed
f1(z = 10)
f1(y = 20)
f1(x = 30)
---------------------------------------------------------
...
----------------------------------------------------------------
 # Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d):  #after default argument there cannot be non-default argument
	pass
