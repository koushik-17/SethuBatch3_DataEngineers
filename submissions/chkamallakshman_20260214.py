...
print(*a[2 : 5])                     Hyd True (3+4j)
 a[2] = 'Sec'                             Error bcz Tuples are immutable 
a . append('Sec')                   Error bcz Tuples are immutable 
a . remove('Hyd')                   Error bcz Tuples are immutable b =  10 , 20 , 30 
print(b)                                     (10 ,  20 , 30)
