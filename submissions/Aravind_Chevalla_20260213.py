...
print(id(a)) address of range objecta
print(len(a)) 8
print(*a[2 : 7] , sep = ' , ') 2,3,4,5,6
print(*a[ : : -1]) index  -1 to -len+1 with size 1
a[4] = 32 
print(a * 2) error
...
#  Find  outputs  (Home  work)
r = range(10 ,  17 , 3)
a , b , c = r   range(10,17,3)
print(a , b , c) (10,17,3)
r = range(3)   
x , y = r   range(0,3,1)
p , q  , r , s = r  range(0,3,1)
a , b , c = *r   0 1 2 
m = r  
print(id(r)) address of range r
print(id(m)) address of range r
