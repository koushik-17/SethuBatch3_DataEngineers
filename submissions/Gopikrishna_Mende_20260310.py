...
b = [4 , 5 , 6]
print(a , id(a)) #[1,2,3], address of object a
a  = a + b #a=a+b [1,2,3,4,5,6]
print(a , id(a)) # [1,2,3,4,5,6], address of new list object a
...
*p , q = list
print('p : ' , p)  # p:[25,10.8,'Hyd'], q: True
print('q : ' , q) # q: True
...
del  a # Deletes  the  entire  list  object  a
print(a) #Error
# ================================================================
...
while b in a:
    a.remove(b)
print("List after removing all occurrences of {}: {}".format(b, a))
# ==============================================================
