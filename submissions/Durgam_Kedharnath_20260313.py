...
a = [[10 , 20] , [30 , 40 ,  50] , [60 , 70 , 80 , 90]]
print('Nested list  with  print function') # for i in a:
                                                 print(i)
print(???)
...
print('Elements  in  the  form   of  matrix   without  using  indexes') # for i in a:
                                                                               print(*i)    
...
print()
for  x , y ,  z  in   a:
	print(x , y , z , sep = '...') # 10...20...30<nextline>40...50...60<nextline>60...70...80
...
for  x , y  in  a:
	print(x , y ,	sep = '...') # Error more than two values
