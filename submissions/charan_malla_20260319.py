...
print(How  to  print  value  25  in  dict  'a') # Error, no key 25 in a
...
b = {**a} # unpacks dictionary to form a new dictionary with same key : value pairs of 'a'
print(b) # {10 : 'Rama' , 20 : 'Sita' , 15 : 'Rajesh' , 18 : 'Kiran'}
print(a  is  b) # False, 'a' and 'b' both points to different dictionaries 
print(a  ==  b) # True , 'a' and 'b' both contains same values
c = a 
print(a  is   c) # True
print(a  ==  c) # True  
...
a = {10 : 20 , 30 : 40}
b = {30 : 50 , 10 : 60}
print(a + b) # Error , dictionaries cannot concatenated with "+" operator
c = {**a , **b} # unpacks dictionary to form a new dictionary 
print(c) # # {10 : 60 , 30 : 50 }
d = a | b # concatenation
print(d) # {10 : 60 , 30 : 50 }
