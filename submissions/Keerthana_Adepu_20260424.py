...
class   c4:
	def  __iter__(self):
		...
		return   self # __iter__() method can only return an iterator
# End  of  the  class
itr = c4()
for  x  in   itr:
	print(x)
...
class   c5:
	def  __iter__(self):
		print('__iter__  method ') # __iter__() method can only return an iterator
# End  of  the  class
itr = c5()
for  x  in   itr:
	print(x)
...
# End  of  the  class
a  =  c6()
print(dir(c6)) # [iter , next , environment variables]
for  x  in  a: # error , for loop can only iterate through iterables and c6 class is not an iterable because it does not have __iter__() method
        print(x)
while  True:
	print(next(a)) # error , next() function can only iterate through iterator and c6 class is not an iterator because it does not have __next__() method  
a . next()
...
2) 1st  input  --->  'Hyd is green city'
    2nd  input ---> 'Hyd'
    What  are  the  outputs  ---> Hyd is green city starts with city
