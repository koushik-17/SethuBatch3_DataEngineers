...
print(range(4) | range(5)) # error we never concatenate range
...
print(z) # 34
25 = a # error we cannot assign object to reference
a + b = x + y # error
...
print(id(b)) # address of object 25, same as previous address
print(id(c)) # address of object 25, same as previous address
...
# Find outputs (Home work)
a , b , c = 3 , 4 , 5
a *= b + c  # a*(b+c)=3*(4+5)=3*9=27 
print(a) # 27


# Find outputs (Home work)
a = 20
a %= 3 + 2 * 4  # 20%(3+2*4)=20%(11)=9
print(a) # 9
...
print(math . pow(-2 , -3)) # -1/8=-0.125
print(math . pow(10 , -2)) =0.01
print(math . pow(4 , math . pow(3 , 2))) # 4**9=262144.0
...
print(sqrt(49)) # error it is not defined
...
print(fabs(-25)) # error it is not defined
...
print(floor(3.5)) # error it is not defined
print(ceil(3.5)) # error it is not defined
