...
a = 35 
print(id(a))  # differrent Address of Obj a
...
print(a)     # 25.7
a = 35.6
print(id(a)) # different Address obj a
print(a)     # 35.6
b = True
print(id(b)) # Address of obj a
b = False
print(id(b)) # Address of obj a False
c = None
...
print((25, 10.8, 'Hyd', True) * 3) # (25,10.8,'Hyd',True,25,10.8,'Hyd',True)
