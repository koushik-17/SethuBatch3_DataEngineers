...
print(a [ : ])         #Rama Rao
print(a [ : : -1])     #oaR amaR    
print(a [ : : -2])  #oRaa  #a[-1 : -9 : -2]  --->  string  from  indexes  -1  to  -8  in  steps  of  -2  i.e.  oRaa
print(a [ -2 : : -2])   #a mR
print(a [2 : 8])        #ma Rao
print(a [2 : 8 : -1])   #''
print(a [ : -6 : -1])   #oaR a
...
#printing a string character using indexs
s = input("Enter a string: ")
# Forward direction
for i in range(0, len(s)):
    print("Character at index", i+1, ":", s[i])
print()
# Reverse direction
