...
print(a , b , c , sep = '---') # 25---10.8---Hyd
print(a , b , c , sep = '\n') # 25<next line>10.8<nextline>Hyd
print(a , b , c) # 25 10.8 'Hyd'
print(a , b , c , separator = ':') #ERROR because seperator is not a keyword
...
print('%s'  %a) # Hyd
print('%s' , a) # %s Hyd
print('%s'  a) # ERROR because before it should be either % or comma
print('%s' , %a) # ERROR because before it should be either % or comma
print(a)  # Hyd
...
print('%s'  a) # ERROR because before it should be either % or comma
print('%s' , %a) # ERROR because before it should be either % or comma
print('%l'  %a) # ERROR because %l is invalid format
print(a) # [10 , 20 , 30 , 40]
...
print('%d    %g      %s'   a , b , c) # ERROR because it should be either % or comma
print('%d    %g    %s'  ,  %(a , b , c)) # ERROR because it should be either % or comma
print('%d    %g    %s'    %a%b%c) # ERROR syntax is not in format
...
print(F'{x =}  \t   {y =}   \t  {z =}') # ERROR because x,y,z are not defined
