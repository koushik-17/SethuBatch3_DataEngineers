...
'''
import Puppala_PavanSreeRam_20260407 as psr
...
from Puppala_PavanSreeRam_20260407 import  student
s = student()
print(s . __dict__) = {}
s . get()
print(s . __dict__) = {'rlno':25 , 'name':'Rama Rao' , 'gender': 'male' , 'sub1':52,'sub2':48,'sub3':55}
s . compute()
print(s . __dict__) =  {'rlno':25 , 'name':'Rama Rao' , 'gender': 'male' , 'sub1':52,'sub2':48,'sub3':55,'total':23,'avg':45,'results':'Grade'}
