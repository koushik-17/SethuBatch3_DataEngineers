...
print(range(4) | range(5))     #error | does not work on range objects.

print([10 , 20]  |  [30 , 20])     #error | does not work on lists.
...
print(10.5 // 2)     #prev  integer(5.2)     =5.0
print(10 // 3)     #prev  integer(3.3)      =3
print(10.0 // 3)     #prev  integer3.3)     =3.0
print(8.5 // 3)     #pr6ev  integer(2.8)    =2.0
print(18 // 4)     #prev  integer(4.5)     =4
print(-18 // 4) # Floor means go down (more negative). -5
print(-(18 // 4))  #  -4
...
# Find outputs (Home work)
a = b = c = 25
print(id(a))      #object of the address 25
print(id(b))     #object of the address 25
print(id(c))     #object of the address 25
...
m = range(5)
n = range(5)
print(m == n)  #False  # Membership operators demo program (Home work)
list = [10 , 20 , 15 , 12 , 18]
...
print(fabs(-25))     #error import math
...
print(floor(3.5))  # error import math
print(ceil(3.5))  # error import math 
