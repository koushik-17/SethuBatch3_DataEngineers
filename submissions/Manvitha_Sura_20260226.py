...
if (a+b)>c and (b+c)>a and (c+a)>b:
    if(a==b and b==c):
        ...
        area1=math.sqrt(3)/4*a**2
        print(f'Area: {area1:.2f}')
    elif(a==b or a==c or b==c and not a==b==c):
        print('Isosceles triangle')
        iperimeter=a+b+c
        print('Perimeter:', iperimeter)
    else:
...
if a!=0:
    ...
    if(d>0):
        ...
        r4=(-b)/(2*a)
        r5=(math.sqrt(-d))/(2*a)
        print(f'Root 1:{r4} + {r5}j')
        print(f'Root 2:{r4} - {r5}j')
'''
...
match  i:
	case  1:
		print('One')
	case  _:        #anonymous object must be written at the end
...
match  m:
	...
	case  _:  
		print('Hello')
	case  _:    #there can only be one anonymous object and only at the end
		print('Bye')
print('End')
