...
# a[3] = 'Sec'    # Error due to 'tuple' object does not support item assignment
a[3 : 6] = 60 , 70 , 80   # Not executed


a = (1 , 2 , 3)
b = (4 , 5 , 6)
print(a , id(a))      # (1, 2, 3)  address of 'a' object
a += b
print(a , id(a))      # (1, 2, 3, 4, 5, 6) address of new 'a' object
...
print(a)                 # Not executed but it gives (10,[70, 30, 40], 50, 60)
