...
class   D(C):
	def   m1(self):
		...
		super(D , D) . m1()  # error , because 2nd argument should be self for this case
# End  of  the  class
...
c . color()
c . height()
c . m1() # error , no classes have the method m1()
'''
Child Qualification
Mother Color
Father Height
...
# Identify  Error
class  c1(c1): # error , because c1 class is not fully defined yet , cannot inherit itself
	     pass
...
# Identify  Error
class   c1(c2): # error , because c2 class is not fully defined , cannot be inherited before it is defined
	pass
class  c2(c1):
	pass
...
class    parent:
	...
	def    m2(cls):
		...
		print(self . a) # error , classmethod has no argument self
	@staticmethod
	def   m3():
...
class  child(parent):
	...
	def   m2(cls):
		...
		cls . m2()  # error , infinite recursion
		self . m2() # error , classmethod has no argument self 
	...
	def   m3():
		...
		super(child , self) # How  to  call  m3()  method  of  parent  class  in   another  way
		super() . m3() # error , because super() function must have 2 arguments in a staticmethod
		self . m3() # error , staticmethod has no argument self  
		cls . m3() # error , staticmethod has no argument cls
...
class   child(father , mother , uncle):
	def  m1(self):
		...
		super(uncle , self) . m1() # error , no m1() method in uncle class
# End of the class
print(child . __mro__)  
c = child()
...
class  D:
	def m1(self):
		super() . m1() # error , no method m1() in parent class
		print('class D method')  
class  X(A , B):
        def m1(self):
                super() . m1()  
