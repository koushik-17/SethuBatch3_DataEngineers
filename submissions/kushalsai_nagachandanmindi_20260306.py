...
print("Starting at even indexes :", even)
print("Starting at odd indexes :", odd)

#Output:

Enter any string: Rama Rao
Starting at even indexes : Rm a
Starting at odd indexes : aaRo
...
'''
# Program:
a = input("Enter any string with alternative characters and digits : ")
...
# Output:
Enter any string  with alternative characters and digits : A4B3C2$5
AAAABBBCC$$$$$

Enter any string  with alternative characters and digits :HYD
...
print("String after removing duplicates:", out)

#Output:

Enter any string: RAMA RAO
String after removing duplicates: RAM O
...
try:
    ...
    print("Please enter string with alternative char and digit")

# Output:
Enter any string with alternative characters and digits : A4M3Z5D2
Result: AEMPZ_DF

Enter any string with alternative characters and digits : HYD
Please enter string with alternative char and digit
