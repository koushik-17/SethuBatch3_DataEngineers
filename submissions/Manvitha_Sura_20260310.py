...
print(a + 5)  #error-sequence cant be added with non seq  
print(a + '5')  #error-2 diff sequences
print([10 , 20] + (30 , 40)) #error-2 diff sequences
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list  #there cant be 2 * objects
...
try:
	...
	list . remove(25)  #except suite is executed
except:
...
# Identify  error (Home  work)
a = [25 , 10.8 ,  'Hyd' ,  True]  #different types of elements cant be sorted
a . sort()  
