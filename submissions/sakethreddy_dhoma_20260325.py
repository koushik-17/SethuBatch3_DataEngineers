...
def   f1(a  , b , *):  
        pass
# Error star is not permitted at the end of arguments and atleast one argument should be after star
...
f1(a = 70 , b = 80 , c = 90)  # Error Keywords arguments passed in the place of  Positional-only arguments.
f1(a = 100 , b = 110 , 120)  # Error  Positional arguments after the Keywords arguments.
f1(a = 130 , 140 , c = 150)  # Error  Positional arguments after the Keywords arguments.
f1(160 , b = 170 , 180)
f1(190 , b = 200 , c = 210)
...
print(add(c = 100 , d = 200 , 300 , 400))  # Error due to positional argument after keyword argument 
