...
print(t . _Test__y) # Test How  to  print   variable  'y'
print(t . __y) # error 
...
c = c1() # another c1() object with name c is created , Object at address 3000 is lost
...
class   c1:
	def  __del__(self , x):
		print('destructor : ' ,  x) 
a = c1() # error , __del__ cannot have any other arguments except self
