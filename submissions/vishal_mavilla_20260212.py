...
print(int(0XA7B9)) # 10 * 16 ^ 3 + 7 * 16 ^ 2 + 11 * 16 ^ 1 + 9 * 16 ^ 0 =4456
print(0XA7B9) # 10 * 16 ^ 3 + 7 * 16 ^ 2 + 11 * 16 ^ 1 + 9 * 16 ^ 0 =4456
print(int(3 + 4j)) # 3
print(int('25.4')) #25
print(int('Ten')) # error
'''
...
6) Is complex('3' , 4) valid ? ---> No becoz 2nd argument is not permitted when 1st
...
print(complex('3' , 4)) # error because the second argument is not applicable
print(complex('3' , '4')) # error because the second argument is not applicable
print(complex('Ten')) # error because of letters
