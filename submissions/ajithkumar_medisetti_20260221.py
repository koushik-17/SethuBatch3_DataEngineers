...
print(keyword . kwlist) # Reserved Key Words
...
print(kwlist) # Error Because  kwlist undefined without keyword
...
cyb = 10.8
print(eval('cyb')) # 10.8
print(eval(cyb)) # Error Because eval(Arg) must be a String
...
x = eval(input('Enter  any  input  :  ')) # 42
print(type(x)) # <class 'int'>
print(x) # 42


# What  is  a  better  approach  to  read  string  input ?
a = input('Enter  any  string  :  ') # Ajith
print(len(a)) # 5
print(a) # Ajith
b = eval(input('Enter   any  string  : ')) # Medisetti
print(len(b)) # 9
print(b) # Medisetti 