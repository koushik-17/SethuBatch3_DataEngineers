...
import  re
s1 = input('Enter Mobile Number : ')
m  = re . fullmatch('(0|[+]91)?[6789][0-9]{9}', s1)
if  m:
...
'''
import  re
s1 = input('Enter a vehicle Number : ')
m  = re . fullmatch('(TS|Ts|tS|ts)([0][1-9]|[1][0-9]|[2][0-9])[a-zA-Z]{2}[0-9]{4}', s1)
if  m:
...
What  is  the  regular  expression  for  the  above  rules ?  --->(0?[1-9]|[1][0-9]|2[0-9]|3[01])(0?[1-9]|1[0-2])[0-9]{4}
'''
import  re
s1 = input('Enter a vehicle Number : ')
m  = re . fullmatch('(0?[1-9]|[1][0-9]|2[0-9]|3[01])(0?[1-9]|1[0-2])[0-9]{4}', s1)
if  m:
        print('Valid date')
else:
        print('Invalid date')
...
import  re
s1 = input('Enter address: ')
m  = re . fullmatch('[A-Za-z ]+,[ ]*[A-Za-z ]+,[ ]*[A-Za-z ]+ - [0-9]{6}', s1)
if  m:
        print('Valid address')
else:
...
What  is  the  regular  expression  for  the  above  rules ?  --->[456][0-9]{3}[[-][0-9]{4}]{3}
'''
import  re
s1 = input('Enter a Number : ')
m  = re . fullmatch('[456][0-9]{3}[[-][0-9]{4}]{3}', s1)
if  m:
