...
results=prime_divisors(n)
print(F'prime divisors of {n} : {results}')
print(F'Number of prime divisors of {n} : {len(results)}')

'''
output
Enter Number : 30
prime divisors of 30 : [2, 3, 5]
Number of prime divisors of 30 : 3
Enter Number : 84
prime divisors of 84 : [2, 3, 7]
Number of prime divisors of 84 : 3
Enter Number : 49
prime divisors of 49 : [7]
Number of prime divisors of 49 : 1
'''
...
f1(70 , 80 , c = 90)#error due to two positional arguments
f1(70 , 80 , 90)#error due to three positional arguments
f1(c = 15 , b = 25 , 35)#error due to postional arguments follows keyword arguments


# Identify error (Home  work)
def   f1(a  , b , *):# '*' cannot be at end 
        pass
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c):'/' cannot be starting argument aleast one positional argument required before '/'
        pass
def   f2(a , b , c , *):'*'  cannot be ending argument aleast one keyword argument required after '*'
        pass
		
		
# Identify  error  (Home  work)
def  f4(* , a , b , c , /):#'/' must be before of '*'
...
f1([10 , 20] , (30 , 40 , 50) , {60 , 70 , 80 , 90})#([10, 20], (30, 40, 50), {80, 90, 60, 70}) <nextline> <class 'tuple'> <nextline> 3
...
print(concat('Python', 'Is', 'A', 'Great', 'Language'))#Python<space>Is<space>A<sapce>Great<space>Language
print(concat())#empty
...
def    f5(a , *b , c):#
        pass
def   f6( * , a , *b , c):# error * twice
       pass
def   f7(a , *b , c ,  /):# error / after * 
       pass
...
def   disp(**a):
	...
	print()
# End  of  the  function
disp(RollNo = 10 , StudName = 'Rama  Rao')#Results <nextline> <class 'dict'> <nextline> {'RollNo': 10, 'StudName': 'Rama  Rao'}
disp(EmpNo = 25 , EmpName = 'Sita' , Salary = 10000.0)#Results <nextline> <class 'dict'> <nextline> {'EmpNo': 25, 'EmpName': 'Sita', 'Salary': 10000.0}
disp(AcNo = 30 , CustName = 'Kiran' , Balance = 20000.0 , Gender = 'm')#Results <nextline> <class 'dict'> <nextline> {'AcNo': 30, 'CustName': 'Kiran', 'Balance': 20000.0, 'Gender': 'm'}
...
def   f2(**a):
	...
	print(a)
# End  of  the  function
f1(25 , 10.8 , 'Hyd' , True)#class 'typle' <nextline> (25,10.8,'Hyd',True)
print()#<nextline> Empty
