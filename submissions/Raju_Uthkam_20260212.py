...
print(float(0B1010101)) #85 1*2^6+0*2^5+1*2^4+0*2^3+1*2^2+0*2^1+1*2^0 = 85
print(float(0O6247)) #512*6+64*2+8*4+1*7 = 3239
print(float(0XA7B9)) #10*4096+7*256+11*16+9*1 = 42937
#print(float(3 + 4j)) #Error
#print(float('Ten')) #Error could not convert string into float
...
#print(complex('3' , 4))  #Error second argument can't be a int
#print(complex('3' , '4'))  #Error second argument can't be a string 
