...
print(int(3 + 4j))  -----> Error due to j
print(int('25.4'))  -----> 25
print(int('Ten'))  ------> Error due to alpha characters
...
print(float(0O6247))  ------> 3229.0
print(float(0XA7B9)) ------> 42937.0
print(float(3 + 4j))  ------> Error due to j
print(float('Ten'))  ------> Error due to alphabets in string
...
print(complex('3' , '4'))  -----> error becoz  2nd  argument  is  not  permitted  when  1st  argument  is  a  string
print(complex('Ten')) ------> Error due to Non-numeric string.
...
hex()  function
------------------
What  does  hex(x)  do ?  --->  Converts  object  'x'  to  hexa-decimal  number  where 'x'  can  be  binary / decimal / octal  number
