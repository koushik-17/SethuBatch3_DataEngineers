...
p , q , r , s , m = f1()#less values t unpack
...
a . m1(30)#Error as their are no default arguments 
a . m1()#error as their are no default arguments 
...
class   c1:
	pass
a = c1()
a . m1()#error as there is no method in the last class
...
print(a . __dict__)#{}
del   a
print(a . __dict__)#Error as whole thing is deleted