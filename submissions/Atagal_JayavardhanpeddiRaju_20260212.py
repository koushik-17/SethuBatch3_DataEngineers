...
print(complex('3'))#3+0j
print(complex('3.8'))#3.8+0j
print(complex(3 , '4')) #error second number is string 
print(complex('3' , 4))  #error due to first number is string 
print(complex('3' , '4')) #error due to both are string 
print(complex('Ten')) #error due to string
...
print(oct(195))  #0o141
print(oct(0B10101110010)) 0o2786
# hex()  function  demo  program
print(hex(25))  #0x37
print(hex(0B10101111010111)) ox3D07
