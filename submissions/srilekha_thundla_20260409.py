...
# a . __init__(3.8  , 4.6)
# print('a  :  ' , a)# 3.8 / 4.6
# # g = Rat(nr1 = 9 , 5)# error because after keyword argument positional argument is not permitted
# h = Rat(nr = 9 , dr = 5)# error such gtype variables are not there
...
# e = Date(dd = 30 , mm = 4 , yy = 2022)#error such type variable are not there in class
# f = Date(dd1 = 26 , mm1 = 8 , 2023)# error because after keyword argument positional argument is not permitted
...
# End  of  class
# a = c1()#error because c1 class is not there c2 class discarded
# b = c2()#error because c2 class is not there c2 class discarded
# print(b)#error because c1 class is not there c2 class discarded
# print(b . __init__())#error because c1 class is not there c2 class discarded
...
# del  a . x
# del  b . y
# print(a . __dict__)#error because deleted a obje
# print(b . __dict__)#error because deleted b obje
# print(a . x)#error because deleted a obje
# print(b . y)#error because deleted b obje
