...
# x . m3() # Error as 'parent' object has no attribute 'm3'
x = child()
...
# 60
print(c . add(10 , 20))
# ERROR: TypeError: child.add() missing 1 required positional argument: 'z'
# Reason: child.add() expects 3 arguments besides self.
...
class  c5(c1):
	def  _init_(slef):
		print('c1  class  constructor')
# End  of  the  class
# c1() # Error as can't instantiate abstract class c1 with abstract method m1
c2()
# OK, object is created
c3()
# OK, object is created
c4()
# OK, object is created
# c5() # Error as can't instantiate abstract class c5 with abstract method m1
