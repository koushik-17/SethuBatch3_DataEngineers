...
#print(range(4) | range(5)) #error-range doesn't support duplicates
...
print(-(18 // 4))  #  Tricky Tricky prev  integer(-4.5)= -4
#============================================================================================================================================================
# Find outputs
#print(7 / 0) #error-not divisible
#print(7 // 0) #error-not divisible
#print(7 % 0) #error-not divisible
#==============================================================================================================================================
# ** operator demo program
...
print(4 ** 3 ** 2) #3**2=9 --->4**9=262144
print(3 + 4 * 5 - 32 / 2 ** 3) #2 ** 3 = 8-->4 * 5 = 20-->32 / 8 = 4.0-->3 + 20 = 23-->23 - 4.0 = 19.0
#=====================================================================================================================================================
...
z = x + y * 6
print(z) #34
#25 = a error-ref should be on left side always not obj
#a + b = x + y # error
#=========================================================================================================================================================
# Find outputs (Home work)
a = b = c = 25
...
#print(math . sqrt(3+4j))#error-there should be real number for squrt
print(math . sqrt(math . sqrt(256)))#4.0
print(math . sqrt(math . pow(3 , 4)))#9.0
#print(math . sqrt(-16))
#print(sqrt(49))error-math is not def here
#=====================================================================================================================================================
...
#print(fabs(-25))#error math not def
#=====================================================================================================================================================
...
#print(floor(3.5))#error-math not def here
#print(ceil(3.5))#error-math not def
