...
print(a := 25) # 25
print(a = 25) # Error 
print(a)     # Error a is not not assigned
print(a := 6 + 7) # 13
print(a)          # 13
print((a := 6) + 7) # Error invalid syntax
print(a)           # Error a is not assigned or defined the value
print((a = 6) + 7) # Error 
...
if  b := 0:
	...
	print('Sec : ' , b) # Sec : 0
if  c = 0:
	print('Hyd')   # Error in if condition u have to give logical operations either True or False
else:
	print('Sec')
...
print(a)  # (10, 20, 15, 18)
print(a[0]) # 10
del  a[2] # tuple cannot add or delete the elements tuple is immutable
del  a # tuple cannot add or delete the elements tuple is immutable
print(a)  # (10, 20, 15, 18)
print(a[0]) # 10
