...
def   f2 (fun): # fun is None
	print('f2  function')
	#fun() # Error, None cannot callable
	print('Back  to  f2  function')
# end of the function
print('Begin')
f2(f1())
...
fun() 
print('Bye')
#inner() # Error, inner() function cannot be called directly
...
#print(inner(10 , 3)) # Error, inner function cannot called directly
