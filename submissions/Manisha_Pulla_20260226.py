...
if (a == b and b != c) or (a == c and a != b) or (b == c and b != a):
    print('Perimeter of an isoscles triangle: ',(a+b+c))
if a!=b and b!=c and a!=c:
    print('Area of Scalene traingle: ',math.sqrt(s*(s-a)*(s-b)*(s-c)))
    print('Perimeter of scalene traingle: ',(a+b+c))
...
#Output:
Hello until condition is False
Bye
