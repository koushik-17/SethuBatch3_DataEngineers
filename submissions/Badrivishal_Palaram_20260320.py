...
dict()  function
------------------
1) What  is  the  argument  of  dict()  function ?  --->Nested  sequence  such  as  list  of  tuples , list  of  lists , tup…
...
12) Finally  what   is  dict  'a' ?  --->  {'R' : 2 , 'A' : 3 , 'M' : 1 , 'O' : 1}
'''
...
b = {'Y' : 'Yellow', 'G' : 'Gray'}
b . update(a)
print(b)#{Y' : 'Yellow','G' , 'Green','B' , 'Blue'}
a . update(b)#error 
