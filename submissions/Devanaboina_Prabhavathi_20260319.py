...
print(a) # print("After modification:", a)
            
 print(id(a)) # print("ID after:", id(a))
...
a =  {'Empno'  :  25,  'Ename'  :  'Rama  Rao'  ,  'Sal'  :  1000.65  }
print(a) #a = {'Empno': 25, 'Ename': 'Rama Rao', 'Sal': 1000.65}
print("Before removing:", a) # 
How  to  remove  'Sal' : 1000.65  from  dictionary 
print(a) # a.pop('sal')
...
b = eval(a)
print(b) # a = eval{10: 'A', 20: 'B', 15: 'C' , 20 : 'D'}
...
for i in range(n):
    ...
    a[name] = salary   # Add to dictionary
print("\nEmployee dictionary:")
print(a)
