...
for  x  in   123:
        print(x) # Error int is not iterrable
...
for  x  in  range(10 , 10):
	print(x) # No Output
for  x  in   range():
	print(x) # Error in range there should be atleast one argument
for  x  in   (25):
	print(x) # Error int is not iterrable
...
if ():
	print('Hyd')
	continue     # continue can use in loop
	print('Sec')
...
if(10 , 20 , 30):
	print('Hyd') 
	break       # break cannot use outside the loop
	print('Sec')
