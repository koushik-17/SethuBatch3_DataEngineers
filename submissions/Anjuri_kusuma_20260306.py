...
for i in range(len(n)):
    print("characters at index ",i,":",n[i])
...
'''
n=input("Enter any string with alternate character and digit : ")
new=""
for i in range(0,len(n),2):
    if n[i+1].isdigit():
        new=new+n[i]*int(n[i+1])
    else:
        print("Input should be alphabet and digit")
        break
print("Result:",new)
--------------------------------------------------------------------------------------
'''
...
out=""
for i in range(len(n)):
    if n[i]==chr and n[i+1]==ord:
        out=out+n[i]+chr(int(n[i+1]))
print(out)
----------------------------------------------------------------------------------------
'''
