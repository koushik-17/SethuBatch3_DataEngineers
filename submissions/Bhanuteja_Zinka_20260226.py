...
output 
syntax error becoz inside of cases not allowed case_
...
10) What  is  the  output  when  input  is  (25,) ?  --->Not a point Does not match 2-value pattern.
11) What  is  the  output  when  input  is  {10 : 20} ?  --->Not a point Does not match tuple pattern.
'''
