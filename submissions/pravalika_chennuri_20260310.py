...
a += b
print(a , id(a)) # [1 , 2 , 3, 4, 5, 6] address of a (same address)
...
print(a , id(a)) # [1, 2, 3] address of a
a  = a + b
print(a , id(a)) # [1, 2, 3, 4, 5, 6] address of a (different address)
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list # error only one unpack will allows
...
print(len(a)) # 4
print("How  to  print  4th  element  of  list  'a'",a[-1])
...
a = [25 , 10.8 ,  'Hyd' ,  True]
a . sort() # integer and string cannot sort
...
for i in n:
    ...
    if a == b:
        ...
        print("elements  are  in  the  list", a)
        print("times  is  first  element  repeated ", b)
        break
else:
