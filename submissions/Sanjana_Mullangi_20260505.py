...
x . m1()
x . m2()
x . m3()  #error-not method m3 in parent class
x = child()
x . m1()
x . m2()
x . m3()
...
print(c . add(10 , 20))#error-one argument is missing and add method is not inherited as child already have same method
