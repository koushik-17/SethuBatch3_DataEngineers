...
print('Largest is :',a if a>b else b if b>c else c)
...
print('Result : 1'if a%2==0 else 'Rresult : -1' if a<0 else 'Result : 0')
...
print('Result : even number'if a%2==0 else 'Rresult : odd number')