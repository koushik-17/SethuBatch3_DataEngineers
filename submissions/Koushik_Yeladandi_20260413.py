...
[12:33 pm, 13/04/2026] +91 99482 50500: print(a + b)
[12:34 pm, 13/04/2026] +91 99482 50500: # Find  outputs
class   c1:
	def   _init_(self , y):
		self . x = y
	def    _gt_(m , n):
...
[12:33 pm, 13/04/2026] +91 99482 50500: '''
Write  a  program  to  overload  + ,   -  ,  *   and   /   operators  on  rational  class  objects
...
if b . nr != 0:
	...
	print('Division is not permitted.')
[12:33 pm, 13/04/2026] +91 99482 50500: # Is  10 + 20  a  recursion ?
class   c1:
	def  _add_(a , b):
			print(10 + 20)
a = c1()
b = c1()
print(a + b)
[12:33 pm, 13/04/2026] +91 99482 50500: # Is  x + y  a  recursion  ?  (Home  work)
class   c1:
	def  _add_(a , b):
		x = c1()
		y = c1()
...
Object  'b'   --->  
'''
[12:36 pm, 13/04/2026] +91 99482 50500: # Find  outputs  (Home work)
class   c1:
	def   _init_(self , y):
		self . x = y
	def    _ge_(m , n):
...
Object  'b'   --->  
'''
[12:37 pm, 13/04/2026] +91 99482 50500: # Find  outputs (Home  work)
class   c1:
	def   _init_(self , y):
			self . x = y
	def    _eq_(m , n):
...
print(a == b)
print(a != b)  # not (a == b)
[12:38 pm, 13/04/2026] +91 99482 50500: # Find  outputs  (Home  work)
class   c1:
	def   _init_(self , y):
			self . x = y
	def    _eq_(m , n):
...
print(a != b)
print(a == b)
[12:38 pm, 13/04/2026] +91 99482 50500: #  Is  10 > 20  a  recursion ?
class  c1:
	def   _gt_(a , b):
		print(10 > 20)
		print(a > b)
...
a < m
n < b
[12:38 pm, 13/04/2026] +91 99482 50500: # Overload  *  operator  to  multiply  two  different  class  objects
class  c1:
	def  _init_(self):
		self . empno = 25
		self . hr = 250
...
print('a + m : ' , a + m)
print(m + a)
[12:38 pm, 13/04/2026] +91 99482 50500: # Overload  +  operator  such  that  numbers  are  added  and  strings  are  joined
class  c1:
	def     _init_(self , y):
		self . x = y
	def _add_(p , q):
