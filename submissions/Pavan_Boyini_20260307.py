...
a = '15:36:48'
print(a . split(':'))   # splitting a string by using ":"
print(a)   # ['15', '36', '48']
...
print(a . split(''))   # Error because empty split
...
c = {'10' , '20' , '15' , '25' , '52'}
print(',' . join(c))    # 10,52,15,25,20
d = ['www' , 'gmail', 'com']
print('.' . join(d))  # www.gmail.com
e = [15 , 36 , 48]
print(':' . join(e))  # error because only str instances acn be joined
