...
print(range(4) | range(5))  #error concatenation is not possible for range
print([10 , 20]  |  [30 , 20])  #error pipe is not permitted for list


#  //  operator  demo  program    #(// gives previous quotient)
print(9 // 2)   #previous integer - 4     #(integer // integer gives integer quotient)  
print(9.0 // 2) #previous integer - 4.0   #(float // integer gives float quotient)
print(9 // 2.0) #previous integer - 4.0
print(9.0 // 2.0) #previous integer - 4.0
print(10.5 // 2)  #previous integer - 5.0
print(10 // 3)  #previous integer - 3
...
z = x + y * 6
print(z)  # 34
25 = a   # error becoz int is not consider as reference 
a + b = x + y  #error  
...
print(id(c))  #same address  , becoz a,b,c refers same object 25
...
import  math
print(math . fabs(-10))  # 10.0  it converts negative value to positive value, positive values are same
