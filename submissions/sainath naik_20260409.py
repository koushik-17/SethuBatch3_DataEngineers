...
# End  of  class
a = c1() # error , whenever __init__() returns a non-None, object creation fails
...
11.#  How  to  use  both  the  classes (i.e.  c1  of  prog9a  and  c1  of  current  program)
