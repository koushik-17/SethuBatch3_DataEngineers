...
# End  of  the  function
disp(25 , 'Rama Rao' , 10000.0) #Emp  Number : {empno:4}  \t  Emp  Name : {ename:15}  \t  Salary : {sal}
...
if  n == 0:
  ...
  out+=words(n//10000000,'Crores') if n//10000000 else '' #How  to  obtain  crores  part  from  the  number  and  call  words()  function
  out+=words(n//100000%100,'Lakhs') if n//100000%100 else ''#      How  to  obtain  lakhs  part  from  the  number  and  call  words()  function
  out+=words(n//1000%100,'Thousand') if n//1000%100 else ''#      How  to  obtain  thousands  part  from  the  number  and  call  words()  function
  out+=words(n//100%10,'Hunderd') if n//100%10 else ''#     How  to  obtain  hundreds  part  from  the  number  and  call  words()  function
  out+=words(n%100,'') if n%100 else ''#      How  to  obtain  last  two  digits  of  the  number  and  call  words()  function
print(out)