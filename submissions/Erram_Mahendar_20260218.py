...
a = 35
print(id(a)) # Different address (suppose 2000)
...
a = 25.7
print(id(a)) # Some address (3000)
print(a) # 25.7


a = 35.6
print(id(a)) # Different address (4000)
print(a) # 35.6


b = True
print(id(b)) # Some fixed address


b = False
print(id(b)) # Different fixed address


c = None
print(id(c)) # Some fixed address
...
c = 'Hyd'
d = 'Hyd'
print(c is d) # True (string reused)
...
e = (10 , 20 , 15 , 18)
f = (10 , 20 , 15 , 18)
print(e is f) # True (tuple reused)


g = {10 , 20 , 15 , 18}
h = {10 , 20 , 15 , 18}
print(g is h) # False (different sets)
