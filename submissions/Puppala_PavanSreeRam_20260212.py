...
print(int(3 + 4j)) = Error – Cannot Convert Complex To Int Directly
print(int('25.4'))  = Error – Coz String Contains Decimal Value 
print(int('Ten')) = Error – String Is Not Numeric 
...
print(float('Ten')) = Error – String Is Not Turmeric
...
print(complex('3' , 4)) = Error  -If first argument is string, second argument is not allowed
print(complex('3' , '4')) = Error – Both Cannot Be Strings
print(complex('Ten')) = Error – String Is Not Turmeric
