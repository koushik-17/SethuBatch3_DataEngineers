...
print(dict(e)) # Error , the inner sequence should contain 2 elements only
f = [[10] , [20] , [30]]
print(dict(f)) # Error , the inner sequence should contain 2 elements only
print(dict([10 , 20])) # {10 : 20}
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g)) # {10 : [20 , 30] , 40 : [50 , 60] , 70 : [80 , 90]} 
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h)) # Error , keys cannot be mutable object
...
c = sorted(a . values())
print(c) # ['Blue' , 'Green' , 'Red' , 'Yellow' , 'White' ]
d = sorted(a . items())
print(d) # [(5 , 'White') , (10 , 'Red') , (15 , 'Blue') , (20 , 'Green')]
...
a . clear() # clears key:value pairs of dictionary
print(a) # {}
...
b = a . copy() # copies key : value pairs 
