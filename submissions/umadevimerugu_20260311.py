...
try:
	while  True:
		print(i:=a . index(b , i + 1))
		#i = a . index(15 , i + 1)
except:
	print(F'{b}  is  found  {a . count(b)}  times ')
################################################################################################3
'''
Most   tricky  program
...
'''
--------------------code--------------
a=eval(input("enter the list to search:"))
...
try:
    for i in a:
        if i in a:
            x=b.index(i,x+1)
    print("True a is subset of b")
except:
    print("False a is not subset of b ")    
################################################################################################3
