...
a[4] = 32                       #10 15 20 25 32 35 40 45
print(a * 2)                    #20 30 40 50 64 70 80 90
...
print(a)
print(a[2 : 5]) #[ 'Sec' , True , 3 + 4j , None , 'Hyd']
...
print(id(a))    #depends on allocation
a = [25]
print(a , id(a))#[25] depends on allocation
print(a * a)    #error
...
#     0     1     2    3     4
a = [10 , 20 , 30 , 40 , 50]
print(a , id(a))#[10, 20, 30, 40, 50] depends on allocation
a[1 : 4] = [60 , 70]
print(a , id(a))#[10, 60, 70, 50] depends on allocation 
a[2: 4] = [100 , 200 ,  300]
print(a , id(a)) #[10,60,100,200,300] depends on allocation
