Name-Dhruva Gupta			Subject-Python			Date-23/2/26
...
print(a , b , c , separator = ':') #error separator is nothing
...
print('%s'  a) #error
print('%s' , %a) #Error
print('%l'  %a) #error as %l not valid
print(a)#[10 , 20 , 30 , 40]
...
print('%d    %g    %s'  ,  %(a , b , c))#error
print('%d    %g    %s'    %a%b%c)#error
print('%d'    %a  ,  '%f'     %b  ,  '%s'   %c) #25 10.92700 Hyd
