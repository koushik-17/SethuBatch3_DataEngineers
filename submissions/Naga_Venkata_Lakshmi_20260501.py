...
a = c1()
b = c2()
print(issubclass(b , a)) #Error because argument one should be class name.
print(issubclass(c2 , a)) #Error because argument 2 should be class name or tuple of class names.
...
print(issubclass(c4 , [int , float , c1 , str , bool])) #Error because argument 2 shoud be class name or tuple of classnames.
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool])) #Error because second argument should be class name or tuple of class name.
