-- creating a studentdb database with a table of employees_demo
show databases;
create database studentdb;
use studentdb;

-- here creating a table below in studentdb database
...
-- Inserting values to the table employees_demo
INSERT INTO employees_demo (emp_name, department, salary, age, joining_date) VALUES
('Ajay', 'HR', 30000, 25, '2022-01-10'),
('Vijay', 'HR', 35000, 28, '2021-03-15'),
('Sanjay', 'IT', 60000, 30, '2020-07-20'),
('Pradeep', 'IT', 75000, 32, '2019-05-18'),
('Pranay', 'Finance', 50000, 29, '2021-11-25'),
('Kushal', 'Finance', 45000, 27, '2022-02-14'),
('saketh', 'IT', 80000, 35, '2018-09-10'),
('Sandeep', 'HR', 32000, 26, '2023-01-05');

-- printing out the table data using * to get all the columns
