...
a = c1()
b = c2()
print(issubclass(b , a)) #TypeError
print(issubclass(c2 , a)) #TypeError
...
print(issubclass(c4 , [int , float , c1 , str , bool])) # TypeError
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool])) # TypeError 
