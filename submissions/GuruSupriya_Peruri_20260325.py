...
'''
from GuruSupriya_Peruri_20260323  import prime
	...
	for i in range(2,n//2+1):
		if n%i==0:
			if prime(i):
				prime_div.append(i)
	return prime_div	
n=int(input('Enter any positive Integer'))#Read  input
...
def   f1(a  , b , *):
        pass    # error is there must be atleast one arg after *
...
# Identify error (Home  work)
def  f1(/ , a , b ,  c):
        pass    # error because there must be atleadt 1 arg before / 
def   f2(a , b , c , *):
        pass     # error because there must be atleadt 1 arg after *

# Identify  error  (Home  work)
def  f4(* , a , b , c , /):
	        pass      # error because first we have to define which are positional args then kA
...
f1(z = 10) #print('3rd  function : ' , 10)
f1(y = 20) #print('3rd  function : ' , 20)
f1(x = 30) #print('3rd  function : ' , 30)
...
def   f1(a = 10 ,  b ,  c = 20 ,  d):
	pass  # error because kA must be after PA
...
# End  of  the  function
print(add(100 , 200)) # 330
print(add(100 , 200 , 300)) # error
print(add(100 , 200 , 300 , 400)) # error
...
disp(80 , 90) # 3-argument  function : 195
...
print(f1(3)) # [0,1,4]
print('_defaults  :  ' , f1._defaults_) # _defaults_  :  ([0,1,4],)
print(f1(4 , [10 , 20 , 15 , 18])) # [10 , 20 , 15 , 18]
print('_defaults  :  ' , f1._defaults_) # _defaults_  :  ([0,1,4],)
print(f1(5)) #  [0,1,2,4,0,1,4,9]
print('_defaults  :  ' , f1._defaults_) # _defaults_  :  ([0,1,2,4,0,1,4,9],)
print(f1(a = [100 , 200 , 300],   x = 6 )) # [100 , 200 , 300,6]
print('_defaults  :  ' , f1._defaults_) # _defaults_  :  ([0,1,2,4,0,1,4,9],) 
print(f1(6)) # [0,1,2,4,0,1,4,9,0,1,4,9,16,25]
print('_defaults  :  ' , f1._defaults_) # _defaults_  :  ([0,1,2,4,0,1,4,9,0,1,4,9,16,25],)
# Find  outputs
def   f1(a = 'Hyd' , b = []):
	a += "Sec"
	b += [1 , 2 , 3]
	...
	print('b :  ' , b)
# End of the function
print('Default Values  :  ' , f1 . _defaults_) # _defaults_  :  ('Hyd',[])
f1() # a: 'HydSec' b: '[1 , 2 , 3]'
print('Default Values  :  ' , f1 . _defaults_) # _defaults_  :  ('HydSec',[1,2,3])
f1() # a: 'HydSecSec' b: '[1 , 2 , 3,1,2,3]'
print('Default Values  :  ' , f1 . _defaults_) ## _defaults_  :  ('HydSecSec','[1 , 2 , 3,1,2,3])
f1() # a: 'HydSecSecSec' b: '[1 , 2 , 3,1,2,3,1,2,3]
...
def  concat(*a):
	return ' '.join(a) #Write  code  to  return  join  of  all  the  strings  passed  to  the  function  (1  line)
# End   of  the   function
