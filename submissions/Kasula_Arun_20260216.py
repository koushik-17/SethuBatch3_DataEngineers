...
a . append('Sec')                                      #error due to no modification
a . remove('Hyd')                                       #error due to no modification
b =  10 , 20 , 30
print(b)                                                        #(10, 20, 30)
...
print(tuple(25))                                                                           #error due to 25 is an int
...
print(id(a))                                                                          #address of  tuple of 6 elements
