...
print(a)	# (10 , 20 , 15 , 18)
# f1(a)
# print(a)	# error , becoz tuple is an immutable object. so, modifying element in tuples is not permitted
...
print(square(5))	# 25
print(square())		# 100 , becoz default value is 10

#==========================================================================================================

# Find  outputs  (Home  work)
print((lambda   x  :   x * x) (7))	# 49
print( lambda   x  :  x * x(7))		# function and hexadecimal address
print( lambda   x  :   x * x)		# function and hexadecimal address
...
print(add(3 + 4j , 5 + 6j))   # 8+20j
# print(add(10 , '20'))       # error , becoz integer and string cannot be concatenated
# print(add())                # error
print(add)                    # function and hexadecimal address
...
# lambda function can hold default values
...
print(lambda  x , y : x + y  ('Hyder'  ,  'abad'))	# returns fucntion and address
...
print(power(4.5 , 4))	# 4.5 ** 4  = 410.00
print(power())			# 3.5 ** 2  = 12.25
print(power(9))			# 81 , becoz defalut arugment of b is 2 . 9 ** 2 = 81
...
#  Find  outputs
a  =  lambda  :  'Hyd'
print(a())	# Hyd , lambda function can write without argument
print(a)	    # address and hexadecimal address
...
# when multiple statements are writeen in lambda. then it returns value from 2nd statement

#=======================================================================================================

#  Find  outputs  (Home  work)
s = 'Hyd'
print(lambda  s  :  print(s))		# type and hexadecimal address
print(lambda  x  :  print(x) (s))	# type and hexadecimal address
...
x = 20
adder3 = lambda    y  :  x + y
print(adder1(100))	# 120 , BECOZ all objects having same name. so, last object is passed to function. 
                            # remaining objects are deleted due to no reference
x = 30
...
# Hyd
# Sec
# [type of f1 and hexadecimal address , type of f2 and hexadecimal address]
...
key = 'power_3'
print(a[key])		# type and hexadecimal address
...
print(lamb(2))		# 9
print(lamb(5))		# 243
print(lamb)		    # type and hexadecimal address
# print(lamb())		# error
...
lam  = eval(3 , 4 , 5)
print(lam(2))		# 3 * 4 + 8 + 5  = 25
print(lam(2.5))		# 3 * 6.25 + 10 + 5 = 33.75
print(lam(4))		# 3 * 16 + 16 + 5 = 69
