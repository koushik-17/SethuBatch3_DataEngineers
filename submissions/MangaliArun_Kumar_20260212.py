...
print(complex(3.8 , 4.6)) # 4+5j
print(complex(3.8)) # 4+0j
print(complex(3 , 4.5)) # 3+5j
print(complex(True , False)) # 1+0j
print(complex(True)) # 1+0j
print(complex(False)) # 0+0j
print(complex(True , 4)) # 1+4j
print(complex('3')) # Error imag cannot be string
print(complex('3.8')) # Error
...
print(oct(195))  # 0o141 ? 
print(oct(0B10101110010))  # decimal1384 ?
print(oct(0xA7B9)) ?
