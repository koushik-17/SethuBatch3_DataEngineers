...
'''
'''
from primefunction import prime 
...
f1(50 , 60) # Error due to positional argument are not premitted 
f1(70 , b = 80) # Error due to positional argument are not premitted 
f1(a = 15 , 25) # Error due to positional argument are not premitted 
...
f1(a = 40 , b = 50 , c = 60)# a:40 <tab> b:50 <tab> c:30
f1(c = 100 , b = 90 , a = 80) # a:80 <tab> b:90 <tab> c:100 
f1(70 , 80 , c = 90) # Error due to positional argument are not premitted  
f1(70 , 80 , 90) # Error due to positional argument are not premitted 
f1(c = 15 , b = 25 , 35) # Error due to positional argument are not premitted 
...
def   f1(a , b , /):
        print(F'a  :  {a}  \t  b  :  {b}')
# End  of   the  function
f1(10 , 20) #Error due to postional argument  and 10, 20
f1(a = 30 ,  b = 40) # Error due to keyword arugment
f1(50 , b = 60) # Error due to '*' and  '/'
f1(a = 70 , 80) # Error due to positional argument before keyword positional argument 
...
f1(a = 70 , b = 80 , c = 90) #Error due to keyword arguments 
f1(a = 100 , b = 110 , 120) # Error due to positional arguments
f1(a = 130 , 140 , c = 150) # Error due to positional arguments 
f1(160 , b = 170 , 180) # Error due to keyword argument 
f1(190 , b = 200 , c = 210) # Error due to keyword argument
...
f1(1 , b = 2 , c = 3 , d = 4 , e = 5 , f = 6) # Error due to keyword argument 
f1(1 , 2 , 3 , 4 , 5 , f = 6) # Error due to positional argument
f1(10 , 20 , c = 30 , 40 , e = 50 , f = 60) # Error due to after keyword argument there is positional argument
f1(10 , 20 , 30 , 40 , e = 50 , f = 60) # a:10 <tab> b:20 <tab> c:30 <tab> d:40 <tab> e : 50 <tab> f:60 


# Identify error (Home  work)
def  f1(/ , a , b ,  c): # Error due to '/' before arguments 
        pass
def   f2(a , b , c , *): # Error due to '*' after arguments 
        pass
# Identify  error  (Home  work)
def  f4(* , a , b , c , /): # Error due to '*' and '/' in one argument 
	        pass
...
print(add()) # Error due to missing argument
print(add(a = 100 , 200)) # Error due to keyword argument 
print(add(100 ,  , 300)) # Error due to empty argument
print(add(100 ,  b , 300)) # Error due to second argument


# Identify  Error
def   f1(a = 10 ,  b ,  c = 20 ,  d): # Error due to keyword argument 
	pass
def   f2(b , d , a = 10 , c = 20): # Error due to positional argument 
	pass
...
print(add(c = 100 , d = 200 , 300 , 400)) # Error due to keyword argument 
print(add(100 , 200 , c = 300 , x = 400)) # Error due to x 
print(add()) # Error due to empty 
...
print(f1()) # 25 
print(f2(20)) # 20 
print(f2()) # Error due to missing argument
...
print(power(True)) # 1
def   power(b = 2 , a): # Error due to a
	pass
...
#end
disp(10 , 20 , 30) 
disp(40 , 50 , 60 , 70) # Error due to positional argument
disp(80 , 90)
'''
'''
3-argument funtion : 10 20 30
...
print(add(80 , 90)) # Error due to positional argument 
...
print(add(c = 25 , a = 43)) # Error due to insufficient argument
print(add(1 , 2 , 3)) # Error due to positional argument
def   add(a , b = 10 ,  c ,  * , d  , e = 20 , f): # Error due to c
		pass
...
f1(4 , [1 , 2 , 3]) #'x'  is   3  ,  'a'  is  [1, 2, 3] , result  is [1, 2, 3, 4]
print('__defaults__  :  ' , f1.__defaults__) # __defaults__ :([3],)
f1(9)
print('__defaults__  :  ' , f1.__defaults__) # __defaults__ ([3,9],)
f1(40 , [10 , 20 , 30]) #'x'  is   10  ,  'a'  is  [10, 20, 30] , result  is [10, 20, 30, 40]
print('__defaults__  :  ' , f1.__defaults__) # __defaults__ :([3,9],)
f1(5)
...
print(f1(4 , [10 , 20 , 15 , 18]))   # x'  is   3  ,  'a'  is default value ([1 2],) result is [10, 20, 15, 18, 0, 1, 4,9]
print('__defaults_  :  ' , f1.__defaults__) # __defaults__ : ([0,1,4],)
