...
print(int(3 + 4j)) #error we can't change complex to a int 
print(int('25.4')) #error we can't change string float to a int  
print(int('Ten'))   #error we can't change string to a int 
=====================================================================================================================================================
...
print(float(0B1010101))# 1* 2 ^ 6+ 0 * 2 ^ 5 + 1 * 2 ^ 4 + 0 * 2 ^ 3 + 1 * 2 ^ 2 + 0 * 2 ^ 1 + 0 * 2 ^ 0   85.0
...
print(complex('3'))   #3+0j
print(complex('3.8')) #3.8+0j
print(complex(3 , '4')) #error 2 arg can't be str 
print(complex('3' , 4))  #error 2 arg not permitted when 1 arg is str
print(complex('3' , '4'))  #error 2 arg can't be str
...
print(oct(195))    
print(oct(0B10101110010))  #10/101/110/010    0o2562
print(oct(0xA7B9)) # 1/010/011/110/111/001    0o123671
=======================================================================================================================================================
# hex()  function  demo  program
print(hex(25))  
print(hex(0B10101111010111)) # 0010/1011/1101/0111 0x2BD7
