...
# Identify  Error
class   c6:
        def   iter(self): # has to be __iter__
                return   reversed([10 , 20 , 15 , 18])
        def  next(self): # has to be __next__
                print('next  method')
# End  of  the  class
a  =  c6()
print(dir(c6))
...
#  object  'r'  ---> list = ['Tv 9' , 'Espn' , 'Zee Tv' , 'ETV'], index = ETV
