...
print(eval("    'hyd'   ")) # hyd                                                                                                                                                                
hyd = 'Sec' 
print(eval('hyd')) # Sec as it removes str and gives python obj. It prints python obj value as it is present
sec = '25'
print(eval('sec')) #25 as it removes str and gives python obj. It prints python obj value as it is present
print(eval(sec)) # 25
cyb = 10.8
print(eval('cyb')) # 10.8
print(eval(cyb)) # 10.8
...
x = eval(input('Enter  any  input  :  '))  # reads input, converts string into appropriate object
print(type(x)) # gives type of obj x
print(x)  # prints obj x
...
print(len(b))
print(b)
# converting input to string is better approach