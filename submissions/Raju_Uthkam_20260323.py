...
def  f2():
		print('f2  function')
f1() #f1 Funtion <nextline> f2 Funtion
...
print(add([25 , 10.8 , 'Hyd'] , [True , None , 3+4j , 'Sec'])) #[25 , 10.8 , 'Hyd' ,True , None , 3+4j , 'Sec'] list concatenation
#print(add(10 , '20')) #Error integer and string can't be concatenated 
...
f1(10 , 20 , 30) #Three agrument functiom : 10 20 30
#f1(40 , 50)   #Error
#f1(60)  #Error
#f1() Error because last function executed ig we give same function name's
...
disp('Sita' , 20000.0 , 35) ##Emp Number : 'Sita'   Emp Name : '20000.0'    Salary : 35 #we have to give in order of partial parameters
...
f1(25 , c = 10.8 , b = 'Hyd') #a : 25 <tab> b : 'Hyd' c : 10.8
#f1(a = 100 , 200 , 300)  #   Error
#f1(True , None , b = 'Hyd') #Error
#f1(10 , 20 , x = 30) #Error
#f1(10 , 20) #Error missing 1 positional argument but 2 are given
...
a = [10 , 20 , 15 , 5 , 12]
#print(sorted(reverse = True , a)) #keyword argument should not be called first 
#print(sorted(a , rev = True)) #Error there is no rev argument in sorted function 
#print(25 , 10.8 , 'Hyd' , separator = '\t') #Error there is no separator argument 
#print(25 , 10.8 , 'Hyd' , endofline = '\t') #Error there is no endofline parameter
#print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') #Error positional  agruments should be intialized first