...
# sep argument demo progrm
a,b,c = 25 ,10.8 ,'Hyd'
print(a,b,c,sep = ',') # 25,10.8,'Hyd'
print print(a , b , c , sep = '\t') # 25    10.8    'Hyd'
print(a , b , c , sep = '---') #  25---10.8---'Hyd
print(a , b , c , sep = '\n')  # 25<next line>10.8<next line>'Hyd'
print(a , b , c) # 2510.8'Hyd'
...
print('%d    %g    %s'  ,  %(a , b , c)) # Error
print('%d    %g    %s'    %a%b%c)        # Error
print('%d'    %a  ,  '%f'     %b  ,  '%s'   %c) # 25 10.92477 Hyd
