...
print(add(10 , '20'))#Error str and int cannot be concatenated

3) outputs 
def  f1():
	print('No-argument  function')#error , not permitted
def  f1(x):
	print('Single  argument  function  : ' , x)#error ,not permitted
def  f1(x , y):
	print('Two  argument  function : ' , x , y)#error ,not permitted
def  f1(x , y , z):
