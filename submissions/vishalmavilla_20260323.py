...
f1(40 , 50)   #  error there  are only 2 args
f1(60)   # error as there is only one arg
f1()  # error  as there are no args
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a))  # error the order is in reverse 
print(sorted(a , rev = True))  # error there is no rev function
print(25 , 10.8 , 'Hyd' , separator = '\t')  # error there is no seperator
print(25 , 10.8 , 'Hyd' , endofline = '\t')  # error  there is no endofline
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd')  # error there  is no correct order  