...
a=int(input("Enter a number:"))
def f1(c):
   b=["" , "One" , "Two" , "Three" , "Four" , "Five" , "Six" , "Seven" , "Eight" , "Nine" , "Ten" , "Eleven" , "Twelve" ,"Thirteen" , "Fourteen" , "Fifteen" , "Sixteen" , "Seventeen" , "Eightteen" , "Nineteen"]
   d = [""  , "" , "Twenty" , "Thirty" , "Forty" , "Fifty" , "Sixty" , "Seventy" , "Eighty" , "Ninety"]
   if c<20:
      return b[c]
   elif c>20:
     return (d[c//10]+" "+b[c%10])

c=a//10000000
print(f1(c),"Crores",sep=" ",end=" ")
e=a//100000 % 100
print(f1(e),"Lakhs",sep=" ",end=" ")
f=a//1000 % 100
print(f1(f),"Thousand",sep=" ",end=" ")
g=a//100 % 10
print(f1(g),"Hundred",sep=" ",end=" ")
h=a%100
print(f1(h))
...
a = [10 , 20 , 15 , 5 , 12]
print(sorted(reverse = True , a)) #Error due keyword argument first
print(sorted(a , rev = True)) #Error due to rev
print(25 , 10.8 , 'Hyd' , separator = '\t') #Error no seperator
print(25 , 10.8 , 'Hyd' , endofline = '\t') #Error no end of line
print(25 ,  sep = '\t' , 10.8 , end = '\t' , 'Hyd') #Error due keyword argument first