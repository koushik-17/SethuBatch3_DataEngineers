...
print(range(4) | range(5))#error due to range will not have  Duplicates
...
print(8.5 // 3)#prev  integer(2.4)=2.0
...
print(10 ** -2)#10^-2=-100
print(4 * 3 * 2)#24
print(3 + 4 * 5 - 32 / 2 ** 3)#(3+20-32/8)==>#(23-32/8)==>#(-11/8)==>#-1.6
...
print(not  '')#True
print(not  -10)#True
print(not  not  'Hyd')#error due to it has two not 

#  Find   outputs (Home work)
i = 10
i = not  i > 14
print(i)#True
print(not(6 < 4  or  9 >= 5  and  6 != 6))#error due it is has single  operand
...
print('Two');#Two
print('Three');#Three
print('Hyd')  ;   print('Sec')  ;  print('Cyb')#Hyd Sec Cyd

#pow()  function  demo  program
import  math
print(math . pow(2 , 3))  #  2 ^ 3 = 8
print(math . pow(-2 , -3))#-2^-3=-8
print(math . pow(10 , -2))#10^-2=-100
print(math . pow(4 , math . pow(3 , 2)))#4^6==>4096

# sqrt()  function  demo  program
import  math
print(math . sqrt(25))#5
print(math . sqrt(10))#2.25
print(math . sqrt(6.25))#39.06
print(math . sqrt(True))#1
print(math . sqrt(3+4j))#3+4(-1)==>3-4==>-1===>1
print(math . sqrt(math . sqrt(256)))#65536
print(math . sqrt(math . pow(3 , 4)))#81
print(math . sqrt(-16))#4
print(sqrt(49))##error due to no maths function
...
print(fabs(-25))#error due to no maths function
...
print(math . ceil(25.1))#-25
print(floor(3.5))#error due to no maths function
print(ceil(3.5))#error due to no maths function