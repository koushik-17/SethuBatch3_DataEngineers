...
a = c1()
b = c2()
print(issubclass(b , a)) # ERROR argument1 should be a class but not object.
print(issubclass(c2 , a)) # ERROR argument2 should be also a class but not object.
...
print(issubclass(c4 , [int , float , c1 , str , bool])) # ERROR argument2 should be also a class or tuple of classes
...
print(isinstance(a , [int  ,  float  ,  c3 , str  ,  bool])) # ERROR argument2 should be a class or tuple of classes