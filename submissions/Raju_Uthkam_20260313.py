...
a = input('Enter any sentence : ').split()
b = [[a[i].upper(),len(a[i])] for i in range(len(a)) ]
print(b)
...
b = eval(input('Enter any list : '))
d = max(len(a),len(b))
c = [ a[i] for i in range(d) if a[i] not in b]
print(c)
...
a = eval(input('Enter a list1 : '))
b = eval(input('enter  list2 : '))
d = [a[i]+b[j] for j in range(len(b)) for i in range(len(a))]
print(d)
...
b = input('enter  list2 : ')
c = [a[i].upper()+b[j].upper() for j in range(len(b)) for i in range(len(a))] 
print(c)
...
a = eval(input('Enter a list : '))
b = [a[i]+a[j] for j in a[i] for i in range(len(a)) ]
print(b)
