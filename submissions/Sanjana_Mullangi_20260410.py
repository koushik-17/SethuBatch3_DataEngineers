...
class  Test:
	def  __init__(self):
		...
		self.__x#How  to  initialize  private  variable  'y'  to  20
	def  m1(self):
		print('m1  method')
...
t = Test()
print('Outside')
t.x#How  to  print  variable  'x'
t._Test__y#How  to  print   variable  'y'
print(t . __y)
print(t . __dict__)
...
print(a . __x)
t.m1()#How  to  call  public  method  m1()
t.__m1()#How  to  call  public  dunder  method  m1()
t._c1__m1()#How  to  call  private  method  m1()
a . __m1()
...
print('End')
'''
Object  is  created  at  address  : id(self)
...
del  list
'''
Object  is  created  at  address  :   address of c1()
Object  is  created  at  address  :   address of c1()
Object  is  created  at  address  :   address of c1()
Object  at  address  address of c1()  is  lost 
Object  at  address  address of c1()  is  lost 
Object  at  address  address of c1()  is  lost 
'''
