...
#  Object  'a'  ---> Date  object  with  attributes  dd = 15 , mm = 8 , yy = 1947
...
class Student:
    ...
    def __str__(self):
        return f'Roll Number: {self.roll_number}, Name: {self.name}, Gender: {self.gender}, Marks: {self.marks}, Total: {self.total}, Average: {self.average}, Grade: {self.grade}'
