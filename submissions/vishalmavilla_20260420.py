...
print(z1)  #   method  of  object  class  returns  type  and  address  of  object
...
print(z.__next__()) # How  to   iterate  thru  zip  object  with  __next__()  method
...
z7 = zip()
disp(z7)
stop iteration error as it is empty 
...
r = reversed(a)
try:
    print(next(r))  # first char in reverse: 'D'
    print(next(r))  # second char in reverse: 'Y'
    print(next(r))  # third char in reverse: 'H'
except StopIteration:
    pass  
...
try:
    ...
    pass
print()  # How  to  iterate  reversed  object   with  __next__()   method
print('Iterate  thru  reversed  object  with   for  loop')
r3 = reversed(a)
for ch in r3:
    print(ch, end=' ')  # prints: D Y H
