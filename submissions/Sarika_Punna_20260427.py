...
try:
    con = mysql.connector.connect(database = "emp" ,host ="localhost",password= "Nithya@1234",user = "root")
    cur = con.cursor()
...
con = mysql.connector.connect(database = "employee" ,host ="localhost",password= "Nithya@1234",user = "root")
cur = con.cursor()
