...
t2 =eval(input("Enter a tuple 1: "))

result = tuple(map(lambda a, b: a + b, t1, t2))
...
list=eval(input("Enter a list: "))
r=reduce(lambda x,y:x if x>y else y,list)
print('largest=',r)
