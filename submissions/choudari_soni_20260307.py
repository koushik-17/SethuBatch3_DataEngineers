...
print('a  :  {x}  \t  b  :  {y}  \t  c  :  {z}  ' . format(z = a , y = b , x = c))#'a  :25  \t  b  : 10.8  \t  c  :  Hyd  '
print('a  :  {z}  \t  b  :  {z}  \t  c  :  {z}  ' . format(z = a , y = b , x = c))#error
...
'''
ch=input('Enter any character or digit or special character')
if ch.isalnum():
    print('Alphanumeric character')
    if ch.isalpha():
        print('Alphaber character')
        if ch.isupper():
            print('Upper case')
        else:
            print('lower case')
