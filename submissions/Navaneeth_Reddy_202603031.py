...
f1()
'''
Infinite Times execution of f1() function
'''
#  Find  outputs  (Home  work)
def  f1():
        print('f1    function')
...
f1() # f1 function
f2() # f2 function
print(f1  is  f2) # False ,because there are different functions
f2 = f1
f2() # f1 function
print(f1  is  f2) # True
f2 = f1() # f1 function
print(f2) # None
f2() # Error due to none
...
outer()
'''
Error, because the x is printed , so it cannot be declared as nonlocal
'''
...
print(x)
'''
Error, because to x as nonlocal  , it should be initialized as local variable in outer function , where in above question 'x' is not initialized in outer function
'''
...
fun()
'''
Error, due to 'x' is considered as local variable because of x = x + 20
'''
...
def   outer():
	...
	def  inner():
		...
		nonlocal  x
'''
Error , x can not be global variable and local variable.
'''
