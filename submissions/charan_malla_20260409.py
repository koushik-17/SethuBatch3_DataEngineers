...
a . __init__(3.8  , 4.6)
print('a  :  ' , a) # 3.8/4.6
#g = Rat(nr1 = 9 , 5) # Error , PA after KA
#h = Rat(nr = 9 , dr = 5) # Error , invalid variables
...
#d = Date() # Error , no args given
#e = Date(dd = 30 , mm = 4 , yy = 2022) # Error, invalid variable names
#f = Date(dd1 = 26 , mm1 = 8 , 2023) # Error , PA after KA
...
# End  of  class
#a = c1() # Error , int is returned
b = c2() # c2 class constructor
print(b) # type address of object
print(b . __init__()) # c2 class constructor /n None 
c = c3()
print(c . __init__()) # c3 class constructor /n None
...
#b = c1(30) # Error , args missing
#c = c1() # Error , args missing
