...
print([10 , 20]  |  [30 , 20])                                                    #Error lists can't be concatenated by '|' 
...
print(-18 // 4)                                                                   #previous integer(-4.5) = -5.0 i.e. rounded off
print(-(18 // 4))                                                                 #previous integer(-(4.5)) = -4


# Find outputs
print(7 / 0)                       #Error as one can't divide an object by 0 
print(7 // 0)                      #Error as one can't divide an object by 0 
print(7 % 0)                       #Error as one can't divide an object by 0 
...
# Find outputs (Home work)
a = b = c = 25
print(id(a)) #Some random address assigned to 'a' 
print(id(b)) #Same random address assigned to 'a' 
print(id(c)) #Same random address assigned to 'a' 
