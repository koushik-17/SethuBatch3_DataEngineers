'''
1) Write a program to print emp table of the database with fetchone() method
...
con.close()
'''
2) Write a program to print emp table based on user condition
...
con.close()
'''
3) Write a program to print emp table in sorted order
...
con.close()
'''
4) Write a program to print user input table with next() function
...
con.close()
'''
5) Write a program to print cursor with fetchall() method
...
con.close()
'''
6) Repeat previous program such that OTP can be between 000000 and 999999 (may be 000156)
'''
