...
print(min(a . values()))--->[7]
print(max(a . items()))--->{9:50}
print(min(a . items()))-->{40:5}
print(max(a))---> [50]
print(min(a))-->[5]
...
print(dict(e))-->  {[[10 , 20 , 30] , [40 , 50 , 60] , [70 , 80 , 90]]}
f = [[10] , [20] , [30]]
print(dict(f))---> {10: null , 20 : null , 30 : null}
...
d = sorted(a . items())
print(d)--->{5 : 'White' , 10 : 'Red' ,  15 : 'Blue', 18 : 'Yellow' , 18 : 'Yellow' , 20 : 'Green'}
f  = sorted(a  , reverse = True)
print(f)---> {20 : 'Green' , 18 : 'Yellow', 15 : 'Blue' ,10 : 'Red' , 5 : 'White'  }
print(a)---> {20 : 'Green' , 18 : 'Yellow', 15 : 'Blue' ,10 : 'Red' , 5 : 'White'  }
...
for  x , y   in  b:
        print(x , y , sep = ' ... ') --- {'Hyd'...'sec'...'Cyb'...'Pune'}
...
print(rno1 , sname1)--->{rno1 , sname1}
print(rno2 , sname2)--->{rno2 , sname2}
print(rno3 , sname3)--->{rno3 , sname3}
...
b = {'Y' : 'Yellow', 'G' : 'Gray'}
b . update(a)
print(b)--->{ 'Y' : 'Yellow', 'G' : 'Gray' , 'R':'Red' , 'G':'Green'}
a . update(b)--->{'Y' : 'Yellow', 'G' : 'Green' , 'R':'Red' , 'G':'Green'}


#  Find  outputs  (Home  work)
a = [ (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)]
b = {}
b.update(a)---> { (10 , 20 , 30) , (40 , 50 , 60) , (70 , 80 , 90)}
...
print(d)
print(type(d))--->{1:1, 2:8 , 3:27, 4:64 , 5:125}
# Find outputs   (Home  work)
...
print(c)--->{10 : 'Rama', 18 : 'Rajesh' ,18 : 'Rajesh' }
