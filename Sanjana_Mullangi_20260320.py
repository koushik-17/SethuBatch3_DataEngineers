...
print(dict(e))#error-the required elements are 2 but there are 3 elements given
f = [[10] , [20] , [30]]
print(dict(f))#error-the required elements are 2 but there are 1 element given
print(dict([10 , 20]))#error
g = [[10 , [20 , 30]] , [40 , [50 , 60]] , [70 , [80 , 90]]]
print(dict(g))#{10: [20, 30], 40: [50, 60], 70: [80, 90]}
h = [[[10 , 20] , 30] , [[40 , 50] , 60] , [[70 , 80] , 90]]
print(dict(h))#error-the key value should contain only one argument but not two 
...
print(a)#{}
del  a
print(a)#error-already the dict a is deleted and it cannot be printed
...
a = {10 : 'Hyd' , 20 : 'Sec' , 15 : 'Cyb' , 18 : 'Pune'}
b = a . items()
print(b)#dict_items[(10:'Hyd'),(15:'Cyb'),(18:'Pune'),(20:'Sec')]
