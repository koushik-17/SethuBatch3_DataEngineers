...
f1(a = 130 , 140 , c = 150) 3error
f1(160 , b = 170 , 180) #a:160 b:170 c:150
...
print(concat('Python', 'Is', 'A', 'Great', 'Language'))  #Hyd Is Green City
print(concat()) #empty                 
...
def   f1(*a):
	...
	for  x  in  a:
		...
		print(type(x)) #<class 'list' <class 'set'> <class 'set'>
# End  of  the  function
...
def   f2(**a):
	print(a) #Emp  Number  :  25  	  Emp  Name  :  Sita  	  Salary  :	10000.0{'empno': 25, 'ename': 'Sita', 'sal': 10000.0}{'eno': 25, 'empname': 'Sita', 'salary': 10000.0}
# End  of  the  function
...
def    f1(a ,  *b , **c):
	...
	if  c:
		print(c) #(25, 'Hyd', True){'EmpNo': 12, 'EmpName': 'Rama  Rao', 'Salary': 10000.0}
# End  of  the  function
f1(25)
print()
f1('Hyd' , 10 , 20 , 30)
