...
print(a + 5) #error-we cannot concatinate with sequence with non sequence
print(a + '5') #error-list can be concatinated with list only
...
a += b 
print(a , id(a)) #[1,2,3,4,5,6] same address of list object a
...
print(a , id(a)) #[1 , 2 , 3] address of list object a
a  = a + b
print(a , id(a)) #[1,2,3,4,5,6] different address of list object a
...
print('d : ' , d) # d :  Hyd
print('e : ' , e) # e :  True
a , b , *c , d , e , f = list # ERROR because not have enough value to unpack
...
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list #in one assignment statement two * cannot be present
...
print(sum(d))#63
e = [25 , 10.8 , 'Hyd' , True]
print(sum(e))#error-cannot add str to float
'''
...
#  Find  outputs
a = [[10 , 20 , 15 , 18]]
print(sum(a))#error-list and int cannot be added
...
print(min(b)) #Amar
c = [25 , 10.8 ,  3 + 4j , True]
print(max(c))#error-list contains elements of different class and hence cannot be compared
d = [25 , '35']
print(max(d))#error-list contains elements of different class and hence cannot be compared
print(max([]))#error-no argument is there to comapre in max
print(min([]))#error-no argument is there to comapre in min
'''
...
a = list()
print(a)#[]
print(list(25)) #error-list object cannot contain non sequence object
print(list(10.8))#error-list object cannot contain non sequence object
print(list(True))#error-list object cannot contain non sequence object
print(list(None))#error-list object cannot contain non sequence object
'''
list()  function
-----------------
...
print(list(b))# [(60, 70, 80, 90), (10, 20), (30, 40, 50)] can be in any order
c = ([10 , 20] , (30 , 40) , {50 , 60})
...
x=int(input("Enter the element to be deleted all occurences in the list:"))
while x in a:
    a.remove(x)
print(a)
'''
