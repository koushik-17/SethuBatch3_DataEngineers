...
print(How  to  print  2nd   inner  list) #a[1]
print(How  to  print  3rd   inner  list) #a[2]
print(How  to  print  number  of  elements  in  1st  inner  list) #a[0][0] , #a[0][1]
print(How  to  print  number  of  elements  in  2nd  inner  list) #a[1][0] , #a[1][1]
print(How  to  print  number  of  elements  in  3rd  inner  list) #a[2][0] , #a[2][1] ,#a[2][2], #a[2][3]'''
...
print('Each  inner  list   of   outer  list  without  indexes')#print(*a)
