...
print(len(' '))#1
print(len('A2#'))#3
print(len(3456))#error-the values does not belong to class str 
print('Sec'. len())#error- first the method should be called and later the argument should be given inside the method
